...
<div class="content">
  ...
  <div id="main_content">
    ...
    </div><div class="row" id="5">
    <label for="subject">title</label>
    <input type="text" name="subject" id="subject" placeholder="Problem..." />
    </div><div class="row" id="5">
      <label for="body">problem</label>
    </div>
      <textarea name="body" id="body" placeholder="Include screen size even if in inches/cm. Type problem details into here"></textarea>
