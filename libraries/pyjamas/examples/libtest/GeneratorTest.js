...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
			...
			while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
				...
				i = $tupleassign1[0];
				g = $tupleassign1[1];
				self['assertEqual'](i, (typeof ($sub1=g)==typeof ($sub2=1) && (typeof $sub1=='number'||typeof $sub1=='string')?
					$sub1-$sub2:
					$p['op_sub']($sub1,$sub2)));
			}
			fn = function(n) {
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				...
				$generator['$genfunc'] = function () {
					...
					if ($generator_state[0] == 1) {
						...
						i = (typeof ($add7=i)==typeof ($add8=1) && (typeof $add7=='number'||typeof $add7=='string')?
							$add7+$add8:
							$p['op_add']($add7,$add8));
						j = i;
						$yield_value = i;
					...
					if ($generator_state[0] == 3) {
						...
						j = (typeof ($mul3=j)==typeof ($mul4=100) && typeof $mul3=='number'?
							$mul3*$mul4:
							$p['op_mul']($mul3,$mul4));
			...
			self['assertEqual'](r, $p['list']([0, 1, 1, 100, 101, 109]));
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
			...
			while (typeof ($iter6_nextval=($iter6_type?($iter6_type > 0?$iter6_iter.next(true,false):$p['wrapped_next']($iter6_iter)):$iter6_array[$iter6_idx++])) != 'undefined') {
				...
				i = $tupleassign2[0];
				g = $tupleassign2[1];
				self['assertEqual'](i, (typeof ($sub3=g)==typeof ($sub4=1) && (typeof $sub3=='number'||typeof $sub3=='string')?
					$sub3-$sub4:
					$p['op_sub']($sub3,$sub4)));
			}
			return null;
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
					...
					if ($generator_state[0] == 2) {
						for (;($generator_state[1] > 0)||((($bool2=((($cmp3=i)===($cmp4=n)?0:
							...
							if ($generator_state[1] == 1) {
								...
								$yield_value = (typeof ($mul7=i)==typeof ($mul8=10) && typeof $mul7=='number'?
									$mul7*$mul8:
									$p['op_mul']($mul7,$mul8));
								$yielding = true;
								$generator_state[1] = 2;
							...
							if ($generator_state[1] == 2) {
								...
								i = (typeof ($add15=i)==typeof ($add16=1) && (typeof $add15=='number'||typeof $add15=='string')?
									$add15+$add16:
			...
			self['assertEqual'](r, $p['list']([0, 0, 1, 10, 2, 20, 3, 30]));
			fn = function(n) {
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
					...
					if ($generator_state[0] == 2) {
						for (;($generator_state[1] > 0)||((($bool4=((($cmp7=i)===($cmp8=n)?0:
							...
							if ($generator_state[1] == 2) {
								...
								i = (typeof ($add19=i)==typeof ($add20=1) && (typeof $add19=='number'||typeof $add19=='string')?
									$add19+$add20:
			...
			self['assertEqual'](r, $p['list']([0, 100]));
			fn = function() {
				var $add28,$add22,$eq2,$eq3,$add23,$eq1,$add25,$add24,$eq4,$add26,$add21,$bool6,$add27,$bool5,y;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				var $generator = function () {};
				$generator['next'] = function (noStop) {
				...
				$generator['$genfunc'] = function () {
					...
					if ($generator_state[0] == 2) {
						for (;($generator_state[1] > 0)||((($bool6=(($eq3=y)===($eq4=0)&&$eq3===null?true:
							...
							if (typeof $generator_state[1] == 'undefined' || $generator_state[1] === 0) {
								for (var $i = 1 ; $i < ($generator_state.length<3?3:$generator_state.length); $i++) $generator_state[$i]=0;
								y = (typeof ($add25=y)==typeof ($add26=1) && (typeof $add25=='number'||typeof $add25=='string')?
									$add25+$add26:
							...
							if ($generator_state[1] == 1) {
								...
								y = (typeof ($add27=y)==typeof ($add28=1) && (typeof $add27=='number'||typeof $add27=='string')?
									$add27+$add28:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testSimpleIfThenElse', function() {
			...
			fn = function(n) {
				var $bool10,$bool11,$bool12,$bool13,$bool14,$eq10,$eq11,$eq12,$add29,$eq8,$eq9,$eq6,$eq7,$eq5,$cmp15,$cmp14,$cmp16,$cmp11,$cmp10,$cmp13,$cmp12,$bool8,$bool9,$add32,$add30,$add31,$cmp9,$bool7;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				var $generator = function () {};
				$generator['next'] = function (noStop) {
				...
				$generator['$genfunc'] = function () {
					...
					if ($generator_state[0] == 2) {
						for (;($generator_state[1] > 0)||((($bool11=((($cmp13=n)===($cmp14=3)?0:
							...
							if ($generator_state[1] == 1) {
								if(($generator_state[2]==1)||($generator_state[2]<1&&((($bool12=((($cmp15=n)===($cmp16=0)?0:
								...
								else if(($generator_state[2]==2)||($generator_state[2]<2&&((($bool13=(($eq9=n)===($eq10=0)&&$eq9===null?true:
								...
								else if(($generator_state[2]==3)||($generator_state[2]<3&&((($bool14=(($eq11=n)===($eq12=1)&&$eq11===null?true:
								...
								$generator_state[2]=0;
								n = (typeof ($add31=n)==typeof ($add32=1) && (typeof $add31=='number'||typeof $add31=='string')?
									$add31+$add32:
			...
			fn.__args__ = [null,null,['n']];
			r = $p['list']([]);
			$iter10_iter = fn((typeof ($usub1=1)=='number'?
				-$usub1:
				$p['op_usub']($usub1)));
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				...
				$generator['$genfunc'] = function () {
					...
					if ($generator_state[0] == 1) {
						try {
							...
							if ($generator_state[1] == 1) {
								$yield_value = (typeof ($add37=i)==typeof ($add38=1) && (typeof $add37=='number'||typeof $add37=='string')?
									$add37+$add38:
							...
							if ($generator_state[1] == 2) {
								...
								$yield_value = (typeof ($add39=i)==typeof ($add40=2) && (typeof $add39=='number'||typeof $add39=='string')?
									$add39+$add40:
			...
			self['assertEqual'](r, $p['list']([2, 3]));
			fn = function() {
				var $add50,$add51,$add52,$add49,$add48,$add47,$add46,$add45,$add44,$add43,$bool15,$add41,$add42,$pyjs_try_err,$bool16,y,$eq13,$eq14,$eq15,$eq16;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				var $generator = function () {};
				$generator['next'] = function (noStop) {
				...
				$generator['$genfunc'] = function () {
					...
					if ($generator_state[0] == 2) {
						for (;($generator_state[1] > 0)||((($bool16=(($eq15=y)===($eq16=0)&&$eq15===null?true:
							...
							if ($generator_state[1] == 1) {
								try {
									...
									if ($generator_state[2] == 1) {
										y = (typeof ($add47=y)==typeof ($add48=1) && (typeof $add47=='number'||typeof $add47=='string')?
											$add47+$add48:
									...
									if ($generator_state[2] == 2) {
										...
										y = (typeof ($add49=y)==typeof ($add50=1) && (typeof $add49=='number'||typeof $add49=='string')?
											$add49+$add50:
									...
									if (typeof $generator_state[3] == 'undefined' || $generator_state[3] === 0) {
										for (var $i = 3 ; $i < ($generator_state.length<5?5:$generator_state.length); $i++) $generator_state[$i]=0;
										y = (typeof ($add51=y)==typeof ($add52=2) && (typeof $add51=='number'||typeof $add51=='string')?
											$add51+$add52:
			...
			self['assertEqual'](r, $p['list']([1, 2, 4]));
			return null;
		}
	, 1, [null,null,['self']]);
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
			...
			self['assertEqual']($p['list'](f()), $p['list']([1, 2]));
			f = function() {
				var $pyjs_try_err;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				var $generator = function () {};
			...
			f.__bind_type__ = 0;
			f.__args__ = [null,null];
			self['assertEqual']($p['list'](f()), $p['list']([1, 3, 4, 2]));
			fn = function(n) {
				var $bool18,$bool19,$bool17,$eq18,$eq19,$iter13_idx,$iter13_array,$eq17,$pyjs_try_err,$bool21,$bool20,$bool22,$iter13_type,$iter14_array,$iter14_type,$eq21,$eq20,$cmp17,$eq22,$eq24,$iter14_iter,e,$cmp19,$cmp18,$iter14_idx,$iter14_nextval,$cmp20,$iter13_nextval,$iter13_iter,i,$eq23;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				var $generator = function () {};
				$generator['next'] = function (noStop) {
						...
						for (;($generator_state[1] > 0 || typeof ($iter14_nextval=($iter14_type?($iter14_type > 0?$iter14_iter.next(true,false):$p['wrapped_next']($iter14_iter)):$iter14_array[$iter14_idx++])) != 'undefined');$generator_state[1] = 0) {
							...
							if ($generator_state[1] == 1) {
								try {
									...
									if ($generator_state[2] == 2) {
										if(($generator_state[3]==1)||($generator_state[3]<1&&((($bool20=(($eq21=i)===($eq22=0)&&$eq21===null?true:
										...
										else if(($generator_state[3]==2)||($generator_state[3]<2&&((($bool21=((($cmp19=i)===($cmp20=3)?0:
										...
										else if(($generator_state[3]==3)||($generator_state[3]<3&&((($bool22=(($eq23=i)===($eq24=3)&&$eq23===null?true:
			...
			fn = function(n) {
				var $iter16_idx,$cmp21,$cmp22,$cmp23,$cmp24,$iter17_type,$iter16_iter,$iter17_iter,$iter16_type,$bool25,$bool24,$bool27,$pyjs_try_err,$bool23,$iter16_nextval,$bool28,$iter17_nextval,$iter17_array,$eq25,$bool26,$eq27,$eq26,$eq29,$eq28,$iter16_array,$eq32,e,i,$eq30,$eq31,$iter17_idx;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				var $generator = function () {};
				$generator['next'] = function (noStop) {
						...
						for (;($generator_state[1] > 0 || typeof ($iter17_nextval=($iter17_type?($iter17_type > 0?$iter17_iter.next(true,false):$p['wrapped_next']($iter17_iter)):$iter17_array[$iter17_idx++])) != 'undefined');$generator_state[1] = 0) {
							...
							if ($generator_state[1] == 1) {
								try {
									...
									if ($generator_state[2] == 2) {
										if(($generator_state[3]==1)||($generator_state[3]<1&&((($bool26=(($eq29=i)===($eq30=0)&&$eq29===null?true:
										...
										else if(($generator_state[3]==2)||($generator_state[3]<2&&((($bool27=((($cmp23=i)===($cmp24=3)?0:
										...
										else if(($generator_state[3]==3)||($generator_state[3]<3&&((($bool28=(($eq31=i)===($eq32=3)&&$eq31===null?true:
											($eq31===null?false:($eq32===null?false:
												((typeof $eq31=='object'||typeof $eq31=='function')&&typeof $eq31.__cmp__=='function'?$eq31.__cmp__($eq32) === 0:
													((typeof $eq32=='object'||typeof $eq32=='function')&&typeof $eq32.__cmp__=='function'?$eq32.__cmp__($eq31) === 0:
														$eq31==$eq32)))))) === null || $bool28 === false || $bool28 === 0 || $bool28 === '' ?
												false :
				...
				if (($pyjs_try_err_name == $p['RuntimeError'].__name__)||$p['_isinstance']($pyjs_try_err,$p['RuntimeError'])) {
					...
					self['assertEqual']((typeof ($1=e).__array != 'undefined'?
						((typeof $1.__array[$2=0]) != 'undefined'?$1.__array[$2]:
							$1.__getitem__($2)):
							$1.__getitem__(0)), 'generator ignored GeneratorExit');
				} else { $pyjs.__active_exception_stack__ = $pyjs.__last_exception_stack__; $pyjs.__last_exception_stack__ = null; throw $pyjs_try_err; }
			}
			return null;
		}
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				...
				$generator['$genfunc'] = function () {
					...
					if (typeof $generator_state[0] == 'undefined' || $generator_state[0] === 0) {
						...
						var $tupleassign5 = $p['__ass_unpack']($p['tuple']([0, 1]), 2, null);
						a = $tupleassign5[0];
						b = $tupleassign5[1];
						$generator_state[0]=1;
					}
					...
					if ($generator_state[0] == 2) {
						for (;($generator_state[1] > 0)||((($bool32=1) === null || $bool32 === false || $bool32 === 0 || $bool32 === '' ?
								false :
			...
			self['assertEqual'](r, $p['list']([1, 1, 2, 3, 5, 8]));
			return null;
		}
	, 1, [null,null,['self']]);
				...
				if (($pyjs_try_err_name == $p['ValueError'].__name__)||$p['_isinstance']($pyjs_try_err,$p['ValueError'])) {
					...
					self['assertEqual']((typeof ($3=e).__array != 'undefined'?
						((typeof $3.__array[$4=0]) != 'undefined'?$3.__array[$4]:
							$3.__getitem__($4)):
							$3.__getitem__(0)), 'generator already executing');
				} else { $pyjs.__active_exception_stack__ = $pyjs.__last_exception_stack__; $pyjs.__last_exception_stack__ = null; throw $pyjs_try_err; }
			}
			return null;
		}
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
			...
			self['assertEqual']($p['list'](f2()), $p['list']([42]));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testPEP255_exceptionPropagation', function() {
			...
			f = function() {
				var $div2,$6,$5,$div1,v;
				v = (typeof ($div1=1)==typeof ($div2=0) && typeof $div1=='number' && $div2 !== 0?
					$div1/$div2:
					$p['op_div']($div1,$div2));
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
			...
			f.__bind_type__ = 0;
			f.__args__ = [null,null];
			self['assertEqual']($p['list'](f()), $p['list']([1, 2, 4, 5, 8, 9, 10, 11]));
			return null;
		}
	, 1, [null,null,['self']]);
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testMixed', function() {
			...
			fn = function(value) {
				if (typeof value == 'undefined') value=arguments.callee.__args__[2][1];
				var $cmp26,$iter28_idx,$eq33,$eq36,$cmp25,$eq34,$eq35,$cmp28,$eq38,$eq39,$iter27_nextval,$div3,$iter27_array,$pyjs_try_err,$iter27_iter,$cmp27,$iter27_type,$bool47,$bool46,$bool45,$bool44,$bool43,$bool48,$iter28_iter,$iter28_type,$div6,$div4,$div5,$iter28_array,i,$iter28_nextval,$eq40,$iter27_idx,v,$eq37;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
				var $generator = function () {};
				$generator['next'] = function (noStop) {
				...
				$generator['$genfunc'] = function () {
					...
					if (typeof $generator_state[0] == 'undefined' || $generator_state[0] === 0) {
						...
						$iter28_iter = $p['list']([(typeof ($usub3=1)=='number'?
							-$usub3:
							$p['op_usub']($usub3)), 0, 1, 2, 3, 4]);
					...
					if ($generator_state[0] == 2) {
						for (;($generator_state[1] > 0 || typeof ($iter28_nextval=($iter28_type?($iter28_type > 0?$iter28_iter.next(true,false):$p['wrapped_next']($iter28_iter)):$iter28_array[$iter28_idx++])) != 'undefined');$generator_state[1] = 0) {
							...
							if ($generator_state[1] == 1) {
								if(($generator_state[2]==1)||($generator_state[2]<1&&((($bool46=((($cmp27=i)===($cmp28=0)?0:
								...
								else if(($generator_state[2]==2)||($generator_state[2]<2&&((($bool47=(($eq37=i)===($eq38=0)&&$eq37===null?true:
									($eq37===null?false:($eq38===null?false:
										((typeof $eq37=='object'||typeof $eq37=='function')&&typeof $eq37.__cmp__=='function'?$eq37.__cmp__($eq38) === 0:
											((typeof $eq38=='object'||typeof $eq38=='function')&&typeof $eq38.__cmp__=='function'?$eq38.__cmp__($eq37) === 0:
												$eq37==$eq38)))))) === null || $bool47 === false || $bool47 === 0 || $bool47 === '' ?
										false :
								...
								else if(($generator_state[2]==3)||($generator_state[2]<3&&((($bool48=(($eq39=i)===($eq40=1)&&$eq39===null?true:
									($eq39===null?false:($eq40===null?false:
										((typeof $eq39=='object'||typeof $eq39=='function')&&typeof $eq39.__cmp__=='function'?$eq39.__cmp__($eq40) === 0:
											((typeof $eq40=='object'||typeof $eq40=='function')&&typeof $eq40.__cmp__=='function'?$eq40.__cmp__($eq39) === 0:
												$eq39==$eq40)))))) === null || $bool48 === false || $bool48 === 0 || $bool48 === '' ?
										false :
			...
			self['assertEqual'](r, $p['list']([0, 1, null, 2, 2, 3, 4]));
			return null;
		}
	, 1, [null,null,['self']]);
				...
				if ($generator_state[0] == 2) {
					for (;($generator_state[1] > 0 || typeof ($iter31_nextval=($iter31_type?($iter31_type > 0?$iter31_iter.next(true,false):$p['wrapped_next']($iter31_iter)):$iter31_array[$iter31_idx++])) != 'undefined');$generator_state[1] = 0) {
						if (typeof $generator_state[1] == 'undefined' || $generator_state[1] === 0) {
							...
							$yield_value = $p['isinstance'](child, $p['float_int']);
							$yielding = true;
							$generator_state[1] = 1;
							return $yield_value;
							$generator_state[1]=1;
...
;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testTupleReturn', function() {
			...
			lst = $p['list']([]);
			$iter34_iter = $p['enumerate']($p['list']([0, 1, 2]));
			...
			self['assertEqual'](lst, $p['list']([$p['tuple']([0, 0]), $p['tuple']([1, 1]), $p['tuple']([2, 2])]));
			lst = function(){
				var $iter35_idx,$iter35_nextval,$collcomp1,$iter35_type,t,$iter35_array,$iter35_iter;
	$collcomp1 = $p['list']();
			$iter35_iter = $p['enumerate']($p['list']([0, 1, 2]));
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
		...
		$method = $pyjs__bind_method2('__repr__', function(level, indent) {
			...
			if ((($bool51=$p['getattr'](self, 'left')) === null || $bool51 === false || $bool51 === 0 || $bool51 === '' ?
				...
				s = (typeof ($add67=(typeof ($add63=s)==typeof ($add64='\n') && (typeof $add63=='number'||typeof $add63=='string')?
					$add63+$add64:
					$p['op_add']($add63,$add64)))==typeof ($add68=self['left']['__repr__']((typeof ($add65=level)==typeof ($add66=1) && (typeof $add65=='number'||typeof $add65=='string')?
					$add65+$add66:
			...
			if ((($bool52=$p['getattr'](self, 'right')) === null || $bool52 === false || $bool52 === 0 || $bool52 === '' ?
				...
				s = (typeof ($add73=(typeof ($add69=s)==typeof ($add70='\n') && (typeof $add69=='number'||typeof $add69=='string')?
					$add69+$add70:
					$p['op_add']($add69,$add70)))==typeof ($add74=self['right']['__repr__']((typeof ($add71=level)==typeof ($add72=1) && (typeof $add71=='number'||typeof $add71=='string')?
					$add71+$add72:
	...
	, 1, [null,null,['self'],['level', 0],['indent', '    ']]);
	...
	$m['tree'] = function(list) {
		var $add76,$add75,$10,$bool53,i,$eq42,$eq41,$9,n,$div8,$len1,$div7;
		n = (($len1=list) === null?0:
			(typeof $len1.__array != 'undefined' ? $len1.__array.length:
				(typeof $len1.__len__ == 'function'?$len1.__len__():
					(typeof $len1.length != 'undefined'?$len1.length:
						$p['len']($len1)))));
		if ((($bool53=(($eq41=n)===($eq42=0)&&$eq41===null?true:
			($eq41===null?false:($eq42===null?false:
				((typeof $eq41=='object'||typeof $eq41=='function')&&typeof $eq41.__cmp__=='function'?$eq41.__cmp__($eq42) === 0:
					((typeof $eq42=='object'||typeof $eq42=='function')&&typeof $eq42.__cmp__=='function'?$eq42.__cmp__($eq41) === 0:
						$eq41==$eq42)))))) === null || $bool53 === false || $bool53 === 0 || $bool53 === '' ?
				false :
		...
		i = (typeof ($div7=n)==typeof ($div8=2) && typeof $div7=='number' && $div8 !== 0?
			$div7/$div8:
			$p['op_div']($div7,$div8));
		return $m['Tree']((typeof ($9=list).__array != 'undefined'?
			((typeof $9.__array[$10=i]) != 'undefined'?$9.__array[$10]:
				$9.__getitem__($10)):
				$9.__getitem__(i)), $m['tree']($p['__getslice'](list, 0, i)), $m['tree']($p['__getslice'](list, (typeof ($add75=i)==typeof ($add76=1) && (typeof $add75=='number'||typeof $add75=='string')?
			$add75+$add76:
