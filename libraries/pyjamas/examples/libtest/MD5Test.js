		...
		$m['hexstr'] = function(s) {
			...
			while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
				...
				r = (typeof ($add3=(typeof ($add1=r)==typeof ($add2=(typeof ($1=h).__array != 'undefined'?
					((typeof $1.__array[$2=((i)>>(4))&(15)]) != 'undefined'?$1.__array[$2]:
						$1.__getitem__($2)):
						$1.__getitem__(((i)>>(4))&(15)))) && (typeof $add1=='number'||typeof $add1=='string')?
					$add1+$add2:
					$p['op_add']($add1,$add2)))==typeof ($add4=(typeof ($3=h).__array != 'undefined'?
					((typeof $3.__array[$4=(i)&(15)]) != 'undefined'?$3.__array[$4]:
						$3.__getitem__($4)):
						$3.__getitem__((i)&(15)))) && (typeof $add3=='number'||typeof $add3=='string')?
					$add3+$add4:
					$p['op_add']($add3,$add4));
			}
			return r;
		...
		$m['hexstr'] = function(s) {
			...
			while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
				...
				r = (typeof ($add7=(typeof ($add5=r)==typeof ($add6=(typeof ($5=h).__array != 'undefined'?
					((typeof $5.__array[$6=((i)>>(4))&(15)]) != 'undefined'?$5.__array[$6]:
						$5.__getitem__($6)):
						$5.__getitem__(((i)>>(4))&(15)))) && (typeof $add5=='number'||typeof $add5=='string')?
					$add5+$add6:
					$p['op_add']($add5,$add6)))==typeof ($add8=(typeof ($7=h).__array != 'undefined'?
					((typeof $7.__array[$8=(i)&(15)]) != 'undefined'?$7.__array[$8]:
						$7.__getitem__($8)):
						$7.__getitem__((i)&(15)))) && (typeof $add7=='number'||typeof $add7=='string')?
					$add7+$add8:
					$p['op_add']($add7,$add8));
			}
			return r;
