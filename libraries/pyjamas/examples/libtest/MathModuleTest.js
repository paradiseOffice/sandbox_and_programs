...
$pyjs.loaded_modules['MathModuleTest'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testExp', function() {
			...
			self['assertEqual']($m['math']['exp'](1), $p['getattr']($m['math'], 'e'));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testLog', function() {
			...
			self['assertEqual']($m['math']['log']($p['getattr']($m['math'], 'e')), 1);
			self['assertTrue'](((($cmp1=(typeof ($sub1=$m['math']['log'](100, 10))==typeof ($sub2=2) && (typeof $sub1=='number'||typeof $sub1=='string')?
				$sub1-$sub2:
				$p['op_sub']($sub1,$sub2)))===($cmp2=1e-12)?0:
				(typeof $cmp1==typeof $cmp2 && ((typeof $cmp1 == 'number')||(typeof $cmp1 == 'string')||(typeof $cmp1 == 'boolean'))?
					($cmp1 == $cmp2 ? 0 : ($cmp1 < $cmp2 ? -1 : 1)):
					$p['cmp']($cmp1, $cmp2))) == -1), $p['sprintf']('math.log(100, 10): %s', $m['math']['log'](100, 10)));
			self['assertTrue'](((($cmp3=(typeof ($sub3=$m['math']['log10'](1000))==typeof ($sub4=3) && (typeof $sub3=='number'||typeof $sub3=='string')?
				$sub3-$sub4:
				$p['op_sub']($sub3,$sub4)))===($cmp4=1e-12)?0:
				(typeof $cmp3==typeof $cmp4 && ((typeof $cmp3 == 'number')||(typeof $cmp3 == 'string')||(typeof $cmp3 == 'boolean'))?
					($cmp3 == $cmp4 ? 0 : ($cmp3 < $cmp4 ? -1 : 1)):
					$p['cmp']($cmp3, $cmp4))) == -1), $p['sprintf']('math.log10(1000): %s', $m['math']['log10'](1000)));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testPow', function() {
			...
			self['assertEqual']($m['math']['pow'](2, 3), 8.0);
			self['assertEqual']($m['math']['pow'](4, 0.5), 2.0);
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testSqrt', function() {
			...
			self['assertEqual']($m['math']['sqrt'](4), 2.0);
			return null;
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testAcos', function() {
			...
			self['assertTrue'](((($cmp7=(typeof ($sub7=$m['math']['acos']($m['math']['cos'](1)))==typeof ($sub8=1) && (typeof $sub7=='number'||typeof $sub7=='string')?
				$sub7-$sub8:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testAsin', function() {
			...
			self['assertTrue'](((($cmp9=(typeof ($sub9=$m['math']['asin']($m['math']['sin'](1)))==typeof ($sub10=1) && (typeof $sub9=='number'||typeof $sub9=='string')?
				$sub9-$sub10:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testAtan', function() {
			...
			self['assertTrue'](((($cmp11=(typeof ($sub11=$m['math']['atan']($m['math']['tan'](1)))==typeof ($sub12=1) && (typeof $sub11=='number'||typeof $sub11=='string')?
				$sub11-$sub12:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testAtan2', function() {
			...
			self['assertTrue'](((($cmp13=(typeof ($sub13=$m['math']['atan2'](1, 1))==typeof ($sub14=$m['math']['atan'](1)) && (typeof $sub13=='number'||typeof $sub13=='string')?
				$sub13-$sub14:
					...
					(typeof $bool1=='object'?
						(typeof $bool1.__nonzero__=='function'?
							...
							(typeof $bool1.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				numbers = (typeof ($add1=(typeof ($mul3=20)==typeof ($mul4=$p['list']([1e-08])) && typeof $mul3=='number'?
					$mul3*$mul4:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testFrexp', function() {
			...
			var $tupleassign1 = $p['__ass_unpack']($m['math']['frexp'](1), 2, null);
			m = $tupleassign1[0];
			e = $tupleassign1[1];
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testLdexp', function() {
			...
			self['assertEqual']($m['math']['ldexp'](0.5, 3), 4);
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testDegrees', function() {
			...
			self['assertTrue'](((($cmp15=(typeof ($sub15=$m['math']['degrees']((typeof ($div3=$p['getattr']($m['math'], 'pi'))==typeof ($div4=2) && typeof $div3=='number' && $div4 !== 0?
				$div3/$div4:
				$p['op_div']($div3,$div4))))==typeof ($sub16=90) && (typeof $sub15=='number'||typeof $sub15=='string')?
				$sub15-$sub16:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('testRadians', function() {
			...
			self['assertTrue'](((($cmp17=(typeof ($sub17=$m['math']['radians'](90))==typeof ($sub18=(typeof ($div5=$p['getattr']($m['math'], 'pi'))==typeof ($div6=2) && typeof $div5=='number' && $div6 !== 0?
				$div5/$div6:
