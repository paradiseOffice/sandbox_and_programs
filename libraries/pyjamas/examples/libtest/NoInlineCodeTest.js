...
$pyjs.loaded_modules['NoInlineCodeTest'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_dict', function() {
			...
			var i1,fn;
			i1 = $pyjs_kwargs_call(null, $p['dict'], null, null, [{a:1}]);
			fn = function() {
				var i3,i2,dict,i4;
				i2 = $p['dict']([['a', 1]]);
				dict = $m['test'];
				i3 = $pyjs_kwargs_call(null, dict, null, null, [{a:1}]);
				i4 = $p['dict']([['a', 1]]);
				self['assertEqual'](i1, $p['dict']([['a', 1]]));
				self['assertEqual'](i1, i2);
				self['assertNotEqual'](i1, i3);
				self['assertEqual'](i1, i4);
				return null;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_ArithmeticError', function() {
			...
			fn = function() {
				...
				try {
					a = (typeof ($div1=1)==typeof ($div2=0) && typeof $div1=='number' && $div2 !== 0?
						$div1/$div2:
						$p['op_div']($div1,$div2));
					throw $p['TryElse'];
				} catch($pyjs_try_err) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_BaseException', function() {
			...
			fn = function() {
				...
				try {
					a = (typeof ($div3=1)==typeof ($div4=0) && typeof $div3=='number' && $div4 !== 0?
						$div3/$div4:
						$p['op_div']($div3,$div4));
					throw $p['TryElse'];
				} catch($pyjs_try_err) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_Exception', function() {
			...
			fn = function() {
				...
				Exception = $p['bool'];
				try {
					a = (typeof ($div5=1)==typeof ($div6=0) && typeof $div5=='number' && $div6 !== 0?
						$div5/$div6:
						$p['op_div']($div5,$div6));
					throw $p['TryElse'];
				} catch($pyjs_try_err) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('_test_GeneratorExit', function() {
			...
			fn = function() {
				...
				try {
					a = (typeof ($div7=1)==typeof ($div8=0) && typeof $div7=='number' && $div8 !== 0?
						$div7/$div8:
						$p['op_div']($div7,$div8));
					throw $p['TryElse'];
				} catch($pyjs_try_err) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_IndexError', function() {
			...
			fn = function() {
				...
				IndexError = $p['bool'];
				try {
					a = (typeof ($1=$p['list']([0])).__array != 'undefined'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_KeyError', function() {
			...
			fn = function() {
				...
				KeyError = $p['bool'];
				try {
					a = (typeof ($3=$pyjs_kwargs_call(null, $p['dict'], null, null, [{a:1}])).__array != 'undefined'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('_test_RuntimeError', function() {
			...
			fn = function() {
				...
				RuntimeError = $p['bool'];
				try {
					a = $pyjs_kwargs_call(null, $p['dict'], null, null, [{a:1, b:2, c:3}]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_StandardError', function() {
			...
			fn = function() {
				...
				try {
					a = (typeof ($div9=1)==typeof ($div10=0) && typeof $div9=='number' && $div10 !== 0?
						$div9/$div10:
						$p['op_div']($div9,$div10));
					throw $p['TryElse'];
				} catch($pyjs_try_err) {
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_TypeError', function() {
			...
			fn = function() {
				...
				TypeError = $p['bool'];
				try {
					a = (typeof ($add1=1)==typeof ($add2='a') && (typeof $add1=='number'||typeof $add1=='string')?
						$add1+$add2:
						$p['op_add']($add1,$add2));
					throw $p['TryElse'];
				} catch($pyjs_try_err) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_ZeroDivisionError', function() {
			...
			fn = function() {
				...
				try {
					a = (typeof ($div11=1)==typeof ($div12=0) && typeof $div11=='number' && $div12 !== 0?
						$div11/$div12:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_ArgsScoping', function() {
						...
						(typeof $bool1=='object'?
							(typeof $bool1.__nonzero__=='function'?
								...
								(typeof $bool1.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					fn((typeof ($add3=i)==typeof ($add4=1) && (typeof $add3=='number'||typeof $add3=='string')?
						$add3+$add4:
						$p['op_add']($add3,$add4)));
				}
			...
			collection['append']($p['tuple']([0, args, kwargs]));
			$pyjs_kwargs_call(null, fn, args, kwargs, [{}, 1]);
			self['assertEqual'](collection, $p['list']([$p['tuple']([0, $p['tuple']([2, 3]), $p['dict']([['a', 'a'], ['b', 'b']])]), $p['tuple']([2, $p['tuple']([]), $p['dict']([])]), $p['tuple']([1, $p['tuple']([2, 3]), $p['dict']([['a', 'a'], ['b', 'b']])])]));
			return null;
		}
	, 1, [null,null,['self']]);
