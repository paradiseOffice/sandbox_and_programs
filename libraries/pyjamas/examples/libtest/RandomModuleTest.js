...
$pyjs.loaded_modules['RandomModuleTest'] = function (__mod_name__) {
	...
	$collcomp2 = $p['list']();
		$iter3_iter = $p['range'](1, (($len1=cof) === null?0:
	...
	$m['gamma'].__args__ = [null,null,['z'],['cof', $m['_gammacoeff']],['g', 7]];
	...
	return $collcomp4;}();
			dists = $p['list']([$p['tuple']([$p['getattr'](g, 'uniform'), $p['tuple']([1.0, 10.0]), (typeof ($div9=(typeof ($add11=10.0)==typeof ($add12=1.0) && (typeof $add11=='number'||typeof $add11=='string')?
				$add11+$add12:
				$p['op_add']($add11,$add12)))==typeof ($div10=2) && typeof $div9=='number' && $div10 !== 0?
				$div9/$div10:
				$p['op_div']($div9,$div10)), (typeof ($div11=(typeof ($pow3=(typeof ($sub3=10.0)==typeof ($sub4=1.0) && (typeof $sub3=='number'||typeof $sub3=='string')?
				$sub3-$sub4:
				$p['op_sub']($sub3,$sub4)))==typeof ($pow4=2) && typeof $pow3=='number'?
				Math.pow($pow3,$pow4):
				$p['op_pow']($pow3,$pow4)))==typeof ($div12=12) && typeof $div11=='number' && $div12 !== 0?
				$div11/$div12:
				$p['op_div']($div11,$div12))]), $p['tuple']([$p['getattr'](g, 'expovariate'), $p['tuple']([1.5]), (typeof ($div13=1)==typeof ($div14=1.5) && typeof $div13=='number' && $div14 !== 0?
				$div13/$div14:
				$p['op_div']($div13,$div14)), (typeof ($div15=1)==typeof ($div16=(typeof ($pow5=1.5)==typeof ($pow6=2) && typeof $pow5=='number'?
				Math.pow($pow5,$pow6):
				$p['op_pow']($pow5,$pow6))) && typeof $div15=='number' && $div16 !== 0?
				$div15/$div16:
				$p['op_div']($div15,$div16))]), $p['tuple']([$p['getattr'](g, 'paretovariate'), $p['tuple']([5.0]), (typeof ($div17=5.0)==typeof ($div18=(typeof ($sub5=5.0)==typeof ($sub6=1) && (typeof $sub5=='number'||typeof $sub5=='string')?
				$sub5-$sub6:
				$p['op_sub']($sub5,$sub6))) && typeof $div17=='number' && $div18 !== 0?
				$div17/$div18:
				$p['op_div']($div17,$div18)), (typeof ($div19=5.0)==typeof ($div20=(typeof ($mul7=(typeof ($pow7=(typeof ($sub7=5.0)==typeof ($sub8=1) && (typeof $sub7=='number'||typeof $sub7=='string')?
				$sub7-$sub8:
				$p['op_sub']($sub7,$sub8)))==typeof ($pow8=2) && typeof $pow7=='number'?
				Math.pow($pow7,$pow8):
				$p['op_pow']($pow7,$pow8)))==typeof ($mul8=(typeof ($sub9=5.0)==typeof ($sub10=2) && (typeof $sub9=='number'||typeof $sub9=='string')?
				$sub9-$sub10:
				$p['op_sub']($sub9,$sub10))) && typeof $mul7=='number'?
				$mul7*$mul8:
				$p['op_mul']($mul7,$mul8))) && typeof $div19=='number' && $div20 !== 0?
				$div19/$div20:
				$p['op_div']($div19,$div20))]), $p['tuple']([$p['getattr'](g, 'weibullvariate'), $p['tuple']([1.0, 3.0]), $m['gamma']((typeof ($add13=1)==typeof ($add14=(typeof ($div21=1)==typeof ($div22=3.0) && typeof $div21=='number' && $div22 !== 0?
				$div21/$div22:
				$p['op_div']($div21,$div22))) && (typeof $add13=='number'||typeof $add13=='string')?
				$add13+$add14:
				$p['op_add']($add13,$add14))), (typeof ($sub11=$m['gamma']((typeof ($add15=1)==typeof ($add16=(typeof ($div23=2)==typeof ($div24=3.0) && typeof $div23=='number' && $div24 !== 0?
				$div23/$div24:
				$p['op_div']($div23,$div24))) && (typeof $add15=='number'||typeof $add15=='string')?
				$add15+$add16:
				$p['op_add']($add15,$add16))))==typeof ($sub12=(typeof ($pow9=$m['gamma']((typeof ($add17=1)==typeof ($add18=(typeof ($div25=1)==typeof ($div26=3.0) && typeof $div25=='number' && $div26 !== 0?
				$div25/$div26:
				$p['op_div']($div25,$div26))) && (typeof $add17=='number'||typeof $add17=='string')?
				$add17+$add18:
				$p['op_add']($add17,$add18))))==typeof ($pow10=2) && typeof $pow9=='number'?
				Math.pow($pow9,$pow10):
			...
			while (typeof ($iter6_nextval=($iter6_type?($iter6_type > 0?$iter6_iter.next(true,false):$p['wrapped_next']($iter6_iter)):$iter6_array[$iter6_idx++])) != 'undefined') {
				...
				g.random = $p['getattr'](x, 'pop');
				y = $p['list']([]);
				$iter7_iter = $p['xrange']((($len2=x) === null?0:
				...
				while (typeof ($iter8_nextval=($iter8_type?($iter8_type > 0?$iter8_iter.next(true,false):$p['wrapped_next']($iter8_iter)):$iter8_array[$iter8_idx++])) != 'undefined') {
					...
					s2 = (typeof ($add21=s2)==typeof ($add22=(typeof ($pow11=(typeof ($sub13=e)==typeof ($sub14=mu) && (typeof $sub13=='number'||typeof $sub13=='string')?
						$sub13-$sub14:
						$p['op_sub']($sub13,$sub14)))==typeof ($pow12=2) && typeof $pow11=='number'?
				...
				self['assertAlmostEqual']((typeof ($div35=s1)==typeof ($div36=N) && typeof $div35=='number' && $div36 !== 0?
					$div35/$div36:
					$p['op_div']($div35,$div36)), mu, 2);
				self['assertAlmostEqual']((typeof ($div37=s2)==typeof ($div38=(typeof ($sub15=N)==typeof ($sub16=1) && (typeof $sub15=='number'||typeof $sub15=='string')?
					$sub15-$sub16:
					$p['op_sub']($sub15,$sub16))) && typeof $div37=='number' && $div38 !== 0?
					$div37/$div38:
					$p['op_div']($div37,$div38)), sigmasqrd, 2);
			}
			return null;
		}
	, 1, [null,null,['self']]);
