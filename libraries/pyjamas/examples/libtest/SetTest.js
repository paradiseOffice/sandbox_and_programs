...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, ['args',null,['self']]);
		...
		$method = $pyjs__bind_method2('__hash__', function() {
			...
			var $add2,$add1;
			self.hash_count = (typeof ($add1=$p['getattr'](self, 'hash_count'))==typeof ($add2=1) && (typeof $add1=='number'||typeof $add1=='string')?
				$add1+$add2:
				$p['op_add']($add1,$add2));
			return $p['float_int']['__hash__'](self);
		}
	, 1, [null,null,['self']]);
		$cls_definition['__hash__'] = $method;
	...
	, 1, ['args',['kwargs'],['self']]);
		...
		$method = $pyjs__bind_method2('test_new_or_init', function() {
			...
			self['assertRaises']($p['TypeError'], $p['getattr'](self, 'thetype'), $p['list']([]), 2);
			return null;
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_len', function() {
			...
			var $len2,$len1;
			self['assertEqual']((($len1=$p['getattr'](self, 's')) === null?0:
				(typeof $len1.__array != 'undefined' ? $len1.__array.length:
					(typeof $len1.__len__ == 'function'?$len1.__len__():
						(typeof $len1.length != 'undefined'?$len1.length:
							$p['len']($len1))))), (($len2=$p['getattr'](self, 'd')) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_or', function() {
			...
			self['assertEqual'](($p['getattr'](self, 's'))|($p['set']($p['getattr'](self, 'otherword'))), i);
			self['assertEqual'](($p['getattr'](self, 's'))|($p['frozenset']($p['getattr'](self, 'otherword'))), i);
			try {
				v = ($p['getattr'](self, 's'))|($p['getattr'](self, 'otherword'));
				throw $p['TryElse'];
			} catch($pyjs_try_err) {
			...
			while (typeof ($iter6_nextval=($iter6_type?($iter6_type > 0?$iter6_iter.next(true,false):$p['wrapped_next']($iter6_iter)):$iter6_array[$iter6_idx++])) != 'undefined') {
				...
				while (typeof ($iter7_nextval=($iter7_type?($iter7_type > 0?$iter7_iter.next(true,false):$p['wrapped_next']($iter7_iter)):$iter7_array[$iter7_idx++])) != 'undefined') {
					...
					while (typeof ($iter8_nextval=($iter8_type?($iter8_type > 0?$iter8_iter.next(true,false):$p['wrapped_next']($iter8_iter)):$iter8_array[$iter8_idx++])) != 'undefined') {
						...
						expected = f(s1, s2);
						self['assertEqual'](actual, expected);
						self['assert_'](((($bool6=$or3=(actual === true)) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
							false :
							(typeof $bool6=='object'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_symmetric_difference', function() {
			...
			while (typeof ($iter11_nextval=($iter11_type?($iter11_type > 0?$iter11_iter.next(true,false):$p['wrapped_next']($iter11_iter)):$iter11_array[$iter11_idx++])) != 'undefined') {
				c = $iter11_nextval;
				self['assertEqual'](i.__contains__(c), ($p['getattr'](self, 'd').__contains__(c))^($p['getattr'](self, 'otherword').__contains__(c)));
			}
			self['assertEqual']($p['getattr'](self, 's'), self['thetype']($p['getattr'](self, 'word')));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_equality', function() {
			...
			self['assertEqual']((($eq1=$p['getattr'](self, 's'))===($eq2=$p['getattr'](self, 'word'))&&$eq1===null?true:
			...
			self['assertEqual'](!(($eq3=$p['getattr'](self, 's'))===($eq4=$p['getattr'](self, 'word'))&&$eq3===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_setOfFrozensets', function() {
			...
			s = self['thetype'](t);
			self['assertEqual']((($len3=s) === null?0:
	...
	$m['SetTest'] = (function(){
		...
		$method = $pyjs__bind_method2('test_init', function() {
			...
			self['assertRaises']($p['TypeError'], $p['getattr'](s, '__init__'), s, 2);
			self['assertRaises']($p['TypeError'], $p['getattr'](s, '__init__'), 1);
			return null;
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_clear', function() {
			...
			self['assertEqual']((($len4=$p['getattr'](self, 's')) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_remove_keyerror_unpacking', function() {
			...
			$iter13_iter = $p['list'](['Q', $p['tuple']([1])]);
		...
		$method = $pyjs__bind_method2('test_remove_keyerror_set', function() {
			...
			try {
				...
				if ($pyjs_try_err.__name__ == 'TryElse') {
					...
					if (($pyjs_try_err_name == $p['KeyError'].__name__)||$p['_isinstance']($pyjs_try_err,$p['KeyError'])) {
						e = $pyjs_try_err;
						self['assertTrue'](((typeof ($3=e).__array != 'undefined'?
							((typeof $3.__array[$4=0]) != 'undefined'?$3.__array[$4]:
								$3.__getitem__($4)):
								$3.__getitem__(0)) === key), $p['sprintf']('KeyError should be %s, not %s', $p['tuple']([key, (typeof ($5=e).__array != 'undefined'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_pop', function() {
			...
			$iter14_iter = $p['xrange']((($len5=$p['getattr'](self, 's')) === null?0:
		...
		$method = $pyjs__bind_method2('test_update', function() {
			...
			while (typeof ($iter18_nextval=($iter18_type?($iter18_type > 0?$iter18_iter.next(true,false):$p['wrapped_next']($iter18_iter)):$iter18_array[$iter18_idx++])) != 'undefined') {
				...
				while (typeof ($iter19_nextval=($iter19_type?($iter19_type > 0?$iter19_iter.next(true,false):$p['wrapped_next']($iter19_iter)):$iter19_array[$iter19_idx++])) != 'undefined') {
					...
					self['assertEqual'](s, ($p['set'](s))|($p['set'](p))|($p['set'](q)));
				}
			}
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_ior', function() {
			...
			self['s'] |= $p['set']($p['getattr'](self, 'otherword'));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_isub', function() {
			...
			self.s = (typeof ($sub1=$p['getattr'](self, 's'))==typeof ($sub2=$p['set']($p['getattr'](self, 'otherword'))) && (typeof $sub1=='number'||typeof $sub1=='string')?
				$sub1-$sub2:
				$p['op_sub']($sub1,$sub2));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_symmetric_difference_update', function() {
			...
			while (typeof ($iter29_nextval=($iter29_type?($iter29_type > 0?$iter29_iter.next(true,false):$p['wrapped_next']($iter29_iter)):$iter29_array[$iter29_idx++])) != 'undefined') {
				c = $iter29_nextval;
				if ((($bool18=($p['getattr'](self, 'word').__contains__(c))^($p['getattr'](self, 'otherword').__contains__(c))) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
						false :
		...
		$method = $pyjs__bind_method2('test_ixor', function() {
			...
			if ((($bool19=$p['isinstance']($p['getattr'](self, 's'), $p['set'])) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
				...
				while (typeof ($iter32_nextval=($iter32_type?($iter32_type > 0?$iter32_iter.next(true,false):$p['wrapped_next']($iter32_iter)):$iter32_array[$iter32_idx++])) != 'undefined') {
					c = $iter32_nextval;
					if ((($bool20=($p['getattr'](self, 'word').__contains__(c))^($p['getattr'](self, 'otherword').__contains__(c))) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
							false :
	...
	$m['TestSetSubclassWithKeywordArgs'] = (function(){
		...
		$method = $pyjs__bind_method2('test_keywords_in_subclass', function() {
			...
			$pyjs_kwargs_call(null, $m['SetSubclassWithKeywordArgs'], null, null, [{newarg:1}]);
			return null;
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_singleton_empty_frozenset', function() {
			...
			var $len6,efs,f;
			f = $p['frozenset']();
			efs = $p['list']([$p['frozenset'](), $p['frozenset']($p['list']([])), $p['frozenset']($p['tuple']([])), $p['frozenset'](''), $p['frozenset'](), $p['frozenset']($p['list']([])), $p['frozenset']($p['tuple']([])), $p['frozenset'](''), $p['frozenset']($p['xrange'](0)), $p['frozenset']($p['frozenset']()), $p['frozenset'](f), f]);
			self['assertEqual']((($len6=$p['set']($p['map']($p['hash'], efs))) === null?0:
	...
	return $collcomp1;}();
			...
			self['assertEqual']((($len7=results) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_frozen_as_dictkey', function() {
			...
			seq = (typeof ($add21=(typeof ($add19=$p['range'](10))==typeof ($add20=$p['list']('abcdefg')) && (typeof $add19=='number'||typeof $add19=='string')?
				$add19+$add20:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_hash_effectiveness', function() {
			...
			elemmasks = $p['list']([$p['tuple']([1, 1]), $p['tuple']([2, 2]), $p['tuple']([3, 4]), $p['tuple']([4, 8]), $p['tuple']([5, 16]), $p['tuple']([6, 32]), $p['tuple']([7, 64]), $p['tuple']([8, 128]), $p['tuple']([9, 256]), $p['tuple']([10, 512]), $p['tuple']([11, 1024]), $p['tuple']([12, 2048]), $p['tuple']([13, 4096])]);
			$iter35_iter = $p['xrange']((typeof ($pow1=2)==typeof ($pow2=n) && typeof $pow1=='number'?
				Math.pow($pow1,$pow2):
				$p['op_pow']($pow1,$pow2)));
	...
	$collcomp2 = $p['list']();
				...
				while (typeof ($iter36_nextval=($iter36_type?($iter36_type > 0?$iter36_iter.next(true,false):$p['wrapped_next']($iter36_iter)):$iter36_array[$iter36_idx++])) != 'undefined') {
					...
					e = $tupleassign6[0];
					m = $tupleassign6[1];
					if ((($bool21=(m)&(i)) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
							false :
	...
	return $collcomp2;}())));
			...
			self['assertEqual']((($len8=hashvalues) === null?0:
				(typeof $len8.__array != 'undefined' ? $len8.__array.length:
					(typeof $len8.__len__ == 'function'?$len8.__len__():
						(typeof $len8.length != 'undefined'?$len8.length:
							$p['len']($len8))))), (typeof ($pow3=2)==typeof ($pow4=n) && typeof $pow3=='number'?
				Math.pow($pow3,$pow4):
				$p['op_pow']($pow3,$pow4)));
			return null;
		}
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_singleton_empty_frozenset', function() {
			...
			f = $p['frozenset']();
			F = Frozenset();
			efs = $p['list']([Frozenset(), Frozenset($p['list']([])), Frozenset($p['tuple']([])), Frozenset(''), Frozenset(), Frozenset($p['list']([])), Frozenset($p['tuple']([])), Frozenset(''), Frozenset($p['xrange'](0)), Frozenset(Frozenset()), Frozenset($p['frozenset']()), f, F, Frozenset(f), Frozenset(F)]);
			self['assertEqual']((($len9=$p['set']($p['map']($p['hash'], efs))) === null?0:
	...
	$m['TestBasicOps'] = (function(){
		...
		$method = $pyjs__bind_method2('test_repr', function() {
			...
			var $bool22;
			if ((($bool22=($p['getattr'](self, 'repr') !== null)) === null || $bool22 === false || $bool22 === 0 || $bool22 === '' ?
					false :
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_length', function() {
			...
			var $len11;
			self['assertEqual']((($len11=$p['getattr'](self, 'set')) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_self_union', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))|($p['getattr'](self, 'set'));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_empty_union', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))|($m['empty_set']);
			self['assertEqual'](result, $p['getattr'](self, 'dup'));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_union_empty', function() {
			...
			var result;
			result = ($m['empty_set'])|($p['getattr'](self, 'set'));
			self['assertEqual'](result, $p['getattr'](self, 'dup'));
			return null;
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_iteration', function() {
			...
			self['assertEqual'](setiter['__length_hint__'](), (($len12=$p['getattr'](self, 'set')) === null?0:
	...
	$m['TestBasicOpsEmpty'] = (function(){
		...
		$method = $pyjs__bind_method2('setUp', function() {
			...
			self.$$case = 'empty set';
			self.values = $p['list']([]);
			self.set = $p['set']($p['getattr'](self, 'values'));
			self.dup = $p['set']($p['getattr'](self, 'values'));
			self.length = 0;
			self.repr = 'set([])';
			return null;
		}
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_in', function() {
			...
			self['failUnless']($p['getattr'](self, 'set').__contains__(3));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_not_in', function() {
			...
			self['failUnless'](!$p['getattr'](self, 'set').__contains__(2));
			return null;
		}
	, 1, [null,null,['self']]);
	...
	$m['TestBasicOpsTuple'] = (function(){
		...
		$method = $pyjs__bind_method2('setUp', function() {
			...
			self.values = $p['list']([$p['tuple']([0, 'zero'])]);
			self.set = $p['set']($p['getattr'](self, 'values'));
			self.dup = $p['set']($p['getattr'](self, 'values'));
			self.length = 1;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_in', function() {
			...
			self['failUnless']($p['getattr'](self, 'set').__contains__($p['tuple']([0, 'zero'])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_in'] = $method;
		$method = $pyjs__bind_method2('test_not_in', function() {
			...
			self['failUnless'](!$p['getattr'](self, 'set').__contains__(9));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_not_in'] = $method;
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_instancesWithoutException', function() {
			...
			$p['set']($p['list']([1, 2, 3]));
			$p['set']($p['tuple']([1, 2, 3]));
			$p['set']($p['dict']([['one', 1], ['two', 2], ['three', 3]]));
			$p['set']($p['xrange'](3));
			$p['set']('abc');
			$p['set']($m['gooditer']());
			return null;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_eq', function() {
			...
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['dict']([[2, 1], [4, 3], [6, 5]])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_union_subset', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))|($p['set']($p['list']([2])));
			self['assertEqual'](result, $p['set']($p['tuple']([2, 4, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_union_superset', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))|($p['set']($p['list']([2, 4, 6, 8])));
			self['assertEqual'](result, $p['set']($p['list']([2, 4, 6, 8])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_union_overlap', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))|($p['set']($p['list']([3, 4, 5])));
			self['assertEqual'](result, $p['set']($p['list']([2, 3, 4, 5, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_union_non_overlap', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))|($p['set']($p['list']([8])));
			self['assertEqual'](result, $p['set']($p['list']([2, 4, 6, 8])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_intersection_subset', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))&($p['set']($p['tuple']([2, 4])));
			self['assertEqual'](result, $p['set']($p['tuple']([2, 4])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_intersection_superset', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))&($p['set']($p['list']([2, 4, 6, 8])));
			self['assertEqual'](result, $p['set']($p['list']([2, 4, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_intersection_overlap', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))&($p['set']($p['list']([3, 4, 5])));
			self['assertEqual'](result, $p['set']($p['list']([4])));
			return null;
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_isdisjoint_subset', function() {
			...
			var result;
			result = self['set']['isdisjoint']($p['set']($p['tuple']([2, 4])));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_isdisjoint_superset', function() {
			...
			var result;
			result = self['set']['isdisjoint']($p['set']($p['list']([2, 4, 6, 8])));
			self['assertEqual'](result, false);
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_isdisjoint_overlap', function() {
			...
			var result;
			result = self['set']['isdisjoint']($p['set']($p['list']([3, 4, 5])));
			self['assertEqual'](result, false);
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_isdisjoint_non_overlap', function() {
			...
			var result;
			result = self['set']['isdisjoint']($p['set']($p['list']([8])));
			self['assertEqual'](result, true);
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_sym_difference_subset', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))^($p['set']($p['tuple']([2, 4])));
			self['assertEqual'](result, $p['set']($p['list']([6])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_sym_difference_superset', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))^($p['set']($p['tuple']([2, 4, 6, 8])));
			self['assertEqual'](result, $p['set']($p['list']([8])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_sym_difference_overlap', function() {
			...
			var result;
			result = ($p['getattr'](self, 'set'))^($p['set']($p['tuple']([3, 4, 5])));
			self['assertEqual'](result, $p['set']($p['list']([2, 3, 5, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_cmp', function() {
			...
			self['assertEqual']($p['cmp'](a, a), 0);
			self['assertRaises']($p['TypeError'], $p['cmp'], a, 12);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_union_subset', function() {
			...
			self['set'] |= $p['set']($p['list']([2]));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['tuple']([2, 4, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_union_subset'] = $method;
		$method = $pyjs__bind_method2('test_union_superset', function() {
			...
			self['set'] |= $p['set']($p['list']([2, 4, 6, 8]));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([2, 4, 6, 8])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_union_superset'] = $method;
		$method = $pyjs__bind_method2('test_union_overlap', function() {
			...
			self['set'] |= $p['set']($p['list']([3, 4, 5]));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([2, 3, 4, 5, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_union_overlap'] = $method;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_union_method_call', function() {
			...
			self['set']['update']($p['set']($p['list']([3, 4, 5])));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([2, 3, 4, 5, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_intersection_subset', function() {
			...
			self['set'] &= $p['set']($p['tuple']([2, 4]));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['tuple']([2, 4])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_intersection_subset'] = $method;
		$method = $pyjs__bind_method2('test_intersection_superset', function() {
			...
			self['set'] &= $p['set']($p['list']([2, 4, 6, 8]));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([2, 4, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_intersection_superset'] = $method;
		$method = $pyjs__bind_method2('test_intersection_overlap', function() {
			...
			self['set'] &= $p['set']($p['list']([3, 4, 5]));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([4])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_intersection_overlap'] = $method;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_intersection_method_call', function() {
			...
			self['set']['intersection_update']($p['set']($p['list']([3, 4, 5])));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([4])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_sym_difference_subset', function() {
			...
			self['set'] ^= $p['set']($p['tuple']([2, 4]));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([6])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_sym_difference_subset'] = $method;
		$method = $pyjs__bind_method2('test_sym_difference_superset', function() {
			...
			self['set'] ^= $p['set']($p['tuple']([2, 4, 6, 8]));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([8])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_sym_difference_superset'] = $method;
		$method = $pyjs__bind_method2('test_sym_difference_overlap', function() {
			...
			self['set'] ^= $p['set']($p['tuple']([3, 4, 5]));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([2, 3, 5, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['test_sym_difference_overlap'] = $method;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_sym_difference_method_call', function() {
			...
			self['set']['symmetric_difference_update']($p['set']($p['list']([3, 4, 5])));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([2, 3, 5, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_difference_subset', function() {
			...
			var $sub12,$sub11;
			self.set = (typeof ($sub11=$p['getattr'](self, 'set'))==typeof ($sub12=$p['set']($p['tuple']([2, 4]))) && (typeof $sub11=='number'||typeof $sub11=='string')?
				$sub11-$sub12:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_difference_superset', function() {
			...
			var $sub13,$sub14;
			self.set = (typeof ($sub13=$p['getattr'](self, 'set'))==typeof ($sub14=$p['set']($p['tuple']([2, 4, 6, 8]))) && (typeof $sub13=='number'||typeof $sub13=='string')?
				$sub13-$sub14:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_difference_overlap', function() {
			...
			var $sub16,$sub15;
			self.set = (typeof ($sub15=$p['getattr'](self, 'set'))==typeof ($sub16=$p['set']($p['tuple']([3, 4, 5]))) && (typeof $sub15=='number'||typeof $sub15=='string')?
				$sub15-$sub16:
				$p['op_sub']($sub15,$sub16));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([2, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_difference_non_overlap', function() {
			...
			var $sub18,$sub17;
			self.set = (typeof ($sub17=$p['getattr'](self, 'set'))==typeof ($sub18=$p['set']($p['list']([8]))) && (typeof $sub17=='number'||typeof $sub17=='string')?
				$sub17-$sub18:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_difference_method_call', function() {
			...
			self['set']['difference_update']($p['set']($p['list']([3, 4, 5])));
			self['assertEqual']($p['getattr'](self, 'set'), $p['set']($p['list']([2, 6])));
			return null;
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_add_until_full', function() {
			...
			while (typeof ($iter39_nextval=($iter39_type?($iter39_type > 0?$iter39_iter.next(true,false):$p['wrapped_next']($iter39_iter)):$iter39_array[$iter39_idx++])) != 'undefined') {
				v = $iter39_nextval;
				tmp['add'](v);
				expected_len = (typeof ($add23=expected_len)==typeof ($add24=1) && (typeof $add23=='number'||typeof $add23=='string')?
					$add23+$add24:
					$p['op_add']($add23,$add24));
				self['assertEqual']((($len13=tmp) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_remove_until_empty', function() {
			...
			expected_len = (($len14=$p['getattr'](self, 'set')) === null?0:
			...
			while (typeof ($iter40_nextval=($iter40_type?($iter40_type > 0?$iter40_iter.next(true,false):$p['wrapped_next']($iter40_iter)):$iter40_array[$iter40_idx++])) != 'undefined') {
				v = $iter40_nextval;
				self['set']['remove'](v);
				expected_len = (typeof ($sub19=expected_len)==typeof ($sub20=1) && (typeof $sub19=='number'||typeof $sub19=='string')?
					$sub19-$sub20:
					$p['op_sub']($sub19,$sub20));
				self['assertEqual']((($len15=$p['getattr'](self, 'set')) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_clear', function() {
			...
			var $len16;
			self['set']['clear']();
			self['assertEqual']((($len16=$p['getattr'](self, 'set')) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_pop', function() {
			...
			self['assertEqual']((($len17=popped) === null?0:
				(typeof $len17.__array != 'undefined' ? $len17.__array.length:
					(typeof $len17.__len__ == 'function'?$len17.__len__():
						(typeof $len17.length != 'undefined'?$len17.length:
							$p['len']($len17))))), (($len18=$p['getattr'](self, 'values')) === null?0:
	...
	$m['TestSubsetEqualNonEmpty'] = (function(){
		...
		var $method;
		$cls_definition.__module__ = 'SetTest';
		$cls_definition['left'] = $p['set']($p['list']([1, 2]));
		$cls_definition['right'] = $p['set']($p['list']([1, 2]));
	...
	$m['TestSubsetPartial'] = (function(){
		...
		var $method;
		$cls_definition.__module__ = 'SetTest';
		$cls_definition['left'] = $p['set']($p['list']([1]));
		$cls_definition['right'] = $p['set']($p['list']([1, 2]));
	...
	$m['TestSubsetNonOverlap'] = (function(){
		...
		$cls_definition.__module__ = 'SetTest';
		$cls_definition['left'] = $p['set']($p['list']([1]));
		$cls_definition['right'] = $p['set']($p['list']([2]));
	...
	$m['TestOnlySetsInBinaryOps'] = (function(){
		...
		$method = $pyjs__bind_method2('test_eq_ne', function() {
			...
			var $eq8,$eq9,$eq6,$eq7,$eq5,$eq10,$eq11,$eq12;
			self['assertEqual']((($eq5=$p['getattr'](self, 'other'))===($eq6=$p['getattr'](self, 'set'))&&$eq5===null?true:
				($eq5===null?false:($eq6===null?false:
					((typeof $eq5=='object'||typeof $eq5=='function')&&typeof $eq5.__cmp__=='function'?$eq5.__cmp__($eq6) === 0:
						((typeof $eq6=='object'||typeof $eq6=='function')&&typeof $eq6.__cmp__=='function'?$eq6.__cmp__($eq5) === 0:
							$eq5==$eq6))))), false);
			self['assertEqual']((($eq7=$p['getattr'](self, 'set'))===($eq8=$p['getattr'](self, 'other'))&&$eq7===null?true:
				($eq7===null?false:($eq8===null?false:
					((typeof $eq7=='object'||typeof $eq7=='function')&&typeof $eq7.__cmp__=='function'?$eq7.__cmp__($eq8) === 0:
						((typeof $eq8=='object'||typeof $eq8=='function')&&typeof $eq8.__cmp__=='function'?$eq8.__cmp__($eq7) === 0:
							$eq7==$eq8))))), false);
			self['assertEqual'](!(($eq9=$p['getattr'](self, 'other'))===($eq10=$p['getattr'](self, 'set'))&&$eq9===null?true:
				($eq9===null?false:($eq10===null?false:
					((typeof $eq9=='object'||typeof $eq9=='function')&&typeof $eq9.__cmp__=='function'?$eq9.__cmp__($eq10) === 0:
						((typeof $eq10=='object'||typeof $eq10=='function')&&typeof $eq10.__cmp__=='function'?$eq10.__cmp__($eq9) === 0:
							$eq9==$eq10))))), true);
			self['assertEqual'](!(($eq11=$p['getattr'](self, 'set'))===($eq12=$p['getattr'](self, 'other'))&&$eq11===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_union', function() {
			...
			var 			$lambda9 = function() {
				...
				return ($p['getattr'](self, 'set'))|($p['getattr'](self, 'other'));
			};
			...
			var 			$lambda10 = function() {
				...
				return ($p['getattr'](self, 'other'))|($p['getattr'](self, 'set'));
			};
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_difference_update_operator', function() {
			...
			try {
				self.set = (typeof ($sub21=$p['getattr'](self, 'set'))==typeof ($sub22=$p['getattr'](self, 'other')) && (typeof $sub21=='number'||typeof $sub21=='string')?
					$sub21-$sub22:
	...
	$m['TestOnlySetsOperator'] = (function(){
		...
		$method = $pyjs__bind_method2('setUp', function() {
			...
			self.set = $p['set']($p['tuple']([1, 2, 3]));
			self.other = $p['getattr']((typeof operator == "undefined"?$m.operator:operator), 'add');
			self.otherIsIterable = false;
			return null;
		}
	, 1, [null,null,['self']]);
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	$m['TestCopying'] = (function(){
		...
		$method = $pyjs__bind_method2('test_copy', function() {
			...
			set_list['sort']();
			self['assertEqual']((($len19=dup_list) === null?0:
				(typeof $len19.__array != 'undefined' ? $len19.__array.length:
					(typeof $len19.__len__ == 'function'?$len19.__len__():
						(typeof $len19.length != 'undefined'?$len19.length:
							$p['len']($len19))))), (($len20=set_list) === null?0:
				(typeof $len20.__array != 'undefined' ? $len20.__array.length:
					(typeof $len20.__len__ == 'function'?$len20.__len__():
						(typeof $len20.length != 'undefined'?$len20.length:
							$p['len']($len20))))));
			$iter45_iter = $p['range']((($len21=dup_list) === null?0:
			...
			while (typeof ($iter45_nextval=($iter45_type?($iter45_type > 0?$iter45_iter.next(true,false):$p['wrapped_next']($iter45_iter)):$iter45_array[$iter45_idx++])) != 'undefined') {
				i = $iter45_nextval;
				self['failUnless'](((typeof ($15=dup_list).__array != 'undefined'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_deep_copy', function() {
			...
			set_list = $p['list']($p['getattr'](self, 'set'));
			set_list['sort']();
			self['assertEqual']((($len22=dup_list) === null?0:
				(typeof $len22.__array != 'undefined' ? $len22.__array.length:
					(typeof $len22.__len__ == 'function'?$len22.__len__():
						(typeof $len22.length != 'undefined'?$len22.length:
							$p['len']($len22))))), (($len23=set_list) === null?0:
				(typeof $len23.__array != 'undefined' ? $len23.__array.length:
					(typeof $len23.__len__ == 'function'?$len23.__len__():
						(typeof $len23.length != 'undefined'?$len23.length:
							$p['len']($len23))))));
			$iter46_iter = $p['range']((($len24=dup_list) === null?0:
	...
	$m['TestCopyingTriple'] = (function(){
		...
		$method = $pyjs__bind_method2('setUp', function() {
			...
			self.set = $p['set']($p['list'](['zero', 0, null]));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['setUp'] = $method;
	...
	$m['TestCopyingTuple'] = (function(){
		...
		$method = $pyjs__bind_method2('setUp', function() {
			...
			self.set = $p['set']($p['list']([$p['tuple']([1, 2])]));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['setUp'] = $method;
	...
	$m['TestCopyingNested'] = (function(){
		...
		$method = $pyjs__bind_method2('setUp', function() {
			...
			self.set = $p['set']($p['list']([$p['tuple']([$p['tuple']([1, 2]), $p['tuple']([3, 4])])]));
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['setUp'] = $method;
	...
	$m['TestIdentities'] = (function(){
		...
		$method = $pyjs__bind_method2('setUp', function() {
			...
			self.a = $p['set']('abracadabra');
			self.b = $p['set']('alacazam');
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['setUp'] = $method;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_commutativity', function() {
			...
			var a,$sub31,$sub33,b,$sub34,$sub32,$bool35,$eq13,$eq14;
			...
			self['assertEqual']((a)|(b), (b)|(a));
			self['assertEqual']((a)^(b), (b)^(a));
			if ((($bool35=!(($eq13=a)===($eq14=b)&&$eq13===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_summations', function() {
			...
			a = $tupleassign10[0];
			b = $tupleassign10[1];
			self['assertEqual'](((typeof ($sub35=a)==typeof ($sub36=b) && (typeof $sub35=='number'||typeof $sub35=='string')?
				$sub35-$sub36:
				$p['op_sub']($sub35,$sub36)))|((a)&(b))|((typeof ($sub37=b)==typeof ($sub38=a) && (typeof $sub37=='number'||typeof $sub37=='string')?
				$sub37-$sub38:
				$p['op_sub']($sub37,$sub38))), (a)|(b));
			self['assertEqual'](((a)&(b))|((a)^(b)), (a)|(b));
			self['assertEqual']((a)|((typeof ($sub39=b)==typeof ($sub40=a) && (typeof $sub39=='number'||typeof $sub39=='string')?
				$sub39-$sub40:
				$p['op_sub']($sub39,$sub40))), (a)|(b));
			self['assertEqual'](((typeof ($sub41=a)==typeof ($sub42=b) && (typeof $sub41=='number'||typeof $sub41=='string')?
				$sub41-$sub42:
				$p['op_sub']($sub41,$sub42)))|(b), (a)|(b));
			self['assertEqual'](((typeof ($sub43=a)==typeof ($sub44=b) && (typeof $sub43=='number'||typeof $sub43=='string')?
				$sub43-$sub44:
				$p['op_sub']($sub43,$sub44)))|((a)&(b)), a);
			self['assertEqual'](((typeof ($sub45=b)==typeof ($sub46=a) && (typeof $sub45=='number'||typeof $sub45=='string')?
				$sub45-$sub46:
				$p['op_sub']($sub45,$sub46)))|((a)&(b)), b);
			self['assertEqual'](((typeof ($sub47=a)==typeof ($sub48=b) && (typeof $sub47=='number'||typeof $sub47=='string')?
				$sub47-$sub48:
				$p['op_sub']($sub47,$sub48)))|((typeof ($sub49=b)==typeof ($sub50=a) && (typeof $sub49=='number'||typeof $sub49=='string')?
				$sub49-$sub50:
				$p['op_sub']($sub49,$sub50))), (a)^(b));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_exclusion', function() {
			...
			self['assertEqual'](((typeof ($sub51=a)==typeof ($sub52=b) && (typeof $sub51=='number'||typeof $sub51=='string')?
				$sub51-$sub52:
				$p['op_sub']($sub51,$sub52)))&(b), zero);
			self['assertEqual'](((typeof ($sub53=b)==typeof ($sub54=a) && (typeof $sub53=='number'||typeof $sub53=='string')?
				$sub53-$sub54:
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			if ((($bool36=((((($cmp49=$p['getattr'](self, 'i'))===($cmp50=(($len25=$p['getattr'](self, 'seqn')) === null?0:
			...
			self.i = (typeof ($add35=$p['getattr'](self, 'i'))==typeof ($add36=1) && (typeof $add35=='number'||typeof $add35=='string')?
				$add35+$add36:
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self'],['seqn']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			if ((($bool37=((((($cmp51=$p['getattr'](self, 'i'))===($cmp52=(($len26=$p['getattr'](self, 'seqn')) === null?0:
			...
			self.i = (typeof ($add37=$p['getattr'](self, 'i'))==typeof ($add38=1) && (typeof $add37=='number'||typeof $add37=='string')?
				$add37+$add38:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			t = (typeof ($floordiv1=3)==typeof ($floordiv2=0) && typeof $floordiv1=='number' && $floordiv2 !== 0?
	...
	$m['TestVariousIteratorArgs'] = (function(){
		...
		$method = $pyjs__bind_method2('test_constructor', function() {
			...
			while (typeof ($iter51_nextval=($iter51_type?($iter51_type > 0?$iter51_iter.next(true,false):$p['wrapped_next']($iter51_iter)):$iter51_array[$iter51_idx++])) != 'undefined') {
				cons = $iter51_nextval;
				$iter52_iter = $p['tuple'](['123', '', $p['range'](1000), $p['tuple'](['do', 1.2]), $p['xrange'](2000, 2200, 5)]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_inline_methods', function() {
			...
			s = $p['set']('november');
			$iter54_iter = $p['tuple'](['123', '', $p['range'](1000), $p['tuple'](['do', 1.2]), $p['xrange'](2000, 2200, 5), 'december']);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('test_inplace_methods', function() {
			...
			$iter57_iter = $p['tuple'](['123', '', $p['range'](1000), $p['tuple'](['do', 1.2]), $p['xrange'](2000, 2200, 5), 'december']);
