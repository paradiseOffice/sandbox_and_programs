...
$pyjs.loaded_modules['UnitTest'] = function (__mod_name__) {
			...
			(typeof $bool2.__nonzero__=='function'?
				...
				(typeof $bool2.__len__=='function'?
					($bool2.__len__()>0 ?
						...
						false) :
					true ) ) :
			 true ) )?((((($cmp1=$p['__getslice']($p['getattr']($m['sys'], 'version_info'), 0, 2))===($cmp2=$p['tuple']([2, 7]))?0:
	...
	$m['UnitTest'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			self.failUnlessRaises = $p['getattr'](self, 'assertRaises');
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onTimer', function(timer) {
			...
			while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
				i = $iter2_nextval;
				if ((($bool7=((((($cmp3=$p['getattr'](self, 'test_idx'))===($cmp4=(($len1=$p['getattr'](self, 'test_methods')) === null?0:
					...
					(typeof $bool12=='object'?
						(typeof $bool12.__nonzero__=='function'?
							...
							(typeof $bool12.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool13=(($eq1=method['find']('test'))===($eq2=0)&&$eq1===null?true:
	...
	, 1, [null,null,['self'],['method']]);
		...
		$method = $pyjs__bind_method2('fail', function(msg) {
			...
			octothorp = msg['find']('#');
			has_bugreport = ((($bool16=$and3=((((($cmp5=octothorp)===($cmp6=0)?0:
				...
				((typeof $3.__array[$4=(typeof ($add15=octothorp)==typeof ($add16=1) && (typeof $add15=='number'||typeof $add15=='string')?
				$add15+$add16:
				$p['op_add']($add15,$add16))]) != 'undefined'?$3.__array[$4]:
					$3.__getitem__($4)):
					$3.__getitem__((typeof ($add15=octothorp)==typeof ($add16=1) && (typeof $add15=='number'||typeof $add15=='string')?
				$add15+$add16:
...
if (typeof console != 'undefined') {
	...
	, 1, [null,null,['self'],['msg', null]]);
		...
		$method = $pyjs__bind_method2('startTest', function() {
			...
			var $add33,$add34;
			self.tests_completed = (typeof ($add33=$p['getattr'](self, 'tests_completed'))==typeof ($add34=1) && (typeof $add33=='number'||typeof $add33=='string')?
				$add33+$add34:
	...
	, 1, [null,null,['self'],['expr'],['msg', null]]);
		...
		$method = $pyjs__bind_method2('failUnlessEqual', function(first, second, msg) {
			...
			var $add38,$add37,$eq3,$add36,$bool27,$eq4,$add35,$bool25,$bool24,$bool26;
			self['startTest']();
			if ((($bool25=!(($bool24=(($eq3=first)===($eq4=second)&&$eq3===null?true:
				($eq3===null?false:($eq4===null?false:
					((typeof $eq3=='object'||typeof $eq3=='function')&&typeof $eq3.__cmp__=='function'?$eq3.__cmp__($eq4) === 0:
						((typeof $eq4=='object'||typeof $eq4=='function')&&typeof $eq4.__cmp__=='function'?$eq4.__cmp__($eq3) === 0:
							$eq3==$eq4)))))) === null || $bool24 === false || $bool24 === 0 || $bool24 === '' ?
				false :
	...
	, 1, [null,null,['self'],['first'],['second'],['msg', null]]);
		...
		$method = $pyjs__bind_method2('failIfEqual', function(first, second, msg) {
			...
			if (typeof msg == 'undefined') msg=arguments.callee.__args__[5][1];
			var $add39,$eq6,$bool30,$add41,$eq5,$add42,$add40,$bool29,$bool28;
			self['startTest']();
			if ((($bool28=(($eq5=first)===($eq6=second)&&$eq5===null?true:
				($eq5===null?false:($eq6===null?false:
					((typeof $eq5=='object'||typeof $eq5=='function')&&typeof $eq5.__cmp__=='function'?$eq5.__cmp__($eq6) === 0:
						((typeof $eq6=='object'||typeof $eq6=='function')&&typeof $eq6.__cmp__=='function'?$eq6.__cmp__($eq5) === 0:
							$eq5==$eq6)))))) === null || $bool28 === false || $bool28 === 0 || $bool28 === '' ?
					false :
	...
	, 1, [null,null,['self'],['first'],['second'],['msg', null]]);
		...
		$method = $pyjs__bind_method2('failUnlessAlmostEqual', function(first, second, places, msg) {
			...
			var $add49,$add48,$add47,$add46,$add44,$add43,$sub2,$sub1,$eq8,$eq7,$add50,$add51,$add52,$bool32,$bool33,$bool31,$add45;
			self['startTest']();
			if ((($bool31=!(($eq7=$p['round']((typeof ($sub1=second)==typeof ($sub2=first) && (typeof $sub1=='number'||typeof $sub1=='string')?
				$sub1-$sub2:
				$p['op_sub']($sub1,$sub2)), places))===($eq8=0)&&$eq7===null?true:
				($eq7===null?false:($eq8===null?false:
					((typeof $eq7=='object'||typeof $eq7=='function')&&typeof $eq7.__cmp__=='function'?$eq7.__cmp__($eq8) === 0:
						((typeof $eq8=='object'||typeof $eq8=='function')&&typeof $eq8.__cmp__=='function'?$eq8.__cmp__($eq7) === 0:
							$eq7==$eq8)))))) === null || $bool31 === false || $bool31 === 0 || $bool31 === '' ?
					false :
	...
	, 1, [null,null,['self'],['first'],['second'],['places', 7],['msg', null]]);
		...
		$method = $pyjs__bind_method2('failIfAlmostEqual', function(first, second, places, msg) {
			...
			self['startTest']();
			if ((($bool34=($p['round']((typeof ($sub3=second)==typeof ($sub4=first) && (typeof $sub3=='number'||typeof $sub3=='string')?
				$sub3-$sub4:
				$p['op_sub']($sub3,$sub4)), places) === 0)) === null || $bool34 === false || $bool34 === 0 || $bool34 === '' ?
					false :
					...
					(typeof $bool37=='object'?
						(typeof $bool37.__nonzero__=='function'?
							...
							(typeof $bool37.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				standardMsg = $p['sprintf']('%s not found in %s', $p['tuple']([$p['__getslice']($p['repr'](member), 0, 80), $p['__getslice']($p['repr'](container), 0, 80)]));
					...
					(typeof $bool39=='object'?
						(typeof $bool39.__nonzero__=='function'?
							...
							(typeof $bool39.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				standardMsg = $p['sprintf']('%s unexpectedly found in %s', $p['tuple']([$p['__getslice']($p['repr'](member), 0, 80), $p['__getslice']($p['repr'](container), 0, 80)]));
