...
$pyjs.loaded_modules['pyjamas.Canvas.ImageLoader'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('addHandle', function(img) {
			...
			var $add2,$add1;
			self.totalImages = (typeof ($add1=$p['getattr'](self, 'totalImages'))==typeof ($add2=1) && (typeof $add1=='number'||typeof $add1=='string')?
				$add1+$add2:
				$p['op_add']($add1,$add2));
	...
	, 1, [null,null,['self'],['img']]);
		...
		$method = $pyjs__bind_method2('dispatchIfComplete', function() {
			...
			if ((($bool2=((($bool1=$and1=($p['getattr'](self, 'callBack') !== null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
				false :
				(typeof $bool1=='object'?
	...
	, 1, [null,null,['self'],['cb']]);
		...
		$method = $pyjs__bind_method2('incrementLoadedImages', function() {
			...
			var $add3,$add4;
			self.loadedImages = (typeof ($add3=$p['getattr'](self, 'loadedImages'))==typeof ($add4=1) && (typeof $add3=='number'||typeof $add3=='string')?
				$add3+$add4:
				$p['op_add']($add3,$add4));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('isAllLoaded', function() {
			...
			var $eq2,$eq1;
			return (($eq1=$p['getattr'](self, 'loadedImages'))===($eq2=$p['getattr'](self, 'totalImages'))&&$eq1===null?true:
