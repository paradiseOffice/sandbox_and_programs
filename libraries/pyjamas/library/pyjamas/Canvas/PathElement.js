...
$pyjs.loaded_modules['pyjamas.Canvas.PathElement'] = function (__mod_name__) {
	...
	$m['arc'] = function(x, y, radius, startAngle, endAngle, antiClockwise, canvas) {
		...
		startX = (typeof ($sub1=(typeof ($add1=x)==typeof ($add2=(typeof ($mul3=$m['math']['cos'](realStartAngle))==typeof ($mul4=ar) && typeof $mul3=='number'?
			...
			$add1+$add2:
			$p['op_add']($add1,$add2)))==typeof ($sub2=5) && (typeof $sub1=='number'||typeof $sub1=='string')?
			$sub1-$sub2:
			$p['op_sub']($sub1,$sub2));
		startY = (typeof ($sub3=(typeof ($add3=y)==typeof ($add4=(typeof ($mul5=$m['math']['sin'](realStartAngle))==typeof ($mul6=ar) && typeof $mul5=='number'?
			...
			$add3+$add4:
			$p['op_add']($add3,$add4)))==typeof ($sub4=5) && (typeof $sub3=='number'||typeof $sub3=='string')?
			$sub3-$sub4:
			$p['op_sub']($sub3,$sub4));
		endX = (typeof ($sub5=(typeof ($add5=x)==typeof ($add6=(typeof ($mul7=$m['math']['cos'](realEndAngle))==typeof ($mul8=ar) && typeof $mul7=='number'?
			...
			$add5+$add6:
			$p['op_add']($add5,$add6)))==typeof ($sub6=5) && (typeof $sub5=='number'||typeof $sub5=='string')?
			$sub5-$sub6:
			$p['op_sub']($sub5,$sub6));
		endY = (typeof ($sub7=(typeof ($add7=y)==typeof ($add8=(typeof ($mul9=$m['math']['sin'](realEndAngle))==typeof ($mul10=ar) && typeof $mul9=='number'?
			...
			$add7+$add8:
			$p['op_add']($add7,$add8)))==typeof ($sub8=5) && (typeof $sub7=='number'||typeof $sub7=='string')?
			$sub7-$sub8:
			$p['op_sub']($sub7,$sub8));
		...
		return (typeof ($add51=(typeof ($add49=(typeof ($add47=(typeof ($add45=(typeof ($add43=(typeof ($add41=(typeof ($add39=(typeof ($add37=(typeof ($add35=(typeof ($add31=(typeof ($add29=(typeof ($add23=(typeof ($add21=(typeof ($add15=(typeof ($add13=$m['ARC'])==typeof ($add14=$p['str']($p['float_int']($m['math']['floor']((typeof ($add11=(typeof ($sub9=cx)==typeof ($sub10=arcX) && (typeof $sub9=='number'||typeof $sub9=='string')?
			$sub9-$sub10:
			...
			$add15+$add16:
			$p['op_add']($add15,$add16)))==typeof ($add22=$p['str']($p['float_int']($m['math']['floor']((typeof ($add19=(typeof ($add17=cy)==typeof ($add18=arcY) && (typeof $add17=='number'||typeof $add17=='string')?
			$add17+$add18:
			...
			$add23+$add24:
			$p['op_add']($add23,$add24)))==typeof ($add30=$p['str']($p['float_int']($m['math']['floor']((typeof ($add27=(typeof ($add25=cx)==typeof ($add26=arcX) && (typeof $add25=='number'||typeof $add25=='string')?
			$add25+$add26:
			...
			$add31+$add32:
			$p['op_add']($add31,$add32)))==typeof ($add36=$p['str']($p['float_int']($m['math']['floor']((typeof ($add33=(typeof ($sub11=cy)==typeof ($sub12=arcY) && (typeof $sub11=='number'||typeof $sub11=='string')?
			$sub11-$sub12:
