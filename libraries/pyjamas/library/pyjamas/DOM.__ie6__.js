...
element.innerHTML = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $bool46,$iter2_nextval,$iter2_type,attr,$iter2_iter,$iter2_idx,val,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			attr = $tupleassign2[0];
			val = $tupleassign2[1];
			if ((($bool46=$p['hasattr']($p['getattr'](element, 'style'), 'setProperty')) === null || $bool46 === false || $bool46 === 0 || $bool46 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,dispEvnt,$iter5_array,$iter3_type,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,bit,$iter3_idx,$iter3_nextval,$iter3_iter,$iter5_idx,$bool47,event_name,$9,$8,$iter3_array,$6,$7,$4,$5,$3,$10,$iter4_nextval,$iter4_idx,$iter4_array;
