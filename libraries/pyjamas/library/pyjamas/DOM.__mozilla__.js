...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $bool36,$bool35;
			if ((($bool36=!(($bool35=$p['getattr'](self, 'child')) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
				false :
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $cmp1,$bool42,$bool41,$bool40,$cmp2,nextSibling,firstChild,$bool37,$len1,$bool38,$bool39;
			if ((($bool38=!(($bool37=$p['getattr'](self, 'child')) === null || $bool37 === false || $bool37 === 0 || $bool37 === '' ?
				false :
			...
			else if ((($bool42=((($cmp1=(($len1=$p['getattr'](self, 'stack')) === null?0:
...
element.innerHTML = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$iter2_idx,val,$bool44,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			attr = $tupleassign2[0];
			val = $tupleassign2[1];
			if ((($bool44=$p['hasattr']($p['getattr'](element, 'style'), 'setProperty')) === null || $bool44 === false || $bool44 === 0 || $bool44 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,$iter3_type,dispEvnt,$iter5_array,$9,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$iter3_idx,$iter3_nextval,$iter3_iter,$iter5_idx,$bool45,event_name,$iter3_array,bit,$14,$15,$16,$10,$11,$12,$13,$iter4_nextval,$iter4_idx,$iter4_array;
...
element['on'+event_name] = null
	...
	if ((($bool54=!(($bool53=$p['getattr']($m['pyjd'], 'is_desktop')) === null || $bool53 === false || $bool53 === 0 || $bool53 === '' ?
		false :
