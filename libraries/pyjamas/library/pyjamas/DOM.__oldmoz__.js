...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $bool34,$bool35;
			if ((($bool35=!(($bool34=$p['getattr'](self, 'child')) === null || $bool34 === false || $bool34 === 0 || $bool34 === '' ?
				false :
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $cmp1,$bool41,$bool40,$cmp2,nextSibling,firstChild,$bool36,$bool37,$len1,$bool38,$bool39;
			if ((($bool37=!(($bool36=$p['getattr'](self, 'child')) === null || $bool36 === false || $bool36 === 0 || $bool36 === '' ?
				false :
			...
			else if ((($bool41=((($cmp1=(($len1=$p['getattr'](self, 'stack')) === null?0:
...
element.innerHTML = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$iter2_idx,val,$bool43,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			attr = $tupleassign2[0];
			val = $tupleassign2[1];
			if ((($bool43=$p['hasattr']($p['getattr'](element, 'style'), 'setProperty')) === null || $bool43 === false || $bool43 === 0 || $bool43 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,$iter3_type,dispEvnt,$iter5_array,$9,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$iter3_idx,$iter3_nextval,$iter3_iter,$iter5_idx,$bool44,event_name,$iter3_array,bit,$14,$15,$16,$10,$11,$12,$13,$iter4_nextval,$iter4_idx,$iter4_array;
...
element['on'+event_name] = null
	...
	if ((($bool53=!(($bool52=$p['getattr']($m['pyjd'], 'is_desktop')) === null || $bool52 === false || $bool52 === 0 || $bool52 === '' ?
		false :
