...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
	...
	$m['eventGetKeyCode'] = function(evt) {
		var $or5,$or7,$or6,$bool32,$bool31;
		return ((($bool31=$or5=$p['getattr'](evt, 'which')) === null || $bool31 === false || $bool31 === 0 || $bool31 === '' ?
			false :
				...
				(typeof $bool31.__nonzero__=='function'?
					...
					(typeof $bool31.__len__=='function'?
						($bool31.__len__()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?$or5:((($bool32=$or6=$p['getattr'](evt, 'keyCode')) === null || $bool32 === false || $bool32 === 0 || $bool32 === '' ?
			false :
	...
	$m['eventGetToElement'] = function(evt) {
		var $eq20,$eq19,$eq18,$bool33,$bool34,type,$eq17;
	...
	$m['getAbsoluteLeft'] = function(elem) {
		var curr,$add2,$add1,$bool36,$bool35,$sub3,$sub2,$sub1,$sub4,left;
		left = 0;
		curr = elem;
		while ((($bool35=$p['getattr'](curr, 'offsetParent')) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
				false :
	...
	$m['getAbsoluteTop'] = function(elem) {
		var curr,top,$add3,$sub8,$bool37,$add4,$bool38,$sub7,$sub6,$sub5;
		top = 0;
		curr = elem;
		while ((($bool37=$p['getattr'](curr, 'offsetParent')) === null || $bool37 === false || $bool37 === 0 || $bool37 === '' ?
				false :
	...
	$m['getChild'] = function(elem, index) {
		var count,$bool45,$bool44,$bool46,$add5,next,$eq21,$eq23,$eq22,$add6,$eq24,child;
		count = 0;
		...
		while ((($bool44=child) === null || $bool44 === false || $bool44 === 0 || $bool44 === '' ?
			...
			if ((($bool45=(($eq21=$p['getattr'](child, 'nodeType'))===($eq22=1)&&$eq21===null?true:
	...
	$m['getChildCount'] = function(elem) {
		var count,$bool47,child,$bool48,$eq25,$add7,$eq26,$add8;
		count = 0;
		child = $p['getattr'](elem, 'firstChild');
				...
				(typeof $bool47=='object'?
					(typeof $bool47.__nonzero__=='function'?
						...
						(typeof $bool47.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool48=(($eq25=$p['getattr'](child, 'nodeType'))===($eq26=1)&&$eq25===null?true:
	...
	$m['getChildIndex'] = function(parent, toFind) {
		var count,$bool50,$bool51,$bool49,$eq30,$eq27,child,$eq29,$eq28,$add9,$add10;
		count = 0;
		...
		while ((($bool49=child) === null || $bool49 === false || $bool49 === 0 || $bool49 === '' ?
			...
			if ((($bool51=(($eq29=$p['getattr'](child, 'nodeType'))===($eq30=1)&&$eq29===null?true:
	...
	$m['getFirstChild'] = function(elem) {
		var $bool54,$and9,$bool52,$bool53,$and12,$and10,$and11,$eq31,child,$eq32;
				...
				(typeof $bool52.__nonzero__=='function'?
					...
					(typeof $bool52.__len__=='function'?
						($bool52.__len__()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?$p['getattr'](elem, 'firstChild'):$and9);
	...
	$m['getInnerHTML'] = function(element) {
		var $bool55,$bool56,$and13,$pyjs_try_err,$and16,$and14,$and15;
		try {
					...
					(typeof $bool55.__nonzero__=='function'?
						...
						(typeof $bool55.__len__=='function'?
							($bool55.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$p['getattr'](element, 'innerHtml'):$and13);
		} catch($pyjs_try_err) {
			var $pyjs_try_err_name = (typeof $pyjs_try_err.__name__ == 'undefined' ? $pyjs_try_err.name : $pyjs_try_err.__name__ );
			$pyjs.__last_exception__ = {error: $pyjs_try_err, module: $m};
			if (true) {
						...
						(typeof $bool56.__nonzero__=='function'?
							...
							(typeof $bool56.__len__=='function'?
								($bool56.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$p['getattr'](element, 'innerHTML'):$and15);
			}
		}
		return null;
	};
	...
	$m['getInnerText'] = function(element) {
		var $bool57,$add12,text,$add13,$bool58,$bool59,$add14,$eq33,$add11,$eq34,child;
		text = '';
		...
		while ((($bool57=child) === null || $bool57 === false || $bool57 === 0 || $bool57 === '' ?
				...
				(typeof $bool57=='object'?
					(typeof $bool57.__nonzero__=='function'?
						...
						(typeof $bool57.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool58=(($eq33=$p['getattr'](child, 'nodeType'))===($eq34=1)&&$eq33===null?true:
			...
			else if ((($bool59=$p['getattr'](child, 'nodeValue')) === null || $bool59 === false || $bool59 === 0 || $bool59 === '' ?
					false :
	...
	$m['getNextSibling'] = function(elem) {
		var $bool63,$bool62,sib,$eq36,$and17,$eq35,$and18;
				...
				(typeof $bool62.__nonzero__=='function'?
					...
					(typeof $bool62.__len__=='function'?
						($bool62.__len__()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq35=$p['getattr'](sib, 'nodeType'))===($eq36=1)&&$eq35===null?true:
	...
	$m['getParent'] = function(elem) {
		var $bool65,$bool64,parent,$eq37,$eq38;
	...
	$m['getStyleAttribute'] = function(elem, attr) {
		var $pyjs_try_err,$bool66;
		try {
			if ((($bool66=$p['hasattr']($p['getattr'](elem, 'style'), 'getProperty')) === null || $bool66 === false || $bool66 === 0 || $bool66 === '' ?
					false :
	...
	$m['insertChild'] = function(parent, toAdd, index) {
		var count,$bool67,$bool69,$bool68,$eq41,$eq40,$bool70,$add15,$add16,$eq42,child,$eq39,before;
		count = 0;
		child = $p['getattr'](parent, 'firstChild');
		before = null;
				...
				(typeof $bool67=='object'?
					(typeof $bool67.__nonzero__=='function'?
						...
						(typeof $bool67.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool68=(($eq39=$p['getattr'](child, 'nodeType'))===($eq40=1)&&$eq39===null?true:
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $bool72,$bool71;
			if ((($bool72=!(($bool71=$p['getattr'](self, 'child')) === null || $bool71 === false || $bool71 === 0 || $bool71 === '' ?
				false :
	...
	, 1, [null,null,['self'],['elem']]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			var $cmp1,$bool78,$cmp2,$bool76,$bool77,$bool75,nextSibling,$bool73,firstChild,$len1,$bool74;
			if ((($bool74=!(($bool73=$p['getattr'](self, 'child')) === null || $bool73 === false || $bool73 === 0 || $bool73 === '' ?
				false :
			...
			else if ((($bool78=((($cmp1=(($len1=$p['getattr'](self, 'stack')) === null?0:
	...
	$m['isOrHasChild'] = function(parent, child) {
		var $bool83,$bool82,$bool81,$bool80,$bool79,$eq43,$eq44;
		while ((($bool79=child) === null || $bool79 === false || $bool79 === 0 || $bool79 === '' ?
			...
			if ((($bool83=!(($eq43=$p['getattr'](child, 'nodeType'))===($eq44=1)&&$eq43===null?true:
	...
	$m['scrollIntoView'] = function(elem) {
		var $sub22,$sub23,$sub20,$add22,$sub24,$cmp9,$add30,$eq54,$sub21,$eq50,$eq51,$eq52,$eq53,$and23,$and22,$and21,$and25,$and24,$add29,$add28,$bool87,$bool86,$add21,$add20,top,$bool88,$add25,$add24,$add27,$add26,width,$sub9,offsetLeft,offsetTop,$add31,$cmp6,$cmp5,$sub19,$sub18,$cmp4,$sub13,$sub12,$sub11,$sub10,$or9,$or8,$sub15,$sub14,$sub16,$bool93,$bool96,$bool92,height,$add18,$add19,$cmp8,cur,$bool90,$bool91,$eq49,$eq48,$bool94,$bool95,$cmp3,$bool97,$bool98,$bool99,$cmp10,$cmp7,$eq47,$eq46,$eq45,$add32,$add17,$add23,$sub17,$bool89,left;
		...
		if ((($bool86=!(($eq45=$p['getattr'](elem, 'parentNode'))===($eq46=$p['getattr'](elem, 'offsetParent'))&&$eq45===null?true:
		...
		while ((($bool88=((($bool87=$and21=cur) === null || $bool87 === false || $bool87 === 0 || $bool87 === '' ?
				...
				(typeof $bool87.__nonzero__=='function'?
					...
					(typeof $bool87.__len__=='function'?
						($bool87.__len__()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?(($eq47=$p['getattr'](cur, 'nodeType'))===($eq48=1)&&$eq47===null?true:
			...
			if ((($bool92=((($bool89=$and23=$p['hasattr'](cur, 'style')) === null || $bool89 === false || $bool89 === 0 || $bool89 === '' ?
					...
					(typeof $bool89.__nonzero__=='function'?
						...
						(typeof $bool89.__len__=='function'?
							($bool89.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool90=$and24=$p['hasattr']($p['getattr'](cur, 'style'), 'overflow')) === null || $bool90 === false || $bool90 === 0 || $bool90 === '' ?
				false :
					...
					(typeof $bool90.__nonzero__=='function'?
						...
						(typeof $bool90.__len__=='function'?
							($bool90.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool91=$or8=(($eq49=$p['getattr']($p['getattr'](cur, 'style'), 'overflow'))===($eq50='auto')&&$eq49===null?true:
					...
					(typeof $bool91.__nonzero__=='function'?
						...
						(typeof $bool91.__len__=='function'?
							($bool91.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or8:(($eq51=$p['getattr']($p['getattr'](cur, 'style'), 'overflow'))===($eq52='scroll')&&$eq51===null?true:
					...
					(typeof $bool92=='object'?
						(typeof $bool92.__nonzero__=='function'?
							...
							(typeof $bool92.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool93=((($cmp3=left)===($cmp4=$p['getattr'](cur, 'scrollLeft'))?0:
				...
				if ((($bool95=((($cmp7=top)===($cmp8=$p['getattr'](cur, 'scrollTop'))?0:
			...
			if ((($bool97=!(($eq53=$p['getattr'](cur, 'parentNode'))===($eq54=$p['getattr'](cur, 'offsetParent'))&&$eq53===null?true:
					...
					(typeof $bool97=='object'?
						(typeof $bool97.__nonzero__=='function'?
							...
							(typeof $bool97.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool98=$p['hasattr']($p['getattr'](cur, 'parentNode'), 'offsetLeft')) === null || $bool98 === false || $bool98 === 0 || $bool98 === '' ?
						false :
				...
				if ((($bool99=$p['hasattr']($p['getattr'](cur, 'parentNode'), 'offsetTop')) === null || $bool99 === false || $bool99 === 0 || $bool99 === '' ?
						false :
	...
	$m['setInnerText'] = function(elem, text) {
		var $or11,$or10,$bool102,$bool101;
		while ((($bool101=($p['getattr'](elem, 'firstChild') !== null)) === null || $bool101 === false || $bool101 === 0 || $bool101 === '' ?
				false :
	...
	$m['setIntStyleAttribute'] = function(elem, attr, value) {
		var $bool103,mf;
		mf = (typeof get_main_frame == "undefined"?$m.get_main_frame:get_main_frame)();
		if ((($bool103=$p['hasattr']($p['getattr'](elem, 'style'), 'setProperty')) === null || $bool103 === false || $bool103 === 0 || $bool103 === '' ?
				false :
	...
	$m['setStyleAttribute'] = function(element, name, value) {
		var $bool104;
		if ((($bool104=$p['hasattr']($p['getattr'](element, 'style'), 'setProperty')) === null || $bool104 === false || $bool104 === 0 || $bool104 === '' ?
				false :
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$bool105,$iter2_idx,val,$iter2_array;
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			attr = $tupleassign2[0];
			val = $tupleassign2[1];
			if ((($bool105=$p['hasattr']($p['getattr'](element, 'style'), 'setProperty')) === null || $bool105 === false || $bool105 === 0 || $bool105 === '' ?
					false :
	...
	$m['sinkEvents'] = function(element, bits) {
		var cb,$cmp12,$bool112,$bool113,$bool110,$bool111,$4,$iter3_idx,$iter3_array,$iter3_nextval,$3,$iter3_iter,event_name,$bool107,$bool106,$cmp11,$iter3_type,$6,bit,$5,$bool109,$bool108,mf,aev,mask;
	...
	if ((($bool122=!(($bool121=$p['getattr']($m['pyjd'], 'is_desktop')) === null || $bool121 === false || $bool121 === 0 || $bool121 === '' ?
		false :
