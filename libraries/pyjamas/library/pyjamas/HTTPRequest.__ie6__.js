...
$pyjs.loaded_modules['pyjamas.HTTPRequest'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['url']]);
		...
		$method = $pyjs__bind_method2('asyncImpl', function(method, user, pwd, url, postData, handler, returnxml, content_type, headers) {
			...
			var hval,$iter1_iter,localHandler,base64,$bool25,$bool24,$bool27,$bool26,$iter1_array,$bool29,$bool28,$iter1_idx,$iter1_nextval,$and4,$and5,$and6,$9,$6,$10,$4,$5,$3,xmlHttp,$iter1_type,h,onprogress,$pyjs_try_err,$bool32,$bool30,$bool31,$bool37,$bool38,$bool39,onreadystatechange;
			...
			onreadystatechange = function(evnt) {
				...
				var status,$or5,localHandler,$eq26,$eq21,$bool33,$eq23,$eq22,$eq25,$eq24,$bool34,$bool35,$bool36,response,$or6;
				if ((($bool33=(($eq21=$p['getattr'](xmlHttp, 'readyState'))===($eq22=4)&&$eq21===null?true:
...
delete xmlHttp.onreadystatechange;
					...
					status = $p['getattr'](xmlHttp, 'status');
					if ((($bool34=returnxml) === null || $bool34 === false || $bool34 === 0 || $bool34 === '' ?
							false :
					...
					handler = null;
					xmlHttp = null;
					if ((($bool36=((($bool35=$or5=(($eq23=status)===($eq24=200)&&$eq23===null?true:
						($eq23===null?false:($eq24===null?false:
							((typeof $eq23=='object'||typeof $eq23=='function')&&typeof $eq23.__cmp__=='function'?$eq23.__cmp__($eq24) === 0:
								((typeof $eq24=='object'||typeof $eq24=='function')&&typeof $eq24.__cmp__=='function'?$eq24.__cmp__($eq23) === 0:
									$eq23==$eq24)))))) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
						false :
			...
			if ((($bool37=$p['hasattr']((typeof localHandler == "undefined"?$m.localHandler:localHandler), 'onProgress')) === null || $bool37 === false || $bool37 === 0 || $bool37 === '' ?
					false :
