...
$pyjs.loaded_modules['pyjamas.HTTPRequest'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onProgress', function(sender, event, ignorearg) {
			...
			var localHandler,xmlHttp,$bool10;
			xmlHttp = $p['getattr'](event, 'target');
			localHandler = $m['handlers']['get'](xmlHttp);
			if ((($bool10=$p['hasattr'](localHandler, 'onProgress')) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
					false :
	...
	, 1, [null,null,['self'],['sender'],['event'],['ignorearg']]);
		...
		$method = $pyjs__bind_method2('onLoad', function(sender, event, ignorearg) {
			...
			var status,localHandler,xmlHttp,$or2,$eq2,$bool11,$eq1,$eq6,$eq4,$eq5,$bool13,$bool12,handler,$eq3,responseText,$or1;
			xmlHttp = $p['getattr'](event, 'target');
			localHandler = $m['handlers']['get'](xmlHttp);
	...
	, 1, [null,null,['self'],['sender'],['event'],['ignorearg']]);
		...
		$method = $pyjs__bind_method2('onReadyStateChange', function(xmlHttp, event, ignorearg) {
			...
			var status,$or4,$eq8,localHandler,$or3,handler,$bool14,$eq7,$eq9,$bool15,$pyjs_try_err,$bool16,$eq11,$eq10,responseText,$eq12;
			try {
			...
			if ((($bool14=!(($eq7=$p['getattr'](xmlHttp, 'readyState'))===($eq8=4)&&$eq7===null?true:
			...
			handler = null;
			xmlHttp = null;
			if ((($bool16=((($bool15=$or3=(($eq9=status)===($eq10=200)&&$eq9===null?true:
	...
	, 1, [null,null,['self'],['xmlHttp'],['event'],['ignorearg']]);
		...
		$method = $pyjs__bind_method2('_convertUrlToAbsolute', function(url) {
			...
			var $bool18,$bool19,sep,$bool17,$eq18,$eq19,$eq13,$eq14,$eq15,$eq16,$eq17,$bool21,$bool20,slash,$bool22,$bool23,$and1,$and2,$and3,$eq20,$2,$1,$cmp1,$cmp2,uri,$add2,$add3,$add1,$add6,$add4,$add5;
			uri = $m['pygwt']['getModuleBaseURL']();
			if ((($bool17=(($eq13=(typeof ($1=url).__array != 'undefined'?
				...
				if ((($bool23=((($bool21=$and1=!(($eq15=$p['__getslice'](url, 0, 7))===($eq16='file://')&&$eq15===null?true:
						...
						(typeof $bool21.__nonzero__=='function'?
							...
							(typeof $bool21.__len__=='function'?
								($bool21.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?((($bool22=$and2=!(($eq17=$p['__getslice'](url, 0, 7))===($eq18='http://')&&$eq17===null?true:
					...
					($eq19===null?false:($eq20===null?false:
						((typeof $eq19=='object'||typeof $eq19=='function')&&typeof $eq19.__cmp__=='function'?$eq19.__cmp__($eq20) === 0:
							((typeof $eq20=='object'||typeof $eq20=='function')&&typeof $eq20.__cmp__=='function'?$eq20.__cmp__($eq19) === 0:
								$eq19==$eq20))))):$and2):$and1)) === null || $bool23 === false || $bool23 === 0 || $bool23 === '' ?
						false :
	...
	, 1, [null,null,['self'],['url']]);
		...
		$method = $pyjs__bind_method2('asyncImpl', function(method, user, pwd, url, postData, handler, returnxml, content_type, headers) {
			...
			var $or5,$eq27,hval,$iter1_iter,$eq32,$6,$eq30,$eq31,$pyjs_try_err,$or8,$bool33,res,base64,$bool25,$bool24,$bool27,$bool26,$iter1_array,$bool29,$bool28,$iter1_idx,$and8,$or7,$or6,$iter1_nextval,$bool40,$and4,$and5,$and6,$and7,$eq21,$eq22,$eq25,$eq26,$eq29,$eq28,$4,$5,$3,mf,xmlHttp,$iter1_type,h,$eq23,$bool32,$bool30,$bool31,$bool36,$bool37,$bool34,$bool35,$bool38,$bool39,$eq24;
			...
			if ((($bool33=(($eq21=$p['getattr'](mf, 'platform'))===($eq22='webkit')&&$eq21===null?true:
			...
			else if ((($bool34=(($eq23=$p['getattr'](mf, 'platform'))===($eq24='mshtml')&&$eq23===null?true:
			...
			if ((($bool36=((($bool35=$and7=!(($eq25=$p['getattr'](mf, 'platform'))===($eq26='mshtml')&&$eq25===null?true:
				($eq25===null?false:($eq26===null?false:
					((typeof $eq25=='object'||typeof $eq25=='function')&&typeof $eq25.__cmp__=='function'?$eq25.__cmp__($eq26) === 0:
						((typeof $eq26=='object'||typeof $eq26=='function')&&typeof $eq26.__cmp__=='function'?$eq26.__cmp__($eq25) === 0:
							$eq25==$eq26)))))) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
				false :
					...
					(typeof $bool35.__nonzero__=='function'?
						...
						(typeof $bool35.__len__=='function'?
							($bool35.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?!(($eq27=$p['getattr'](mf, 'platform'))===($eq28='ie6')&&$eq27===null?true:
				($eq27===null?false:($eq28===null?false:
					((typeof $eq27=='object'||typeof $eq27=='function')&&typeof $eq27.__cmp__=='function'?$eq27.__cmp__($eq28) === 0:
						((typeof $eq28=='object'||typeof $eq28=='function')&&typeof $eq28.__cmp__=='function'?$eq28.__cmp__($eq27) === 0:
							$eq27==$eq28))))):$and7)) === null || $bool36 === false || $bool36 === 0 || $bool36 === '' ?
					false :
			...
			if ((($bool38=((($bool37=$or5=(($eq29=$p['getattr'](mf, 'platform'))===($eq30='webkit')&&$eq29===null?true:
				($eq29===null?false:($eq30===null?false:
					((typeof $eq29=='object'||typeof $eq29=='function')&&typeof $eq29.__cmp__=='function'?$eq29.__cmp__($eq30) === 0:
						((typeof $eq30=='object'||typeof $eq30=='function')&&typeof $eq30.__cmp__=='function'?$eq30.__cmp__($eq29) === 0:
							$eq29==$eq30)))))) === null || $bool37 === false || $bool37 === 0 || $bool37 === '' ?
				false :
					...
					(typeof $bool37.__nonzero__=='function'?
						...
						(typeof $bool37.__len__=='function'?
							($bool37.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or5:(($eq31=$p['getattr'](mf, 'platform'))===($eq32='mshtml')&&$eq31===null?true:
				($eq31===null?false:($eq32===null?false:
					((typeof $eq31=='object'||typeof $eq31=='function')&&typeof $eq31.__cmp__=='function'?$eq31.__cmp__($eq32) === 0:
						((typeof $eq32=='object'||typeof $eq32=='function')&&typeof $eq32.__cmp__=='function'?$eq32.__cmp__($eq31) === 0:
							$eq31==$eq32))))))) === null || $bool38 === false || $bool38 === 0 || $bool38 === '' ?
					false :
