...
$pyjs.loaded_modules['pyjamas.JSONService'] = function (__mod_name__) {
	...
	$m['create_object'] = function(items) {
		...
		clsname = $p['__getslice'](clsname, (typeof ($add5=dot)==typeof ($add6=1) && (typeof $add5=='number'||typeof $add5=='string')?
			$add5+$add6:
	...
	, 1, [null,null,['self'],['request']]);
		...
		$method = $pyjs__bind_method2('onCompletion', function(json_str) {
			...
			var $bool18,$bool19,code,$bool13,$bool14,$bool15,$bool16,$bool17,message,$pyjs_try_err,$eq3,$eq4,$8,$6,$7,$5,data,response,jsonrpc,error;
			try {
			...
			if ((($bool14=!(($bool13=response) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
				...
				if ((($bool17=!(($bool16=jsonrpc) === null || $bool16 === false || $bool16 === 0 || $bool16 === '' ?
					...
					if ((($bool18=(($eq3=jsonrpc)===($eq4='1.0')&&$eq3===null?true:
		...
		$method = $pyjs__bind_method2('__call__', function() {
			...
			if ((($bool22=((($bool21=$and1=params) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
				...
				((typeof $9.__array[$10=0]) != 'undefined'?$9.__array[$10]:
					$9.__getitem__($10)):
					$9.__getitem__(0)), 'onRemoteResponse'):$and1)) === null || $bool22 === false || $bool22 === 0 || $bool22 === '' ?
					false :
			...
			if ((($bool29=(handler !== null)) === null || $bool29 === false || $bool29 === 0 || $bool29 === '' ?
					false :
	...
	$m['JSONProxy'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(url, methods, headers) {
			...
			self.headers = ((($bool30=(headers === null)) === null || $bool30 === false || $bool30 === 0 || $bool30 === '' ?
				false :
