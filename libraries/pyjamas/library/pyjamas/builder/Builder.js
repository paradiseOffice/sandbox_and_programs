...
$pyjs.loaded_modules['pyjamas.builder.Builder'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['text', null]]);
		...
		$method = $pyjs__bind_method2('setText', function(text) {
			...
			var $eq2,$eq1,$bool2,$bool1;
			if ((($bool1=(text === null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
					false :
					(typeof $bool1=='object'?
						(typeof $bool1.__nonzero__=='function'?
							...
							(typeof $bool1.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				self.widgets_by_name = $p['dict']([]);
				self.widget_instances = $p['dict']([]);
				self.widget_order = $p['dict']([]);
				self.widgets_by_class = $p['dict']([]);
			...
			text = $p['str'](text);
			if ((($bool2=(($eq1=text)===($eq2=$p['getattr'](self, 'builder_text'))&&$eq1===null?true:
			...
			self.properties = $tupleassign1[0];
			self.components = $tupleassign1[1];
			return null;
		}
	, 1, [null,null,['self'],['text']]);
		...
		$method = $pyjs__bind_method2('createInstance', function(instancename, eventTarget, targetItem, index) {
			...
			var childs,widgets_by_class,frame,widget_order,$iter4_type,$iter4_iter,widgets_by_name,$bool24,props,addItem,$eq6,$eq5,widget_instances,$iter4_nextval,$iter4_idx,item,$iter4_array,$51,$52,$bool25;
			...
			addItem = function(comp, props, childs, parentInstance, eventTarget) {
				...
				while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
					...
					if ((($bool8=(($eq3=(typeof ($11=wprops).__array != 'undefined'?
						((typeof $11.__array[$12=name]) != 'undefined'?$11.__array[$12]:
							$11.__getitem__($12)):
							$11.__getitem__(name)))===($eq4='')&&$eq3===null?true:
				...
				if ((($bool10=(tooltip !== null)) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
						false :
				...
				while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
					...
					if ((($bool13=((($bool12=$or1=!(($bool11=(typeof ($17=child).__array != 'undefined'?
						((typeof $17.__array[$18=0]) != 'undefined'?$17.__array[$18]:
							$17.__getitem__($18)):
							$17.__getitem__(0))['has_key']('type')) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
						false :
							...
							(typeof $bool12.__nonzero__=='function'?
								...
								(typeof $bool12.__len__=='function'?
									($bool12.__len__()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?$or1:((typeof ($21=(typeof ($19=child).__array != 'undefined'?
						((typeof $19.__array[$20=0]) != 'undefined'?$19.__array[$20]:
							$19.__getitem__($20)):
							$19.__getitem__(0))).__array != 'undefined'?
					...
					childitem = addItem((typeof ($23=child).__array != 'undefined'?
						((typeof $23.__array[$24=0]) != 'undefined'?$23.__array[$24]:
							$23.__getitem__($24)):
							$23.__getitem__(0)), (typeof ($25=child).__array != 'undefined'?
						((typeof $25.__array[$26=1]) != 'undefined'?$25.__array[$26]:
							$25.__getitem__($26)):
							$25.__getitem__(1)), (typeof ($27=child).__array != 'undefined'?
						((typeof $27.__array[$28=2]) != 'undefined'?$27.__array[$28]:
							$27.__getitem__($28)):
							$27.__getitem__(2)), item, eventTarget);
					if ((($bool14=(childitem === null)) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
							false :
					...
					cname = (typeof ($43=(typeof ($41=child).__array != 'undefined'?
						((typeof $41.__array[$42=0]) != 'undefined'?$41.__array[$42]:
							$41.__getitem__($42)):
							$41.__getitem__(0))).__array != 'undefined'?
						((typeof $43.__array[$44='id']) != 'undefined'?$43.__array[$44]:
							$43.__getitem__($44)):
							$43.__getitem__('id'));
					$p['setattr'](item, cname, childitem);
				}
				if ((($bool20=((($bool19=$and1=(eventTarget !== null)) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
					false :
			...
			while (typeof ($iter4_nextval=($iter4_type?($iter4_type > 0?$iter4_iter.next(true,false):$p['wrapped_next']($iter4_iter)):$iter4_array[$iter4_idx++])) != 'undefined') {
				...
				if ((($bool24=!(($eq5=(typeof ($51=frame).__array != 'undefined'?
					((typeof $51.__array[$52='id']) != 'undefined'?$51.__array[$52]:
						$51.__getitem__($52)):
						$51.__getitem__('id')))===($eq6=instancename)&&$eq5===null?true:
				...
				if ((($bool25=(index !== null)) === null || $bool25 === false || $bool25 === 0 || $bool25 === '' ?
						false :
