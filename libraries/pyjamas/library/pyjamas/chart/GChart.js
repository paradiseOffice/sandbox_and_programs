...
$pyjs.loaded_modules['pyjamas.chart.GChart'] = function (__mod_name__) {
	...
	$m['isMouseAnchored'] = function(symbolType) {
		var $or1,$or3,$or2,$eq2,$eq3,$eq1,$eq6,$eq4,$eq5,$bool2,$bool1;
		return ((($bool1=$or1=(($eq1=$p['getattr']($m['SymbolType'], 'ANCHOR_MOUSE'))===($eq2=symbolType)&&$eq1===null?true:
				...
				(typeof $bool1.__nonzero__=='function'?
					...
					(typeof $bool1.__len__=='function'?
						($bool1.__len__()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?$or1:((($bool2=$or2=(($eq3=$p['getattr']($m['SymbolType'], 'ANCHOR_MOUSE_SNAP_TO_X'))===($eq4=symbolType)&&$eq3===null?true:
				...
				(typeof $bool2.__nonzero__=='function'?
					...
					(typeof $bool2.__len__=='function'?
						($bool2.__len__()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?$or2:(($eq5=$p['getattr']($m['SymbolType'], 'ANCHOR_MOUSE_SNAP_TO_Y'))===($eq6=symbolType)&&$eq5===null?true:
	...
	$m['GChart'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			self.hoverParameterInterpreter = null;
			self.hoverTouchingEnabled = true;
			self.defaultSymbolBorderColors = $m['DEFAULT_SYMBOL_BORDER_COLORS'];
			self.chartPanel = $m['SimplePanel']();
			self.borderWidth = $m['USE_CSS'];
			self.borderStyle = $m['USE_CSS'];
			self.borderColor = $m['USE_CSS'];
			self.backgroundColor = $m['USE_CSS'];
			self.blankImageURL = null;
			self.chartDecorationsChanged = true;
			self.curves = $p['list']([]);
			self.fontFamily = $m['USE_CSS'];
			self.footnotesThickness = $m['NAI'];
			self.legendBackgroundColor = $m['DEFAULT_LEGEND_BACKGROUND_COLOR'];
			self.legendBorderColor = $m['DEFAULT_LEGEND_BORDER_COLOR'];
			self.legendBorderWidth = $m['DEFAULT_LEGEND_BORDER_WIDTH'];
			self.legendBorderStyle = $m['DEFAULT_LEGEND_BORDER_STYLE'];
			self.legendThickness = $m['NAI'];
			self.chartFootnotes = null;
			self.chartFootnotesLeftJustified = true;
			self.legendVisible = true;
			self.legendFontColor = $m['DEFAULT_FONT_COLOR'];
			self.legendFontSize = $m['DEFAULT_LEGEND_FONTSIZE'];
			self.legendFontStyle = $m['DEFAULT_FONT_STYLE'];
			self.legendFontWeight = $m['DEFAULT_FONT_WEIGHT'];
			self.initialPieSliceOrientation = 0.0;
			self.plotPanel = $m['PlotPanel'](self);
			self.padding = $m['USE_CSS'];
			self.optimizeForMemory = false;
			self.clipToPlotArea = false;
			self.clipToDecoratedChart = false;
			self.titleThickness = $m['NAI'];
			self.wasUnloaded = false;
			self['addSystemCurves']();
			self.xAxis = $m['XAxis'](self);
			self.yAxis = $m['YAxis'](self);
			self.y2Axis = $m['Y2Axis'](self);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setLastPieSliceOrientation', function(lastOrientation) {
			...
			var $mod1,$mod2;
			self.lastPieSliceOrientation = (typeof ($mod1=lastOrientation)==typeof ($mod2=1.0) && typeof $mod1=='number'?
	...
	, 1, [null,null,['self'],['lastOrientation']]);
		...
		$method = $pyjs__bind_method2('setInitialPieSliceOrientation', function(orientation) {
			...
			if ((($bool10=((($bool9=$or4=((($cmp1=orientation)===($cmp2=0)?0:
					...
					(typeof $bool9.__nonzero__=='function'?
						...
						(typeof $bool9.__len__=='function'?
							($bool9.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or4:((((($cmp3=orientation)===($cmp4=1)?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('addSystemCurves', function() {
			...
			var c,$iter1_nextval,$iter1_type,i,$bool11,$eq7,$iter1_iter,$eq8,$iter1_array,$iter1_idx;
			...
			c['addPoint']($p['getattr']($m['Double'], 'NaN'), $p['getattr']($m['Double'], 'NaN'));
			c['getPoint']()['setAnnotationLocation']($p['getattr']($m['AnnotationLocation'], 'CENTER'));
			if ((($bool11=!(($eq7=self['getNCurves']())===($eq8=0)&&$eq7===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('updateDecorations', function(xChartSizeDecorated) {
			...
			self['getSystemCurve']($m['XLABEL_ID'])['getPoint'](0)['setAnnotationWidget'](self['getXAxis']()['getAxisLabel'](), self['getXChartSize'](), self['getXAxis']()['getAxisLabelThickness']());
			self['getSystemCurve']($m['XLABEL_ID'])['getPoint'](0)['setAnnotationYShift']((typeof ($sub5=(typeof ($sub3=(typeof ($sub1=(typeof ($usub7=self['getXAxis']()['getTickLabelThickness'](false))=='number'?
				-$usub7:
				...
				$sub3-$sub4:
				$p['op_sub']($sub3,$sub4)))==typeof ($sub6=(typeof ($div1=self['getXAxis']()['getAxisLabelThickness']())==typeof ($div2=2) && typeof $div1=='number' && $div2 !== 0?
				$div1/$div2:
				$p['op_div']($div1,$div2))) && (typeof $sub5=='number'||typeof $sub5=='string')?
				$sub5-$sub6:
				$p['op_sub']($sub5,$sub6)));
			self['getSystemCurve']($m['YLABEL_ID'])['getPoint'](0)['setAnnotationWidget'](self['getYAxis']()['getAxisLabel'](), self['getYAxis']()['getAxisLabelThickness'](), self['getYChartSize']());
			self['getSystemCurve']($m['YLABEL_ID'])['getPoint'](0)['setAnnotationXShift']((typeof ($sub11=(typeof ($sub9=(typeof ($sub7=(typeof ($usub8=self['getYAxis']()['getTickLabelThickness'](false))=='number'?
				-$usub8:
				...
				$sub9-$sub10:
				$p['op_sub']($sub9,$sub10)))==typeof ($sub12=(typeof ($div3=self['getYAxis']()['getAxisLabelThickness']())==typeof ($div4=2) && typeof $div3=='number' && $div4 !== 0?
				$div3/$div4:
				$p['op_div']($div3,$div4))) && (typeof $sub11=='number'||typeof $sub11=='string')?
				$sub11-$sub12:
				$p['op_sub']($sub11,$sub12)));
			self['getSystemCurve']($m['Y2LABEL_ID'])['getPoint'](0)['setAnnotationWidget'](self['getY2Axis']()['getAxisLabel'](), self['getY2Axis']()['getAxisLabelThickness'](), self['getYChartSize']());
			self['getSystemCurve']($m['Y2LABEL_ID'])['getPoint'](0)['setAnnotationXShift']((typeof ($add11=(typeof ($add9=(typeof ($add7=(typeof ($uadd1=self['getY2Axis']()['getTickLabelThickness'](false))=='number'?
				$uadd1:
				...
				$add9+$add10:
				$p['op_add']($add9,$add10)))==typeof ($add12=(typeof ($div5=self['getY2Axis']()['getAxisLabelThickness']())==typeof ($div6=2) && typeof $div5=='number' && $div6 !== 0?
				$div5/$div6:
					...
					(typeof $bool12.__nonzero__=='function'?
						...
						(typeof $bool12.__len__=='function'?
							($bool12.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($cmp5=0)===($cmp6=self['getNVisibleCurvesOnLegend']())?0:
			...
			self['getSystemCurve']($m['LEGEND_ID'])['getPoint'](0)['setAnnotationWidget'](legend, self['getLegendThickness'](), self['getYChartSize']());
			self['getSystemCurve']($m['LEGEND_ID'])['getPoint'](0)['setAnnotationXShift']((typeof ($add19=(typeof ($add17=(typeof ($add15=(typeof ($add13=(typeof ($uadd2=self['getY2Axis']()['getTickLabelThickness'](false))=='number'?
				$uadd2:
				...
				$add17+$add18:
				$p['op_add']($add17,$add18)))==typeof ($add20=(typeof ($div7=self['getLegendThickness']())==typeof ($div8=2) && typeof $div7=='number' && $div8 !== 0?
				$div7/$div8:
			...
			shiftToHorizontalMidpoint = (typeof ($add21=shiftToLeftEdge)==typeof ($add22=(typeof ($div9=xChartSizeDecorated)==typeof ($div10=2) && typeof $div9=='number' && $div10 !== 0?
				$div9/$div10:
				$p['op_div']($div9,$div10))) && (typeof $add21=='number'||typeof $add21=='string')?
				$add21+$add22:
				$p['op_add']($add21,$add22));
			self['getSystemCurve']($m['TITLE_ID'])['getPoint'](0)['setAnnotationWidget'](self['getChartTitle'](), xChartSizeDecorated, self['getChartTitleThickness']());
			self['getSystemCurve']($m['TITLE_ID'])['getPoint'](0)['setAnnotationYShift']((typeof ($div11=self['getChartTitleThickness']())==typeof ($div12=2) && typeof $div11=='number' && $div12 !== 0?
				$div11/$div12:
				$p['op_div']($div11,$div12)));
			self['getSystemCurve']($m['TITLE_ID'])['getPoint'](0)['setAnnotationXShift'](shiftToHorizontalMidpoint);
			self['getSystemCurve']($m['FOOTNOTES_ID'])['getPoint'](0)['setAnnotationWidget'](self['getChartFootnotes'](), xChartSizeDecorated, self['getChartFootnotesThickness']());
			self['getSystemCurve']($m['FOOTNOTES_ID'])['getPoint'](0)['setAnnotationYShift']((typeof ($sub25=(typeof ($sub23=(typeof ($sub21=(typeof ($sub19=(typeof ($usub10=self['getXAxis']()['getTickLabelThickness'](false))=='number'?
				-$usub10:
				...
				$sub23-$sub24:
				$p['op_sub']($sub23,$sub24)))==typeof ($sub26=(typeof ($div13=self['getChartFootnotesThickness']())==typeof ($div14=2) && typeof $div13=='number' && $div14 !== 0?
				$div13/$div14:
					...
					(typeof $bool14=='object'?
						(typeof $bool14.__nonzero__=='function'?
							...
							(typeof $bool14.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				self['getSystemCurve']($m['FOOTNOTES_ID'])['getPoint'](0)['setAnnotationXShift'](shiftToLeftEdge);
				self['getSystemCurve']($m['FOOTNOTES_ID'])['getPoint'](0)['setAnnotationLocation']($p['getattr']($m['AnnotationLocation'], 'EAST'));
			}
			else {
				self['getSystemCurve']($m['FOOTNOTES_ID'])['getPoint'](0)['setAnnotationXShift'](shiftToHorizontalMidpoint);
				self['getSystemCurve']($m['FOOTNOTES_ID'])['getPoint'](0)['setAnnotationLocation']($p['getattr']($m['AnnotationLocation'], 'CENTER'));
			}
	...
	, 1, [null,null,['self'],['handler']]);
		...
		$method = $pyjs__bind_method2('internalCurveIndex', function(externalIndex) {
			...
			var $bool18,$add28,$cmp7,$eq9,$add27,$add25,$cmp9,$cmp8,$bool16,$bool17,result,$len1,$eq10,$add24,$add26,$add23,$cmp10;
			if ((($bool16=(($eq9=$m['NAI'])===($eq10=externalIndex)&&$eq9===null?true:
			...
			else if ((($bool18=((($cmp9=externalIndex)===($cmp10=0)?0:
					...
					(typeof $bool18=='object'?
						(typeof $bool18.__nonzero__=='function'?
							...
							(typeof $bool18.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				result = (typeof ($add25=(($len1=$p['getattr'](self, 'curves')) === null?0:
	...
	, 1, [null,null,['self'],['externalIndex']]);
		...
		$method = $pyjs__bind_method2('externalCurveIndex', function(internalIndex) {
			...
			if ((($bool19=((($cmp11=internalIndex)===($cmp12=0)?0:
			...
			else if ((($bool21=((((($cmp15=internalIndex)===($cmp16=(typeof ($sub29=(($len2=$p['getattr'](self, 'curves')) === null?0:
					...
					(typeof $bool21=='object'?
						(typeof $bool21.__nonzero__=='function'?
							...
							(typeof $bool21.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				result = (typeof ($sub31=internalIndex)==typeof ($sub32=(($len3=$p['getattr'](self, 'curves')) === null?0:
	...
	, 1, [null,null,['self'],['internalIndex']]);
		...
		$method = $pyjs__bind_method2('isSystemCurveIndex', function(externalIndex) {
			...
			result = ((($cmp17=externalIndex)===($cmp18=0)?0:
	...
	, 1, [null,null,['self'],['externalIndex']]);
		...
		$method = $pyjs__bind_method2('addCurve', function(iCurve) {
			...
			var $cmp20,$cmp21,$cmp22,$cmp23,$cmp24,rpIndex,$eq11,$eq12,$add29,$iter2_iter,$2,$add42,$add41,$add40,$bool25,$bool24,$bool26,$bool23,$bool22,$iter2_type,$sub36,c,$iter2_idx,$iter2_nextval,$cmp19,$1,internalIndex,$add38,$add39,$add32,$add33,$add30,$add31,$add36,$add37,$add34,$add35,i,$len4,$sub35,$iter2_array;
			if ((($bool22=(iCurve === null)) === null || $bool22 === false || $bool22 === 0 || $bool22 === '' ?
					false :
			...
			else if ((($bool24=((($cmp21=iCurve)===($cmp22=0)?0:
			...
			$iter2_iter = $p['range']((typeof ($add41=internalIndex)==typeof ($add42=1) && (typeof $add41=='number'||typeof $add41=='string')?
				$add41+$add42:
				$p['op_add']($add41,$add42)), (($len4=$p['getattr'](self, 'curves')) === null?0:
			...
			if ((($bool25=!(($eq11=0)===($eq12=self['plotPanel']['getRenderingPanelCount']())&&$eq11===null?true:
				($eq11===null?false:($eq12===null?false:
					((typeof $eq11=='object'||typeof $eq11=='function')&&typeof $eq11.__cmp__=='function'?$eq11.__cmp__($eq12) === 0:
						((typeof $eq12=='object'||typeof $eq12=='function')&&typeof $eq12.__cmp__=='function'?$eq12.__cmp__($eq11) === 0:
							$eq11==$eq12)))))) === null || $bool25 === false || $bool25 === 0 || $bool25 === '' ?
					false :
			...
			c['invalidate']();
			if ((($bool26=((($cmp23=self['getNCurves']())===($cmp24=0)?0:
					...
					(typeof $bool26=='object'?
						(typeof $bool26.__nonzero__=='function'?
							...
							(typeof $bool26.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				self['setDefaultBorderColor'](c, (typeof ($sub35=self['getNCurves']())==typeof ($sub36=1) && (typeof $sub35=='number'||typeof $sub35=='string')?
					$sub35-$sub36:
	...
	, 1, [null,null,['self'],['iCurve', null]]);
		...
		$method = $pyjs__bind_method2('clearCurves', function() {
			...
			$iter3_iter = $p['range']((typeof ($sub37=self['getNCurves']())==typeof ($sub38=1) && (typeof $sub37=='number'||typeof $sub37=='string')?
				$sub37-$sub38:
				$p['op_sub']($sub37,$sub38)), (typeof ($usub13=1)=='number'?
				-$usub13:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getChartFootnotesThickness', function() {
			...
			var EXTRA_HEIGHT,$add44,$bool29,DEF_HEIGHT,$add43,$mul3,$bool28,$bool27,$mul1,result,$mul2,$add46,$add45,$mul4,$eq13,$eq14,$eq15,$eq16;
			result = 0;
			EXTRA_HEIGHT = 3;
			DEF_HEIGHT = 1;
			if ((($bool27=(($eq13=null)===($eq14=self['getChartFootnotes']())&&$eq13===null?true:
			...
			else if ((($bool28=!(($eq15=$m['NAI'])===($eq16=$p['getattr'](self, 'footnotesThickness'))&&$eq15===null?true:
				($eq15===null?false:($eq16===null?false:
					((typeof $eq15=='object'||typeof $eq15=='function')&&typeof $eq15.__cmp__=='function'?$eq15.__cmp__($eq16) === 0:
						((typeof $eq16=='object'||typeof $eq16=='function')&&typeof $eq16.__cmp__=='function'?$eq16.__cmp__($eq15) === 0:
							$eq15==$eq16)))))) === null || $bool28 === false || $bool28 === 0 || $bool28 === '' ?
					false :
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getChartTitleThickness', function() {
			...
			var EXTRA_HEIGHT,$bool32,$add49,$eq20,$add47,DEF_HEIGHT,$eq18,$eq19,$bool30,$bool31,result,$add48,$mul8,$mul7,$mul6,$mul5,$add50,$eq17;
			result = 0;
			EXTRA_HEIGHT = 3;
			DEF_HEIGHT = 1;
			if ((($bool30=(($eq17=null)===($eq18=self['getChartTitle']())&&$eq17===null?true:
				($eq17===null?false:($eq18===null?false:
					((typeof $eq17=='object'||typeof $eq17=='function')&&typeof $eq17.__cmp__=='function'?$eq17.__cmp__($eq18) === 0:
						((typeof $eq18=='object'||typeof $eq18=='function')&&typeof $eq18.__cmp__=='function'?$eq18.__cmp__($eq17) === 0:
							$eq17==$eq18)))))) === null || $bool30 === false || $bool30 === 0 || $bool30 === '' ?
					false :
			...
			else if ((($bool31=!(($eq19=$m['NAI'])===($eq20=$p['getattr'](self, 'titleThickness'))&&$eq19===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getClosestBrushTouchingPointNoCheck', function(x, y) {
			...
			var dx,nCurves,$eq26,d,symType,result,$iter4_type,$sub40,$sub41,$sub42,$cmp26,$iter4_iter,$add52,onY2,iCurve,xPoint,$or7,$or6,$bool42,$bool41,$bool40,$sub39,dBest,$and4,$mul15,sym,$eq21,$eq23,$eq22,$eq25,$eq24,$mul9,$and3,dy,$add51,$mul12,$mul16,c,$mul14,$mul13,$mul11,yPoint,$mul10,$iter4_nextval,$iter4_idx,$bool33,$bool36,$bool37,$bool34,$bool35,$iter4_array,$bool38,$bool39,iClosest,$cmp25;
			result = null;
			if ((($bool34=((($bool33=$or6=(($eq21=x)===($eq22=$m['NAI'])&&$eq21===null?true:
					...
					(typeof $bool33.__nonzero__=='function'?
						...
						(typeof $bool33.__len__=='function'?
							($bool33.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or6:(($eq23=y)===($eq24=$m['NAI'])&&$eq23===null?true:
			...
			while (typeof ($iter4_nextval=($iter4_type?($iter4_type > 0?$iter4_iter.next(true,false):$p['wrapped_next']($iter4_iter)):$iter4_array[$iter4_idx++])) != 'undefined') {
				...
				if ((($bool41=(($eq25=$m['NAI'])===($eq26=iClosest)&&$eq25===null?true:
					($eq25===null?false:($eq26===null?false:
						((typeof $eq25=='object'||typeof $eq25=='function')&&typeof $eq25.__cmp__=='function'?$eq25.__cmp__($eq26) === 0:
							((typeof $eq26=='object'||typeof $eq26=='function')&&typeof $eq26.__cmp__=='function'?$eq26.__cmp__($eq25) === 0:
								$eq25==$eq26)))))) === null || $bool41 === false || $bool41 === 0 || $bool41 === '' ?
						false :
	...
	, 1, [null,null,['self'],['xPlotArea'],['yPlotArea']]);
		...
		$method = $pyjs__bind_method2('getCurve', function(iCurve) {
			...
			if ((($bool45=(iCurve === null)) === null || $bool45 === false || $bool45 === 0 || $bool45 === '' ?
					false :
				...
				return self['getSystemCurve']((typeof ($sub43=N)==typeof ($sub44=1) && (typeof $sub43=='number'||typeof $sub43=='string')?
					$sub43-$sub44:
			...
			if ((($bool47=((((($cmp29=iCurve)===($cmp30=self['getNCurves']())?0:
				...
				throw ((typeof IllegalArgumentException == "undefined"?$m.IllegalArgumentException:IllegalArgumentException)((typeof ($add59=(typeof ($add57=(typeof ($add55=(typeof ($add53='iCurve = ')==typeof ($add54=iCurve) && (typeof $add53=='number'||typeof $add53=='string')?
					...
					$add55+$add56:
					$p['op_add']($add55,$add56)))==typeof ($add58=$p['str']((typeof ($sub45=self['getNCurves']())==typeof ($sub46=1) && (typeof $sub45=='number'||typeof $sub45=='string')?
					$sub45-$sub46:
			...
			else if ((($bool48=((($cmp31=iCurve)===($cmp32=0)?0:
		...
		$method = $pyjs__bind_method2('getRenderingPanelIndex', function(internalCurveIndex) {
			...
			if ((($bool49=((($cmp33=$m['N_PRE_SYSTEM_CURVES'])===($cmp34=internalCurveIndex)?0:
				...
				result = (typeof ($add65=(typeof ($sub47=internalCurveIndex)==typeof ($sub48=$m['N_PRE_SYSTEM_CURVES']) && (typeof $sub47=='number'||typeof $sub47=='string')?
					$sub47-$sub48:
					$p['op_sub']($sub47,$sub48)))==typeof ($add66=1) && (typeof $add65=='number'||typeof $add65=='string')?
					$add65+$add66:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getLegendThickness', function() {
			...
			var $bool50,$bool51,$bool52,$and5,$and6,result,$eq27,$eq28,$cmp36,$cmp35;
			result = 0;
					...
					(typeof $bool50.__nonzero__=='function'?
						...
						(typeof $bool50.__len__=='function'?
							($bool50.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($cmp35=0)===($cmp36=self['getNVisibleCurvesOnLegend']())?0:
					...
					(typeof $bool51=='object'?
						(typeof $bool51.__nonzero__=='function'?
							...
							(typeof $bool51.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool52=(($eq27=$m['NAI'])===($eq28=$p['getattr'](self, 'legendThickness'))&&$eq27===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getNCurves', function() {
			...
			return (typeof ($sub49=(($len5=$p['getattr'](self, 'curves')) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('hasY2Axis', function() {
			...
			result = ((($cmp37=self['getY2Axis']()['getNCurvesVisibleOnAxis']())===($cmp38=0)?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('hasYAxis', function() {
			...
			result = ((($cmp39=self['getYAxis']()['getNCurvesVisibleOnAxis']())===($cmp40=0)?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('removeCurve', function(iCurve) {
			...
			var $iter5_nextval,$and8,$bool60,$iter5_array,$bool58,$bool59,$bool61,$6,$eq30,$eq31,rpIndex,$eq34,$iter5_type,$cmp42,$cmp43,$sub52,$cmp41,$cmp44,$add104,$add107,$bool64,$iter5_idx,$add101,$add100,$add103,$add102,$add98,$add99,$sub51,$add106,$add108,$add97,$bool63,$and7,$8,$eq29,$7,$5,internalIndex,$eq32,c,$eq33,i,$bool62,$len6,$iter5_iter,$add105;
			if ((($bool58=((((($cmp41=iCurve)===($cmp42=self['getNCurves']())?0:
				...
				throw ((typeof IllegalArgumentException == "undefined"?$m.IllegalArgumentException:IllegalArgumentException)((typeof ($add103=(typeof ($add101=(typeof ($add99=(typeof ($add97='iCurve = ')==typeof ($add98=iCurve) && (typeof $add97=='number'||typeof $add97=='string')?
					...
					$add99+$add100:
					$p['op_add']($add99,$add100)))==typeof ($add102=(typeof ($sub51=self['getNCurves']())==typeof ($sub52=1) && (typeof $sub51=='number'||typeof $sub51=='string')?
					$sub51-$sub52:
			...
			else if ((($bool59=((($cmp43=iCurve)===($cmp44=0)?0:
			...
			if ((($bool61=((($bool60=$and7=($p['getattr']($p['getattr'](self, 'plotPanel'), 'touchedPoint') !== null)) === null || $bool60 === false || $bool60 === 0 || $bool60 === '' ?
				false :
					...
					(typeof $bool60.__nonzero__=='function'?
						...
						(typeof $bool60.__len__=='function'?
							($bool60.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?(($eq29=self['plotPanel']['touchedPoint']['getParent']())===($eq30=self['getSystemCurve'](iCurve))&&$eq29===null?true:
				($eq29===null?false:($eq30===null?false:
					((typeof $eq29=='object'||typeof $eq29=='function')&&typeof $eq29.__cmp__=='function'?$eq29.__cmp__($eq30) === 0:
						((typeof $eq30=='object'||typeof $eq30=='function')&&typeof $eq30.__cmp__=='function'?$eq30.__cmp__($eq29) === 0:
							$eq29==$eq30))))):$and7)) === null || $bool61 === false || $bool61 === 0 || $bool61 === '' ?
					false :
			...
			internalIndex = self['internalCurveIndex'](iCurve);
			if ((($bool62=!(($eq31=0)===($eq32=self['plotPanel']['getRenderingPanelCount']())&&$eq31===null?true:
				($eq31===null?false:($eq32===null?false:
					((typeof $eq31=='object'||typeof $eq31=='function')&&typeof $eq31.__cmp__=='function'?$eq31.__cmp__($eq32) === 0:
						((typeof $eq32=='object'||typeof $eq32=='function')&&typeof $eq32.__cmp__=='function'?$eq32.__cmp__($eq31) === 0:
							$eq31==$eq32)))))) === null || $bool62 === false || $bool62 === 0 || $bool62 === '' ?
					false :
			...
			if ((($bool63=c['isVisible']()) === null || $bool63 === false || $bool63 === 0 || $bool63 === '' ?
				...
				if ((($bool64=(($eq33=c['getYAxis']())===($eq34=$m['Y_AXIS'])&&$eq33===null?true:
					($eq33===null?false:($eq34===null?false:
						((typeof $eq33=='object'||typeof $eq33=='function')&&typeof $eq33.__cmp__=='function'?$eq33.__cmp__($eq34) === 0:
							((typeof $eq34=='object'||typeof $eq34=='function')&&typeof $eq34.__cmp__=='function'?$eq34.__cmp__($eq33) === 0:
								$eq33==$eq34)))))) === null || $bool64 === false || $bool64 === 0 || $bool64 === '' ?
						false :
			...
			$iter5_iter = $p['range'](internalIndex, (($len6=$p['getattr'](self, 'curves')) === null?0:
	...
	, 1, [null,null,['self'],['iCurve']]);
		...
		$method = $pyjs__bind_method2('removeCurve', function(curve) {
			...
			var index,$bool65,$bool67,$bool66,$eq36,$eq37,$eq35,$eq38,$cmp46,$cmp45;
			if ((($bool65=(($eq35=null)===($eq36=curve)&&$eq35===null?true:
				($eq35===null?false:($eq36===null?false:
					((typeof $eq35=='object'||typeof $eq35=='function')&&typeof $eq35.__cmp__=='function'?$eq35.__cmp__($eq36) === 0:
						((typeof $eq36=='object'||typeof $eq36=='function')&&typeof $eq36.__cmp__=='function'?$eq36.__cmp__($eq35) === 0:
							$eq35==$eq36)))))) === null || $bool65 === false || $bool65 === 0 || $bool65 === '' ?
					false :
			...
			if ((($bool66=(($eq37=index)===($eq38=$m['NAI'])&&$eq37===null?true:
				($eq37===null?false:($eq38===null?false:
					((typeof $eq37=='object'||typeof $eq37=='function')&&typeof $eq37.__cmp__=='function'?$eq37.__cmp__($eq38) === 0:
						((typeof $eq38=='object'||typeof $eq38=='function')&&typeof $eq38.__cmp__=='function'?$eq38.__cmp__($eq37) === 0:
							$eq37==$eq38)))))) === null || $bool66 === false || $bool66 === 0 || $bool66 === '' ?
					false :
			...
			if ((($bool67=((($cmp45=index)===($cmp46=0)?0:
	...
	, 1, [null,null,['self'],['cssColor']]);
		...
		$method = $pyjs__bind_method2('setBlankImageURL', function(_blankImageURL) {
			...
			var $bool68,$eq39,$eq40;
			if ((($bool68=!(($eq39=_blankImageURL)===($eq40=$p['getattr'](self, 'blankImageURL'))&&$eq39===null?true:
	...
	, 1, [null,null,['self'],['hoverTouchingEnabled']]);
		...
		$method = $pyjs__bind_method2('setBorderColor', function(cssColor) {
			...
			var $bool69,$eq42,$eq41,$bool70,$or11,$or10;
			self.chartDecorationsChanged = true;
			if ((($bool70=((($bool69=$or10=($p['getattr'](self, 'borderColor') === null)) === null || $bool69 === false || $bool69 === 0 || $bool69 === '' ?
				false :
					...
					(typeof $bool69.__nonzero__=='function'?
						...
						(typeof $bool69.__len__=='function'?
							($bool69.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or10:(($eq41=$p['getattr'](self, 'borderColor'))===($eq42=$m['TRANSPARENT_BORDER_COLOR'])&&$eq41===null?true:
				($eq41===null?false:($eq42===null?false:
					((typeof $eq41=='object'||typeof $eq41=='function')&&typeof $eq41.__cmp__=='function'?$eq41.__cmp__($eq42) === 0:
						((typeof $eq42=='object'||typeof $eq42=='function')&&typeof $eq42.__cmp__=='function'?$eq42.__cmp__($eq41) === 0:
							$eq41==$eq42))))))) === null || $bool70 === false || $bool70 === 0 || $bool70 === '' ?
					false :
	...
	, 1, [null,null,['self'],['clipToPlotArea']]);
		...
		$method = $pyjs__bind_method2('setDefaultSymbolBorderColors', function(defaultBorderColors) {
			...
			var $eq43,$bool72,$bool73,$eq44,$cmp48,$cmp47;
			if ((($bool72=(($eq43=null)===($eq44=defaultBorderColors)&&$eq43===null?true:
				($eq43===null?false:($eq44===null?false:
					((typeof $eq43=='object'||typeof $eq43=='function')&&typeof $eq43.__cmp__=='function'?$eq43.__cmp__($eq44) === 0:
						((typeof $eq44=='object'||typeof $eq44=='function')&&typeof $eq44.__cmp__=='function'?$eq44.__cmp__($eq43) === 0:
							$eq43==$eq44)))))) === null || $bool72 === false || $bool72 === 0 || $bool72 === '' ?
					false :
			...
			else if ((($bool73=((($cmp47=$p['getattr'](defaultBorderColors, 'length'))===($cmp48=1)?0:
	...
	, 1, [null,null,['self'],['showOffDecoratedChartGlyphs']]);
		...
		$method = $pyjs__bind_method2('getTouchedCurve', function() {
			...
			var $bool76,result,$eq45,$eq46;
			result = null;
			if ((($bool76=!(($eq45=null)===($eq46=self['getTouchedPoint']())&&$eq45===null?true:
	...
	, 1, [null,null,['self'],['pointToTouch']]);
		...
		$method = $pyjs__bind_method2('update', function(option) {
			...
			var $eq49,$eq48,$bool78,$bool79,$bool77,$eq47,$bool81,$bool80,$eq50,$eq51,$eq52;
			if ((($bool77=(option === null)) === null || $bool77 === false || $bool77 === 0 || $bool77 === '' ?
					false :
			...
			self['assembleChart']();
			if ((($bool79=(($eq47=$p['getattr']($m['TouchedPointUpdateOption'], 'TOUCHED_POINT_LOCKED'))===($eq48=option)&&$eq47===null?true:
				($eq47===null?false:($eq48===null?false:
					((typeof $eq47=='object'||typeof $eq47=='function')&&typeof $eq47.__cmp__=='function'?$eq47.__cmp__($eq48) === 0:
						((typeof $eq48=='object'||typeof $eq48=='function')&&typeof $eq48.__cmp__=='function'?$eq48.__cmp__($eq47) === 0:
							$eq47==$eq48)))))) === null || $bool79 === false || $bool79 === 0 || $bool79 === '' ?
					false :
			...
			else if ((($bool80=(($eq49=$p['getattr']($m['TouchedPointUpdateOption'], 'TOUCHED_POINT_CLEARED'))===($eq50=option)&&$eq49===null?true:
				($eq49===null?false:($eq50===null?false:
					((typeof $eq49=='object'||typeof $eq49=='function')&&typeof $eq49.__cmp__=='function'?$eq49.__cmp__($eq50) === 0:
						((typeof $eq50=='object'||typeof $eq50=='function')&&typeof $eq50.__cmp__=='function'?$eq50.__cmp__($eq49) === 0:
							$eq49==$eq50)))))) === null || $bool80 === false || $bool80 === 0 || $bool80 === '' ?
					false :
			...
			else if ((($bool81=(($eq51=$p['getattr']($m['TouchedPointUpdateOption'], 'TOUCHED_POINT_UPDATED'))===($eq52=option)&&$eq51===null?true:
				($eq51===null?false:($eq52===null?false:
					((typeof $eq51=='object'||typeof $eq51=='function')&&typeof $eq51.__cmp__=='function'?$eq51.__cmp__($eq52) === 0:
						((typeof $eq52=='object'||typeof $eq52=='function')&&typeof $eq52.__cmp__=='function'?$eq52.__cmp__($eq51) === 0:
							$eq51==$eq52)))))) === null || $bool81 === false || $bool81 === 0 || $bool81 === '' ?
					false :
	...
	, 1, [null,null,['self'],['option', null]]);
		...
		$method = $pyjs__bind_method2('assembleChart', function() {
			...
			var $bool83,$bool82,$bool88,$bool87,$bool86,$bool85,$bool84,$eq53,$or17,$or15,$or14,$and10,$or16,$or13,$or12,$and9,$eq54;
			...
			if ((($bool88=!(($eq53=$p['getattr'](self, 'plotPanel'))===($eq54=self['chartPanel']['getWidget']())&&$eq53===null?true:
				($eq53===null?false:($eq54===null?false:
					((typeof $eq53=='object'||typeof $eq53=='function')&&typeof $eq53.__cmp__=='function'?$eq53.__cmp__($eq54) === 0:
						((typeof $eq54=='object'||typeof $eq54=='function')&&typeof $eq54.__cmp__=='function'?$eq54.__cmp__($eq53) === 0:
							$eq53==$eq54)))))) === null || $bool88 === false || $bool88 === 0 || $bool88 === '' ?
					false :
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('createLegend', function(pp) {
			...
			var $iter6_type,nCurves,$add110,$eq55,$eq56,$eq57,result,$iter6_iter,$div16,$eq58,$iter6_nextval,$div15,$$label,$iter6_idx,$add109,$and12,$iter6_array,$and11,icon,$bool90,$bool91,c,i,iVisible,symBorderFraction,$bool89;
			result = $m['Grid'](self['getNVisibleCurvesOnLegend'](), 2);
			iVisible = 0;
			if ((($bool89=(($eq55=$m['TRANSPARENT_BORDER_COLOR'])===($eq56=self['getLegendBorderColor']())&&$eq55===null?true:
				($eq55===null?false:($eq56===null?false:
					((typeof $eq55=='object'||typeof $eq55=='function')&&typeof $eq55.__cmp__=='function'?$eq55.__cmp__($eq56) === 0:
						((typeof $eq56=='object'||typeof $eq56=='function')&&typeof $eq56.__cmp__=='function'?$eq56.__cmp__($eq55) === 0:
							$eq55==$eq56)))))) === null || $bool89 === false || $bool89 === 0 || $bool89 === '' ?
					false :
					(typeof $bool89=='object'?
						(typeof $bool89.__nonzero__=='function'?
							...
							(typeof $bool89.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				$m['GChartUtil']['setBorderWidth'](result, 0);
			...
			while (typeof ($iter6_nextval=($iter6_type?($iter6_type > 0?$iter6_iter.next(true,false):$p['wrapped_next']($iter6_iter)):$iter6_array[$iter6_idx++])) != 'undefined') {
				...
				if ((($bool91=((($bool90=$and11=c['isVisible']()) === null || $bool90 === false || $bool90 === 0 || $bool90 === '' ?
						...
						(typeof $bool90.__nonzero__=='function'?
							...
							(typeof $bool90.__len__=='function'?
								($bool90.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?!(($eq57=c['getLegendLabel']())===($eq58=null)&&$eq57===null?true:
					($eq57===null?false:($eq58===null?false:
						((typeof $eq57=='object'||typeof $eq57=='function')&&typeof $eq57.__cmp__=='function'?$eq57.__cmp__($eq58) === 0:
							((typeof $eq58=='object'||typeof $eq58=='function')&&typeof $eq58.__cmp__=='function'?$eq58.__cmp__($eq57) === 0:
								$eq57==$eq58))))):$and11)) === null || $bool91 === false || $bool91 === 0 || $bool91 === '' ?
						false :
					...
					result['getCellFormatter']()['setAlignment'](iVisible, 0, $p['getattr']($m['HasHorizontalAlignment'], 'ALIGN_CENTER'), $p['getattr']($m['HasVerticalAlignment'], 'ALIGN_MIDDLE'));
					...
					result['getCellFormatter']()['setAlignment'](iVisible, 1, $p['getattr']($m['HasHorizontalAlignment'], 'ALIGN_LEFT'), $p['getattr']($m['HasVerticalAlignment'], 'ALIGN_MIDDLE'));
					iVisible = (typeof ($add109=iVisible)==typeof ($add110=1) && (typeof $add109=='number'||typeof $add109=='string')?
						$add109+$add110:
	...
	, 1, [null,null,['self'],['pp']]);
		...
		$method = $pyjs__bind_method2('getDefaultLegendThickness', function() {
			...
			var nCurves,$add112,$add111,$eq59,EXTRA_WIDTH,$iter7_type,$mul20,$iter7_iter,$bool92,$and13,$and14,$iter7_idx,$mul17,c,$bool93,$iter7_nextval,maxLen,i,$iter7_array,$eq60,$mul19,$mul18;
			EXTRA_WIDTH = 5;
			maxLen = 0;
			nCurves = self['getNCurves']();
						...
						(typeof $bool92.__nonzero__=='function'?
							...
							(typeof $bool92.__len__=='function'?
								($bool92.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?!(($eq59=null)===($eq60=c['getLegendLabel']())&&$eq59===null?true:
					($eq59===null?false:($eq60===null?false:
						((typeof $eq59=='object'||typeof $eq59=='function')&&typeof $eq59.__cmp__=='function'?$eq59.__cmp__($eq60) === 0:
							((typeof $eq60=='object'||typeof $eq60=='function')&&typeof $eq60.__cmp__=='function'?$eq60.__cmp__($eq59) === 0:
								$eq59==$eq60))))):$and13)) === null || $bool93 === false || $bool93 === 0 || $bool93 === '' ?
						false :
			...
			return $p['float_int']((typeof ($mul19=(typeof ($mul17=(typeof ($add111=maxLen)==typeof ($add112=EXTRA_WIDTH) && (typeof $add111=='number'||typeof $add111=='string')?
				$add111+$add112:
						...
						(typeof $bool94.__nonzero__=='function'?
							...
							(typeof $bool94.__len__=='function'?
								($bool94.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?(self['getSystemCurve'](i)['getLegendLabel']() !== null):$and15)) === null || $bool95 === false || $bool95 === 0 || $bool95 === '' ?
						false :
						(typeof $bool95=='object'?
							(typeof $bool95.__nonzero__=='function'?
								...
								(typeof $bool95.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					result = (typeof ($add113=result)==typeof ($add114=1) && (typeof $add113=='number'||typeof $add113=='string')?
						$add113+$add114:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setDefaultBorderColor', function(curve, index) {
			...
			curve['getSymbol']()['setBorderColor']((typeof ($9=$p['getattr'](self, 'defaultSymbolBorderColors')).__array != 'undefined'?
				((typeof $9.__array[$10=(typeof ($mod3=index)==typeof ($mod4=(($len7=$p['getattr'](self, 'defaultSymbolBorderColors')) === null?0:
				...
				$p['op_mod']($mod3,$mod4))]) != 'undefined'?$9.__array[$10]:
					$9.__getitem__($10)):
					$9.__getitem__((typeof ($mod3=index)==typeof ($mod4=(($len7=$p['getattr'](self, 'defaultSymbolBorderColors')) === null?0:
				(typeof $len7.__array != 'undefined' ? $len7.__array.length:
					(typeof $len7.__len__ == 'function'?$len7.__len__():
						(typeof $len7.length != 'undefined'?$len7.length:
							$p['len']($len7)))))) && typeof $mod3=='number'?
	...
	, 1, [null,null,['self'],['curve'],['index']]);
		...
		$method = $pyjs__bind_method2('realizeCurve', function(c) {
			...
			var arp,j,$eq72,canvasRegion,nPoints,$bool110,$cmp49,rpIndex,$and23,$and22,$and21,$and20,$cmp52,grp,$iter9_iter,$iter9_array,$iter9_nextval,$iter9_idx,$eq70,$eq71,$or21,$or20,$iter9_type,$sub54,$sub53,$bool105,$bool104,$bool107,$bool106,$bool101,$and17,$bool103,$bool102,$cmp51,$cmp50,$and18,$and19,$bool109,$bool108,internalIndex,$eq69,$eq68,$bool96,$bool97,$bool98,$eq64,$eq67,$eq66,$eq61,$eq63,$eq62,$eq65,$bool99,$or19,$or18,$bool100;
			...
			if ((($bool97=(($eq61=$p['getattr']($m['GChartWidgets'], 'DECORATIVE_RENDERING_PANEL_INDEX'))===($eq62=rpIndex)&&$eq61===null?true:
				($eq61===null?false:($eq62===null?false:
					((typeof $eq61=='object'||typeof $eq61=='function')&&typeof $eq61.__cmp__=='function'?$eq61.__cmp__($eq62) === 0:
						((typeof $eq62=='object'||typeof $eq62=='function')&&typeof $eq62.__cmp__=='function'?$eq62.__cmp__($eq61) === 0:
							$eq61==$eq62)))))) === null || $bool97 === false || $bool97 === 0 || $bool97 === '' ?
					false :
					(typeof $bool97=='object'?
						(typeof $bool97.__nonzero__=='function'?
							...
							(typeof $bool97.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool98=(($eq63=0)===($eq64=internalIndex)&&$eq63===null?true:
					($eq63===null?false:($eq64===null?false:
						((typeof $eq63=='object'||typeof $eq63=='function')&&typeof $eq63.__cmp__=='function'?$eq63.__cmp__($eq64) === 0:
							((typeof $eq64=='object'||typeof $eq64=='function')&&typeof $eq64.__cmp__=='function'?$eq64.__cmp__($eq63) === 0:
								$eq63==$eq64)))))) === null || $bool98 === false || $bool98 === 0 || $bool98 === '' ?
						false :
			...
			else if ((($bool102=((($bool99=$and17=(($eq65=0)===($eq66=c['getSymbol']()['getFillSpacing']())&&$eq65===null?true:
				($eq65===null?false:($eq66===null?false:
					((typeof $eq65=='object'||typeof $eq65=='function')&&typeof $eq65.__cmp__=='function'?$eq65.__cmp__($eq66) === 0:
						((typeof $eq66=='object'||typeof $eq66=='function')&&typeof $eq66.__cmp__=='function'?$eq66.__cmp__($eq65) === 0:
							$eq65==$eq66)))))) === null || $bool99 === false || $bool99 === 0 || $bool99 === '' ?
				false :
					...
					(typeof $bool99.__nonzero__=='function'?
						...
						(typeof $bool99.__len__=='function'?
							($bool99.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool100=$and18=((($cmp49=0)===($cmp50=c['getSymbol']()['getFillThickness']())?0:
					...
					(typeof $bool100.__nonzero__=='function'?
						...
						(typeof $bool100.__len__=='function'?
							($bool100.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($bool101=$and19=!(($eq67=null)===($eq68=self['getCanvasFactory']())&&$eq67===null?true:
				($eq67===null?false:($eq68===null?false:
					((typeof $eq67=='object'||typeof $eq67=='function')&&typeof $eq67.__cmp__=='function'?$eq67.__cmp__($eq68) === 0:
						((typeof $eq68=='object'||typeof $eq68=='function')&&typeof $eq68.__cmp__=='function'?$eq68.__cmp__($eq67) === 0:
							$eq67==$eq68)))))) === null || $bool101 === false || $bool101 === 0 || $bool101 === '' ?
				false :
					...
					(typeof $bool103=='object'?
						(typeof $bool103.__nonzero__=='function'?
							...
							(typeof $bool103.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool108=((($bool105=$and21=((((($cmp51=self['getCurveIndex'](c))===($cmp52=0)?0:
			...
			if ((($bool110=((($bool109=$or20=!(($eq69=$p['getattr']($m['GChartWidgets'], 'DECORATIVE_RENDERING_PANEL_INDEX'))===($eq70=rpIndex)&&$eq69===null?true:
				($eq69===null?false:($eq70===null?false:
					((typeof $eq69=='object'||typeof $eq69=='function')&&typeof $eq69.__cmp__=='function'?$eq69.__cmp__($eq70) === 0:
						((typeof $eq70=='object'||typeof $eq70=='function')&&typeof $eq70.__cmp__=='function'?$eq70.__cmp__($eq69) === 0:
							$eq69==$eq70)))))) === null || $bool109 === false || $bool109 === 0 || $bool109 === '' ?
				false :
					...
					(typeof $bool109.__nonzero__=='function'?
						...
						(typeof $bool109.__len__=='function'?
							($bool109.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or20:(($eq71=internalIndex)===($eq72=(typeof ($sub53=$m['N_PRE_SYSTEM_CURVES'])==typeof ($sub54=1) && (typeof $sub53=='number'||typeof $sub53=='string')?
				$sub53-$sub54:
				$p['op_sub']($sub53,$sub54)))&&$eq71===null?true:
				($eq71===null?false:($eq72===null?false:
					((typeof $eq71=='object'||typeof $eq71=='function')&&typeof $eq71.__cmp__=='function'?$eq71.__cmp__($eq72) === 0:
						((typeof $eq72=='object'||typeof $eq72=='function')&&typeof $eq72.__cmp__=='function'?$eq72.__cmp__($eq71) === 0:
							$eq71==$eq72))))))) === null || $bool110 === false || $bool110 === 0 || $bool110 === '' ?
					false :
	...
	, 1, [null,null,['self'],['c']]);
		...
		$method = $pyjs__bind_method2('invalidateEveryCurve', function() {
			...
			$iter10_iter = $p['range']((($len8=$p['getattr'](self, 'curves')) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('invalidateDependentSlices', function(iFirstCurve) {
			...
			var c,$iter13_nextval,$iter13_iter,i,nCurves,$eq73,$iter13_array,$bool112,$bool113,$iter13_idx,$bool114,$iter13_type,$eq74;
			...
			while (typeof ($iter13_nextval=($iter13_type?($iter13_type > 0?$iter13_iter.next(true,false):$p['wrapped_next']($iter13_iter)):$iter13_array[$iter13_idx++])) != 'undefined') {
				...
				else if ((($bool114=(($eq73=i)===($eq74=iFirstCurve)&&$eq73===null?true:
					($eq73===null?false:($eq74===null?false:
						((typeof $eq73=='object'||typeof $eq73=='function')&&typeof $eq73.__cmp__=='function'?$eq73.__cmp__($eq74) === 0:
							((typeof $eq74=='object'||typeof $eq74=='function')&&typeof $eq74.__cmp__=='function'?$eq74.__cmp__($eq73) === 0:
								$eq73==$eq74)))))) === null || $bool114 === false || $bool114 === 0 || $bool114 === '' ?
						false :
					...
					(typeof $bool116.__nonzero__=='function'?
						...
						(typeof $bool116.__len__=='function'?
							($bool116.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?((($cmp55=self['plotPanel']['getRenderingPanelCount']())===($cmp56=0)?0:
