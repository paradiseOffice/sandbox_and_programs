		...
		try {
				...
				while ((($bool2=type_i) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
						...
						(typeof $bool2=='object'?
							(typeof $bool2.__nonzero__=='function'?
							 ...
							 true ) )) {
					types['append'](type_i);
					ct = (typeof ($add1=ct)==typeof ($add2=1) && (typeof $add1=='number'||typeof $add1=='string')?
						$add1+$add2:
						$p['op_add']($add1,$add2));
					type_i = dt_types['item'](ct);
				}
					...
					try {
						...
						while ((($bool3=type_i) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
								...
								(typeof $bool3=='object'?
									(typeof $bool3.__nonzero__=='function'?
									 ...
									 true ) )) {
							types['append'](type_i);
							ct = (typeof ($add3=ct)==typeof ($add4=1) && (typeof $add3=='number'||typeof $add3=='string')?
								$add3+$add4:
								$p['op_add']($add3,$add4));
						...
						if (true) {
							...
							while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
								item = $iter1_nextval;
								try {
									if ((($bool4=(($len1=dt['getData'](item)) === null?0:
			...
			if (true) {
				...
				while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
					item = $iter2_nextval;
					try {
						if ((($bool5=(($len2=dt['getData'](item)) === null?0:
