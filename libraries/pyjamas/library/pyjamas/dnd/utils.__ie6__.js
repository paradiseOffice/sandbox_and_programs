...
$pyjs.loaded_modules['pyjamas.dnd.utils'] = function (__mod_name__) {
	...
	$m['copyStyles'] = function(elem1, elem2) {
		var $bool10,$bool11,$bool12,$bool13,style,$bool9,$iter2_iter,$pyjs_try_err,$iter2_type,$eq2,$eq3,$eq1,$eq4,element_style,$iter2_idx,$4,$3,$iter2_nextval,value,$iter2_array;
						...
						(typeof $bool10=='object'?
							(typeof $bool10.__nonzero__=='function'?
								...
								(typeof $bool10.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool12=!(($bool11=(($eq1=style)===($eq2='cssText')&&$eq1===null?true:
						...
						if ((($bool13=(($eq3=value)===($eq4='font')&&$eq3===null?true:
	...
	$m['getTargetInChildren'] = function(element, x, y) {
		...
		return_elt = null;
		if ((($bool14=((($cmp9=$m['DOM']['getChildCount'](element))===($cmp10=0)?0:
	...
	$m['eventCoordinates'] = function(event) {
		...
		pageX = (typeof ($add5=$p['getattr'](event, 'clientX'))==typeof ($add6=offsetX) && (typeof $add5=='number'||typeof $add5=='string')?
			$add5+$add6:
			$p['op_add']($add5,$add6));
		pageY = (typeof ($add7=$p['getattr'](event, 'clientY'))==typeof ($add8=offsetY) && (typeof $add7=='number'||typeof $add7=='string')?
			$add7+$add8:
			$p['op_add']($add7,$add8));
	...
	$m['DraggingWidget'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(element) {
			...
			if ((($bool18=(element !== null)) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
					false :
	...
	, 1, [null,null,['self'],['element']]);
		...
		$method = $pyjs__bind_method2('updateCursor', function(operation) {
			...
			var $eq8,$eq9,$eq6,$eq7,$eq5,$bool21,$bool20,$bool22,$eq10;
			if ((($bool20=(($eq5=operation)===($eq6='copy')&&$eq5===null?true:
			...
			else if ((($bool21=(($eq7=operation)===($eq8='link')&&$eq7===null?true:
			...
			else if ((($bool22=(($eq9=operation)===($eq10='move')&&$eq9===null?true:
				($eq9===null?false:($eq10===null?false:
					((typeof $eq9=='object'||typeof $eq9=='function')&&typeof $eq9.__cmp__=='function'?$eq9.__cmp__($eq10) === 0:
						((typeof $eq10=='object'||typeof $eq10=='function')&&typeof $eq10.__cmp__=='function'?$eq10.__cmp__($eq9) === 0:
							$eq9==$eq10)))))) === null || $bool22 === false || $bool22 === 0 || $bool22 === '' ?
					false :
	...
	, 1, [null,null,['self'],['iterable', null]]);
		...
		$method = $pyjs__bind_method2('_getLength', function() {
			...
			var $len1;
			return (($len1=$p['getattr'](self, '_data')) === null?0:
	...
	, 1, [null,null,['self'],['url']]);
		...
		$method = $pyjs__bind_method2('get_first_url', function() {
			...
			var $iter6_idx,$iter6_type,$bool25,item,$iter6_array,$8,$eq11,$7,$iter6_iter,$eq12,$iter6_nextval;
			...
			while (typeof ($iter6_nextval=($iter6_type?($iter6_type > 0?$iter6_iter.next(true,false):$p['wrapped_next']($iter6_iter)):$iter6_array[$iter6_idx++])) != 'undefined') {
				item = $iter6_nextval;
				if ((($bool25=!(($eq11=(typeof ($7=item).__array != 'undefined'?
					((typeof $7.__array[$8=0]) != 'undefined'?$7.__array[$8]:
						$7.__getitem__($8)):
						$7.__getitem__(0)))===($eq12='#')&&$eq11===null?true:
					...
					(typeof $bool26=='object'?
						(typeof $bool26.__nonzero__=='function'?
							...
							(typeof $bool26.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				return (typeof ($add9='\r\n'['join']($p['getattr'](self, '_data')))==typeof ($add10='\r\n') && (typeof $add9=='number'||typeof $add9=='string')?
					$add9+$add10:
					$p['op_add']($add9,$add10));
			}
			return '';
