...
$pyjs.loaded_modules['pyjamas.logging'] = function (__mod_name__) {
	...
	$p['__import_all__']('logging', 'pyjamas.logging', $m, null, false);
	...
	$m['getLoggerForHandler'] = function(handler, name, level, fmt) {
		...
		formatter = (typeof Formatter == "undefined"?$m.Formatter:Formatter)(fmt);
		handler['setFormatter'](formatter);
		logger = (typeof getLogger == "undefined"?$m.getLogger:getLogger)(name);
	...
	$m['getLoggerForHandler'].__args__ = [null,null,['handler'],['name', (typeof __name__ == "undefined"?$m.__name__:__name__)],['level', (typeof DEBUG == "undefined"?$m.DEBUG:DEBUG)],['fmt', (typeof BASIC_FORMAT == "undefined"?$m.BASIC_FORMAT:BASIC_FORMAT)]];
	...
	$m['getAlertLogger'].__args__ = [null,null,['name', (typeof __name__ == "undefined"?$m.__name__:__name__)],['level', (typeof DEBUG == "undefined"?$m.DEBUG:DEBUG)],['fmt', (typeof BASIC_FORMAT == "undefined"?$m.BASIC_FORMAT:BASIC_FORMAT)]];
	...
	$m['getAppendLogger'].__args__ = [null,null,['name', (typeof __name__ == "undefined"?$m.__name__:__name__)],['level', (typeof DEBUG == "undefined"?$m.DEBUG:DEBUG)],['fmt', (typeof BASIC_FORMAT == "undefined"?$m.BASIC_FORMAT:BASIC_FORMAT)]];
	...
	$m['getConsoleLogger'].__args__ = [null,null,['name', (typeof __name__ == "undefined"?$m.__name__:__name__)],['level', (typeof DEBUG == "undefined"?$m.DEBUG:DEBUG)],['fmt', (typeof BASIC_FORMAT == "undefined"?$m.BASIC_FORMAT:BASIC_FORMAT)]];
	...
	$m['getNullLogger'].__args__ = [null,null,['name', (typeof __name__ == "undefined"?$m.__name__:__name__)],['level', (typeof DEBUG == "undefined"?$m.DEBUG:DEBUG)],['fmt', (typeof BASIC_FORMAT == "undefined"?$m.BASIC_FORMAT:BASIC_FORMAT)]];
	$m['getPrintLogger'] = function(name, level, fmt) {
		if (typeof name == 'undefined') name=arguments.callee.__args__[2][1];
		if (typeof level == 'undefined') level=arguments.callee.__args__[3][1];
		if (typeof fmt == 'undefined') fmt=arguments.callee.__args__[4][1];

		return $m['getLoggerForHandler']((typeof StreamHandler == "undefined"?$m.StreamHandler:StreamHandler)(), name, level, fmt);
	};
	$m['getPrintLogger'].__name__ = 'getPrintLogger';

	$m['getPrintLogger'].__bind_type__ = 0;
	$m['getPrintLogger'].__args__ = [null,null,['name', (typeof __name__ == "undefined"?$m.__name__:__name__)],['level', (typeof DEBUG == "undefined"?$m.DEBUG:DEBUG)],['fmt', (typeof BASIC_FORMAT == "undefined"?$m.BASIC_FORMAT:BASIC_FORMAT)]];
	return this;
}; /* end pyjamas.logging */
...
/*
PYJS_DEPS: ['pyjamas.logging.handlers.AlertHandler', 'pyjamas', 'pyjamas.logging', 'pyjamas.logging.handlers', 'pyjamas.logging.handlers.AppendHandler', 'pyjamas.logging.handlers.ConsoleHandler', 'pyjamas.logging.handlers.NullHandler', 'logging']
*/
