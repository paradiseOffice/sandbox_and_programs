...
$pyjs.loaded_modules['pyjamas.logging.handlers'] = function (__mod_name__) {
	...
	$m['AppendHandler'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(logger_name) {
			...
			var $add2,$add1;
			$m['Handler']['__init__'](self);
			self.div_id = self['__getSafeNameFor']((typeof ($add1='logging_')==typeof ($add2=logger_name) && (typeof $add1=='number'||typeof $add1=='string')?
				$add1+$add2:
				$p['op_add']($add1,$add2)));
			return null;
		}
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self'],['name']]);
		...
		$method = $pyjs__bind_method2('__addLogElement', function() {
			...
			var $eq2,$bool2,$eq1;
			if ((($bool2=(($eq1=$p['getattr'](self, 'div'))===($eq2=null)&&$eq1===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('emit', function(record) {
			...
			msg = (typeof ($add7=msg['$$replace']('\n', '<br/>\n'))==typeof ($add8='<br/>\n') && (typeof $add7=='number'||typeof $add7=='string')?
				$add7+$add8:
				$p['op_add']($add7,$add8));
			self.output = (typeof ($add9=$p['getattr'](self, 'output'))==typeof ($add10=msg) && (typeof $add9=='number'||typeof $add9=='string')?
				$add9+$add10:
				$p['op_add']($add9,$add10));
