...
$pyjs.loaded_modules['pyjamas.ui.AreaSlider'] = function (__mod_name__) {
	...
	, 1, [null,['kwargs'],['self'],['min_value'],['max_value'],['start_value', null],['step', null]]);
		...
		$method = $pyjs__bind_method2('setHandleStyle', function(border, width, height, backgroundColor) {
			...
			if ((($bool4=(border !== null)) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
					false :
					(typeof $bool4=='object'?
			...
			if ((($bool5=(width !== null)) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
					false :
					(typeof $bool5=='object'?
			...
			if ((($bool6=(height !== null)) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
					false :
					(typeof $bool6=='object'?
			...
			if ((($bool7=(backgroundColor !== null)) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
					false :
					(typeof $bool7=='object'?
	...
	, 1, [null,null,['self'],['border'],['width'],['height'],['backgroundColor']]);
		...
		$method = $pyjs__bind_method2('setValue', function(new_value, notify) {
			...
			self.value_x = (typeof ($1=new_value).__array != 'undefined'?
				((typeof $1.__array[$2=0]) != 'undefined'?$1.__array[$2]:
					$1.__getitem__($2)):
					$1.__getitem__(0));
			self.value_y = (typeof ($3=new_value).__array != 'undefined'?
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$method = $pyjs__bind_method2('moveControl', function(mouse_x, mouse_y, first_move) {
			...
			height_range = (typeof ($sub1=widget_height)==typeof ($sub2=10) && (typeof $sub1=='number'||typeof $sub1=='string')?
				$sub1-$sub2:
				$p['op_sub']($sub1,$sub2));
			relative_y = (typeof ($sub3=mouse_y)==typeof ($sub4=(typeof ($div1=handle_height)==typeof ($div2=2) && typeof $div1=='number' && $div2 !== 0?
				$div1/$div2:
				$p['op_div']($div1,$div2))) && (typeof $sub3=='number'||typeof $sub3=='string')?
				$sub3-$sub4:
				$p['op_sub']($sub3,$sub4));
			if ((($bool10=((($cmp1=relative_y)===($cmp2=0)?0:
			...
			length_range = (typeof ($sub7=widget_width)==typeof ($sub8=10) && (typeof $sub7=='number'||typeof $sub7=='string')?
				$sub7-$sub8:
				$p['op_sub']($sub7,$sub8));
			relative_x = (typeof ($sub9=mouse_x)==typeof ($sub10=(typeof ($div3=handle_width)==typeof ($div4=2) && typeof $div3=='number' && $div4 !== 0?
				$div3/$div4:
				$p['op_div']($div3,$div4))) && (typeof $sub9=='number'||typeof $sub9=='string')?
				$sub9-$sub10:
				$p['op_sub']($sub9,$sub10));
			if ((($bool12=((($cmp5=relative_x)===($cmp6=0)?0:
		...
		$method = $pyjs__bind_method2('setControlPos', function(value) {
			...
			value_y = (typeof ($7=value).__array != 'undefined'?
				((typeof $7.__array[$8=1]) != 'undefined'?$7.__array[$8]:
					...
					$7.__getitem__(1));
			widget_width = self['getOffsetWidth']();
			length_range = (typeof ($sub15=widget_width)==typeof ($sub16=10) && (typeof $sub15=='number'||typeof $sub15=='string')?
				$sub15-$sub16:
			...
			relative_x = (typeof ($div9=(typeof ($mul5=length_range)==typeof ($mul6=(typeof ($sub19=value_x)==typeof ($sub20=$p['getattr'](self, 'min_value_x')) && (typeof $sub19=='number'||typeof $sub19=='string')?
				...
				$div9/$div10:
				$p['op_div']($div9,$div10));
			if ((($bool14=((($cmp9=relative_x)===($cmp10=0)?0:
			...
			widget_height = self['getOffsetHeight']();
			height_range = (typeof ($sub21=widget_height)==typeof ($sub22=10) && (typeof $sub21=='number'||typeof $sub21=='string')?
				$sub21-$sub22:
			...
			if ((($bool16=((($cmp13=relative_y)===($cmp14=0)?0:
