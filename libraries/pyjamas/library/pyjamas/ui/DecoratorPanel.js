...
$pyjs.loaded_modules['pyjamas.ui.DecoratorPanel'] = function (__mod_name__) {
	...
	$m['DecoratorPanel'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(rowStyles, containerIndex) {
			...
			var $iter1_iter,row,$iter1_array,$iter1_nextval,$eq2,$eq1,$bool2,$bool3,$bool1,$bool6,$bool4,$bool5,$2,$1,$iter1_type,i,fc,$iter1_idx,$len1;
						...
						(typeof $bool6=='object'?
							(typeof $bool6.__nonzero__=='function'?
								...
								(typeof $bool6.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					self.containerElem = $m['DOM']['getFirstChild']($m['DOM']['getChild'](row, 1));
				}
			}
			return null;
		}
	...
	, 1, [null,['kwargs'],['self']]);
		...
		$method = $pyjs__bind_method2('createTabTextWrapper', function() {
			...
			return $m['DecoratorPanel']($p['getattr'](self, 'TAB_ROW_STYLES'), 1);
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,['kwargs'],['self']]);
		...
		$method = $pyjs__bind_method2('createTabTextWrapper', function() {
			...
			return $m['DecoratorPanel']($p['getattr']($m['DecoratedTabBar'], 'TAB_ROW_STYLES'), 1);
		}
	, 1, [null,null,['self']]);
		$cls_definition['createTabTextWrapper'] = $method;
	...
	$m['DecoratorTitledPanel'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(title, titleStyle, imgStyle, rowStyles, containerIndex, titleIndex) {
			...
			if ((($bool10=(rowStyles === null)) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
					false :
			...
			if ((($bool11=(titleStyle === null)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
					false :
