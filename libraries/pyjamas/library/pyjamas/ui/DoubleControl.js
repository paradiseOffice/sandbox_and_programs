...
$pyjs.loaded_modules['pyjamas.ui.DoubleControl'] = function (__mod_name__) {
	...
	$m['DoubleControl'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(element, min_value, max_value, start_value_xy, step_xy) {
			...
			self.min_value_x = (typeof ($1=min_value).__array != 'undefined'?
				((typeof $1.__array[$2=0]) != 'undefined'?$1.__array[$2]:
					$1.__getitem__($2)):
					$1.__getitem__(0));
			self.min_value_y = (typeof ($3=min_value).__array != 'undefined'?
				((typeof $3.__array[$4=1]) != 'undefined'?$3.__array[$4]:
					$3.__getitem__($4)):
					$3.__getitem__(1));
			self.max_value_x = (typeof ($5=max_value).__array != 'undefined'?
				((typeof $5.__array[$6=0]) != 'undefined'?$5.__array[$6]:
					$5.__getitem__($6)):
					$5.__getitem__(0));
			self.max_value_y = (typeof ($7=max_value).__array != 'undefined'?
				((typeof $7.__array[$8=1]) != 'undefined'?$7.__array[$8]:
					$7.__getitem__($8)):
					$7.__getitem__(1));
			if ((($bool1=(start_value_xy === null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
					false :
					(typeof $bool1=='object'?
						(typeof $bool1.__nonzero__=='function'?
							...
							(typeof $bool1.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				self.start_value_x = $p['getattr'](self, 'min_value_x');
				self.start_value_y = $p['getattr'](self, 'min_value_y');
			}
			else {
				self.start_value_x = (typeof ($9=start_value_xy).__array != 'undefined'?
					((typeof $9.__array[$10=0]) != 'undefined'?$9.__array[$10]:
						$9.__getitem__($10)):
						$9.__getitem__(0));
				self.start_value_y = (typeof ($11=start_value_xy).__array != 'undefined'?
					((typeof $11.__array[$12=1]) != 'undefined'?$11.__array[$12]:
						$11.__getitem__($12)):
						$11.__getitem__(1));
			}
			if ((($bool2=(step_xy === null)) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
					false :
					(typeof $bool2=='object'?
						(typeof $bool2.__nonzero__=='function'?
							...
							(typeof $bool2.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				self.step_x = (typeof ($div1=(typeof ($sub1=$p['getattr'](self, 'max_value_x'))==typeof ($sub2=$p['getattr'](self, 'min_value_x')) && (typeof $sub1=='number'||typeof $sub1=='string')?
					$sub1-$sub2:
					$p['op_sub']($sub1,$sub2)))==typeof ($div2=20) && typeof $div1=='number' && $div2 !== 0?
					$div1/$div2:
					$p['op_div']($div1,$div2));
				self.step_y = (typeof ($div3=(typeof ($sub3=$p['getattr'](self, 'max_value_y'))==typeof ($sub4=$p['getattr'](self, 'min_value_y')) && (typeof $sub3=='number'||typeof $sub3=='string')?
					$sub3-$sub4:
					$p['op_sub']($sub3,$sub4)))==typeof ($div4=20) && typeof $div3=='number' && $div4 !== 0?
					$div3/$div4:
					$p['op_div']($div3,$div4));
			}
			else {
				self.step_x = (typeof ($13=step_xy).__array != 'undefined'?
					((typeof $13.__array[$14=0]) != 'undefined'?$13.__array[$14]:
						$13.__getitem__($14)):
						$13.__getitem__(0));
				self.step_y = (typeof ($15=step_xy).__array != 'undefined'?
					((typeof $15.__array[$16=1]) != 'undefined'?$15.__array[$16]:
						$15.__getitem__($16)):
						$15.__getitem__(1));
			}
			self.value_x = $p['getattr'](self, 'start_value_x');
			self.value_y = $p['getattr'](self, 'start_value_y');
	...
	, 1, [null,null,['self'],['value']]);
		...
		$method = $pyjs__bind_method2('setValue', function(new_value_x, new_value_y, notify) {
			...
			self.value_x = (typeof ($21=(typeof new_value == "undefined"?$m.new_value:new_value)).__array != 'undefined'?
				((typeof $21.__array[$22=0]) != 'undefined'?$21.__array[$22]:
					$21.__getitem__($22)):
					$21.__getitem__(0));
			self.value_y = (typeof ($23=(typeof new_value == "undefined"?$m.new_value:new_value)).__array != 'undefined'?
	...
	, 1, [null,null,['self'],['new_value_x'],['new_value_y'],['notify', 1]]);
	...
	, 1, [null,null,['self'],['value_old_xy'],['value_new_xy']]);
		...
		$method = $pyjs__bind_method2('onKeyDown', function(sender, keycode, modifiers) {
			...
			var $bool8,$eq2,$eq3,$eq1,$eq4,$sub12,$sub9,$add6,$bool7,$sub10,$add5,$sub11,new_value,$add8,$add7;
			if ((($bool7=(($eq1=keycode)===($eq2=$p['getattr']($m['KeyboardListener'], 'KEY_UP'))&&$eq1===null?true:
			...
			else if ((($bool8=(($eq3=keycode)===($eq4=$p['getattr']($m['KeyboardListener'], 'KEY_DOWN'))&&$eq3===null?true:
