			...
			kwargs = $p['__empty_dict']();
{
	...
	$m['show'] = function(mousetarget) {
		...
		var target_element,$bool4;
		target_element = mousetarget['getElement']();
		if ((($bool4=$p['hasattr'](target_element, 'setCapture')) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
				false :
				(typeof $bool4=='object'?
	...
	$m['hide'] = function() {
		var $bool5;
		if ((($bool5=$p['hasattr']($m['mousecapturer'], 'releaseCapture')) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
				false :
				(typeof $bool5=='object'?
	...
	$m['GlassWidget'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			var element,$bool6,$bool7,$bool8;
			self.glassListeners = $p['list']([]);
			self.showing = false;
			self.mousehandler = false;
			if ((($bool7=!(($bool6=kwargs.__contains__('StyleName')) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
				false :
				(typeof $bool6=='object'?
			...
			if ((($bool8=kwargs.__contains__('Element')) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
					false :
					(typeof $bool8=='object'?
	...
	, 1, [null,null,['self'],['listener']]);
		...
		$method = $pyjs__bind_method2('hide', function(autoClosed) {
			...
			var $iter1_nextval,$iter1_type,$iter1_iter,listener,$iter1_array,$bool9,$iter1_idx;
			self.showing = false;
			self['hideGlass']();
			...
			while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
				...
				if ((($bool9=$p['hasattr'](listener, 'onGlassHide')) === null || $bool9 === false || $bool9 === 0 || $bool9 === '' ?
						false :
						(typeof $bool9=='object'?
	...
	, 1, [null,null,['self'],['autoClosed', false]]);
		...
		$method = $pyjs__bind_method2('_event_targets_popup', function(event) {
			...
			var target,$bool10,$and1,$and2;
			target = $m['DOM']['eventGetTarget'](event);
			return ((($bool10=$and1=target) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
				false :
	...
	, 1, [null,null,['self'],['event']]);
		...
		$method = $pyjs__bind_method2('onEventPreview', function(event) {
			...
			var $bool18,$bool11,$bool12,$bool13,$bool14,$bool15,$bool16,$bool17,$or6,$eq10,$eq11,$eq12,etype,$or5,$or4,$eq8,$eq9,$or1,$or3,$or2,$eq2,$eq3,$eq1,$eq6,$eq7,$eq4,$eq5;
			etype = $m['DOM']['eventGetType'](event);
			if ((($bool12=((($bool11=$or1=(($eq1=etype)===($eq2='mousedown')&&$eq1===null?true:
					...
					(typeof $bool12=='object'?
						(typeof $bool12.__nonzero__=='function'?
							...
							(typeof $bool12.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool13=($m['DOM']['getCaptureElement']() !== null)) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
						false :
			...
			else if ((($bool17=((($bool14=$or3=(($eq5=etype)===($eq6='mouseup')&&$eq5===null?true:
					...
					(typeof $bool14.__nonzero__=='function'?
						...
						(typeof $bool14.__len__=='function'?
							($bool14.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or3:((($bool15=$or4=(($eq7=etype)===($eq8='click')&&$eq7===null?true:
					...
					(typeof $bool15.__nonzero__=='function'?
						...
						(typeof $bool15.__len__=='function'?
							($bool15.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?$or4:((($bool16=$or5=(($eq9=etype)===($eq10='mousemove')&&$eq9===null?true:
					...
					(typeof $bool17=='object'?
						(typeof $bool17.__nonzero__=='function'?
							...
							(typeof $bool17.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				if ((($bool18=($m['DOM']['getCaptureElement']() !== null)) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
						false :
	...
	, 1, [null,null,['self'],['listener']]);
		...
		$method = $pyjs__bind_method2('setGlassPosition', function() {
			...
			var el,$eq15,$bool19,$add3,height,$add2,width,$add1,$bool21,$bool20,$add4,$eq13,$eq14,top,$eq16,left;
			...
			$m['DOM']['setStyleAttribute'](el, 'left', ((($bool19=(($eq13=left)===($eq14=0)&&$eq13===null?true:
			...
			$m['DOM']['setStyleAttribute'](el, 'top', ((($bool20=(($eq15=top)===($eq16=0)&&$eq15===null?true:
				($eq15===null?false:($eq16===null?false:
					((typeof $eq15=='object'||typeof $eq15=='function')&&typeof $eq15.__cmp__=='function'?$eq15.__cmp__($eq16) === 0:
						((typeof $eq16=='object'||typeof $eq16=='function')&&typeof $eq16.__cmp__=='function'?$eq16.__cmp__($eq15) === 0:
							$eq15==$eq16)))))) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
				false :
			...
			$m['DOM']['setStyleAttribute'](el, 'width', $p['sprintf']('%spx', (typeof ($add3=left)==typeof ($add4=width) && (typeof $add3=='number'||typeof $add3=='string')?
				$add3+$add4:
				$p['op_add']($add3,$add4))));
			if ((($bool21=$p['getattr']($m['pyjd'], 'is_desktop')) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
					false :
	...
	, 1, [null,null,['self'],['width'],['height']]);
		...
		$method = $pyjs__bind_method2('show', function() {
			...
			var $bool22;
			if ((($bool22=$p['getattr'](self, 'showing')) === null || $bool22 === false || $bool22 === 0 || $bool22 === '' ?
					false :
	...
	, 1, [null,null,['self'],['sender'],['x'],['y']]);
		...
		$method = $pyjs__bind_method2('onMouseUp', function(sender, x, y) {
			...
			x = $tupleassign3[0];
			y = $tupleassign3[1];
			if ((($bool25=$p['getattr'](self, 'mousehandler')) === null || $bool25 === false || $bool25 === 0 || $bool25 === '' ?
					false :
