...
$pyjs.loaded_modules['pyjamas.ui.HTMLTable'] = function (__mod_name__) {
		...
		$method = $pyjs__bind_method2('clear', function() {
			...
			while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
				...
				while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
					...
					if ((($bool7=(child !== null)) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
							false :
							(typeof $bool7=='object'?
	...
	, 1, [null,null,['self'],['row'],['column']]);
		...
		$method = $pyjs__bind_method2('getWidget', function(row, column) {
			...
			if ((($bool8=(column === null)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
					false :
					(typeof $bool8=='object'?
			...
			if ((($bool9=(key === null)) === null || $bool9 === false || $bool9 === 0 || $bool9 === '' ?
					false :
					(typeof $bool9=='object'?
		...
		$method = $pyjs__bind_method2('getIndex', function(widget) {
			...
			while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
				...
				while (typeof ($iter4_nextval=($iter4_type?($iter4_type > 0?$iter4_iter.next(true,false):$p['wrapped_next']($iter4_iter)):$iter4_array[$iter4_idx++])) != 'undefined') {
					col = $iter4_nextval;
					if ((($bool10=(self['getWidget'](row, col) === widget)) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
							false :
		...
		$method = $pyjs__bind_method2('getIndexedChild', function(index) {
			...
			return self['getWidget']((typeof ($3=index).__array != 'undefined'?
				((typeof $3.__array[$4=0]) != 'undefined'?$3.__array[$4]:
					$3.__getitem__($4)):
					$3.__getitem__(0)), (typeof ($5=index).__array != 'undefined'?
	...
	, 1, [null,null,['self'],['item'],['row'],['col']]);
		...
		$method = $pyjs__bind_method2('isCellPresent', function(row, column) {
			...
			if ((($bool16=((($bool15=$or3=((($cmp9=column)===($cmp10=0)?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('_onBrowserEvent', function(event, event_type) {
			...
			var $bool18,$iter5_nextval,$bool19,$iter5_array,$bool17,$iter5_iter,$iter5_type,row,tr,$bool21,$bool20,$and1,td,body,$and3,$iter5_idx,$eq2,$eq3,$and2,$eq1,$eq6,$bool22,lists,$eq5,listener,$eq4,column,$and4;
			td = self['getEventTargetCell'](event);
			if ((($bool17=(td === null)) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
					false :
			...
			if ((($bool18=(($eq1=event_type)===($eq2='dblclick')&&$eq1===null?true:
			...
			while (typeof ($iter5_nextval=($iter5_type?($iter5_type > 0?$iter5_iter.next(true,false):$p['wrapped_next']($iter5_iter)):$iter5_array[$iter5_idx++])) != 'undefined') {
				...
				if ((($bool20=((($bool19=$and1=(($eq3=event_type)===($eq4='click')&&$eq3===null?true:
					($eq3===null?false:($eq4===null?false:
						((typeof $eq3=='object'||typeof $eq3=='function')&&typeof $eq3.__cmp__=='function'?$eq3.__cmp__($eq4) === 0:
							((typeof $eq4=='object'||typeof $eq4=='function')&&typeof $eq4.__cmp__=='function'?$eq4.__cmp__($eq3) === 0:
								$eq3==$eq4)))))) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
					false :
				...
				else if ((($bool22=((($bool21=$and3=(($eq5=event_type)===($eq6='dblclick')&&$eq5===null?true:
					($eq5===null?false:($eq6===null?false:
						((typeof $eq5=='object'||typeof $eq5=='function')&&typeof $eq5.__cmp__=='function'?$eq5.__cmp__($eq6) === 0:
							((typeof $eq6=='object'||typeof $eq6=='function')&&typeof $eq6.__cmp__=='function'?$eq6.__cmp__($eq5) === 0:
								$eq5==$eq6)))))) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
					false :
	...
	, 1, [null,null,['self'],['event'],['event_type']]);
		...
		$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
			...
			var $eq8,$eq9,event_type,$eq7,$and6,$and5,$bool24,$bool23,$eq10;
			event_type = $m['DOM']['eventGetType'](event);
			if ((($bool24=((($bool23=$and5=!(($eq7=event_type)===($eq8='dblclick')&&$eq7===null?true:
					...
					(typeof $bool23.__nonzero__=='function'?
						...
						(typeof $bool23.__len__=='function'?
							($bool23.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?!(($eq9=event_type)===($eq10='click')&&$eq9===null?true:
				($eq9===null?false:($eq10===null?false:
					((typeof $eq9=='object'||typeof $eq9=='function')&&typeof $eq9.__cmp__=='function'?$eq9.__cmp__($eq10) === 0:
						((typeof $eq10=='object'||typeof $eq10=='function')&&typeof $eq10.__cmp__=='function'?$eq10.__cmp__($eq9) === 0:
							$eq9==$eq10))))):$and5)) === null || $bool24 === false || $bool24 === 0 || $bool24 === '' ?
					false :
	...
	, 1, [null,null,['self'],['event']]);
		...
		$method = $pyjs__bind_method2('remove', function(widget) {
			...
			var $bool25,$eq11,$eq12;
			if ((($bool25=!(($eq11=widget['getParent']())===($eq12=self)&&$eq11===null?true:
	...
	, 1, [null,null,['self'],['listener']]);
		...
		$method = $pyjs__bind_method2('setBorderWidth', function(width) {
			...
			var $bool26;
			if ((($bool26=(width === null)) === null || $bool26 === false || $bool26 === 0 || $bool26 === '' ?
					false :
	...
	, 1, [null,null,['self'],['spacing']]);
		...
		$method = $pyjs__bind_method2('setHTML', function(row, column, html) {
			...
			if ((($bool27=(html !== null)) === null || $bool27 === false || $bool27 === 0 || $bool27 === '' ?
					false :
	...
	, 1, [null,null,['self'],['row'],['column'],['html']]);
		...
		$method = $pyjs__bind_method2('setText', function(row, column, text) {
			...
			self['prepareCell'](row, column);
			td = self['cleanCell'](row, column);
			if ((($bool28=(text !== null)) === null || $bool28 === false || $bool28 === 0 || $bool28 === '' ?
					false :
	...
	, 1, [null,null,['self'],['row'],['column'],['text']]);
		...
		$method = $pyjs__bind_method2('setWidget', function(row, column, widget) {
			...
			var td,$bool29;
			self['prepareCell'](row, column);
			if ((($bool29=(widget === null)) === null || $bool29 === false || $bool29 === 0 || $bool29 === '' ?
					false :
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getDOMCellCount', function(element, row) {
			...
			var $bool31;
			if ((($bool31=(row === null)) === null || $bool31 === false || $bool31 === 0 || $bool31 === '' ?
					false :
	...
	, 1, [null,null,['self'],['element'],['row']]);
		...
		$method = $pyjs__bind_method2('getDOMRowCount', function(element) {
			...
			var $bool32;
			if ((($bool32=(element === null)) === null || $bool32 === false || $bool32 === 0 || $bool32 === '' ?
					false :
	...
	, 1, [null,null,['self'],['element']]);
		...
		$method = $pyjs__bind_method2('getEventTargetCell', function(event) {
			...
			var $and8,body,$bool34,tr,$and7,$bool33,$bool36,$bool37,tagName,$bool35,td,$eq13,$eq14;
			td = $m['DOM']['eventGetTarget'](event);
			while ((($bool33=(td !== null)) === null || $bool33 === false || $bool33 === 0 || $bool33 === '' ?
					false :
				...
				if ((($bool35=((($bool34=$and7=(tagName !== null)) === null || $bool34 === false || $bool34 === 0 || $bool34 === '' ?
					false :
						...
						(typeof $bool34.__nonzero__=='function'?
							...
							(typeof $bool34.__len__=='function'?
								($bool34.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?(($eq13=tagName['lower']())===($eq14='td')&&$eq13===null?true:
					($eq13===null?false:($eq14===null?false:
						((typeof $eq13=='object'||typeof $eq13=='function')&&typeof $eq13.__cmp__=='function'?$eq13.__cmp__($eq14) === 0:
							((typeof $eq14=='object'||typeof $eq14=='function')&&typeof $eq14.__cmp__=='function'?$eq14.__cmp__($eq13) === 0:
								$eq13==$eq14))))):$and7)) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
						false :
	...
	, 1, [null,null,['self'],['row'],['column'],['count']]);
		...
		$method = $pyjs__bind_method2('insertRow', function(beforeRow) {
			...
			var tr,$bool38,$eq15,$eq16;
			if ((($bool38=!(($eq15=beforeRow)===($eq16=self['getRowCount']())&&$eq15===null?true:
	...
	, 1, [null,null,['self'],['beforeRow']]);
		...
		$method = $pyjs__bind_method2('internalClearCell', function(td) {
			...
			widget = null;
			if ((($bool39=(maybeChild !== null)) === null || $bool39 === false || $bool39 === 0 || $bool39 === '' ?
					false :
			...
			if ((($bool40=(widget !== null)) === null || $bool40 === false || $bool40 === 0 || $bool40 === '' ?
					false :
