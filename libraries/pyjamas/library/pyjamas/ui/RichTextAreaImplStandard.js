...
$pyjs.loaded_modules['pyjamas.ui.RichTextAreaImplStandard'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['view'],['evt'],['from_window']]);
		...
		$method = $pyjs__bind_method2('hookEvents', function() {
			...
			mf['_addWindowEventListener']('keydown', $p['getattr'](self, '__gwt_handler'));
			mf['_addWindowEventListener']('keyup', $p['getattr'](self, '__gwt_handler'));
			mf['_addWindowEventListener']('keypress', $p['getattr'](self, '__gwt_handler'));
			mf['_addWindowEventListener']('mousedown', $p['getattr'](self, '__gwt_handler'));
			mf['_addWindowEventListener']('mouseup', $p['getattr'](self, '__gwt_handler'));
			mf['_addWindowEventListener']('mousemove', $p['getattr'](self, '__gwt_handler'));
			mf['_addWindowEventListener']('mouseover', $p['getattr'](self, '__gwt_handler'));
			mf['_addWindowEventListener']('mouseout', $p['getattr'](self, '__gwt_handler'));
			mf['_addWindowEventListener']('click', $p['getattr'](self, '__gwt_handler'));
			mf['_addWindowEventListener']('focus', $p['getattr'](self, '__gwt_focus_handler'));
			mf['_addWindowEventListener']('blur', $p['getattr'](self, '__gwt_blur_handler'));
			return null;
		}
	, 1, [null,null,['self']]);
