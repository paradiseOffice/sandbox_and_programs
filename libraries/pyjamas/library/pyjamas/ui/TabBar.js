...
$pyjs.loaded_modules['pyjamas.ui.TabBar'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['sender', null]]);
		...
		$method = $pyjs__bind_method2('removeTab', function(index) {
			...
			var toRemove,$eq2,$eq1,$bool15,$add10,$add9;
			...
			toRemove = self['panel']['getWidget']((typeof ($add9=index)==typeof ($add10=1) && (typeof $add9=='number'||typeof $add9=='string')?
				$add9+$add10:
				$p['op_add']($add9,$add10)));
			if ((($bool15=(($eq1=toRemove)===($eq2=$p['getattr'](self, 'selectedTab'))&&$eq1===null?true:
	...
	, 1, [null,null,['self'],['listener']]);
		...
		$method = $pyjs__bind_method2('selectTab', function(index) {
			...
			var $bool18,$iter2_nextval,$iter2_type,$iter2_iter,$eq3,$iter3_array,$iter3_iter,$bool16,$bool17,listener,$iter2_idx,$iter3_idx,$eq4,$add12,$iter3_type,$iter3_nextval,$iter2_array,$add11;
			self['checkTabIndex'](index);
