...
$pyjs.loaded_modules['pyjamas.ui.TabPanel'] = function (__mod_name__) {
	...
	$m['TabPanel'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(tabBar) {
			...
			if ((($bool1=($p['getattr'](self, 'deck') === null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
					false :
					(typeof $bool1=='object'?
			...
			if ((($bool5=(self['deck']['getParent']() === null)) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
					false :
					(typeof $bool5=='object'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('insert', function(widget, tabText, asHTML, beforeIndex, name) {
			...
			var $bool6,$bool7;
			if ((($bool6=(beforeIndex === null)) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
					false :
					(typeof $bool6=='object'?
			...
			if ((($bool7=(name !== null)) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
					false :
					(typeof $bool7=='object'?
	...
	, 1, [null,null,['self'],['sender'],['tabIndex']]);
		...
		$method = $pyjs__bind_method2('remove', function(widget) {
			...
			var index,$iter3_idx,$eq3,$bool10,$bool11,$iter3_array,$eq4,$bool13,$eq2,$bool12,$iter3_iter,w,$iter3_type,k,$2,$iter3_nextval,$eq1,$1;
			...
			else if ((($bool11=$p['isinstance'](widget, $p['float_int'])) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
					false :
			...
			while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
				...
				k = $tupleassign1[0];
				w = $tupleassign1[1];
				if ((($bool12=(($eq1=widget)===($eq2=w)&&$eq1===null?true:
			...
			if ((($bool13=(($eq3=index)===($eq4=(typeof ($usub1=1)=='number'?
				-$usub1:
	...
	, 1, [null,null,['self'],['listener']]);
		...
		$method = $pyjs__bind_method2('selectTab', function(index) {
			...
			if ((($bool16=!(($bool15=$p['isinstance'](index, $p['float_int'])) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
				false :
