...
$pyjs.loaded_modules['pyjamas.ui.VerticalSlider'] = function (__mod_name__) {
	...
	, 1, [null,['ka'],['self'],['min_value'],['max_value'],['start_value', null],['step', null]]);
		...
		$method = $pyjs__bind_method2('setHandleStyle', function(border, width, height, backgroundColor) {
			...
			if ((($bool2=(border !== null)) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
					false :
					(typeof $bool2=='object'?
			...
			if ((($bool3=(width !== null)) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
					false :
					(typeof $bool3=='object'?
			...
			if ((($bool4=(height !== null)) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
					false :
					(typeof $bool4=='object'?
			...
			if ((($bool5=(backgroundColor !== null)) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
					false :
					(typeof $bool5=='object'?
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$method = $pyjs__bind_method2('moveControl', function(mouse_x, mouse_y, first_move) {
			...
			relative_y = (typeof ($sub3=mouse_y)==typeof ($sub4=(typeof ($div1=handle_height)==typeof ($div2=2) && typeof $div1=='number' && $div2 !== 0?
				...
				$sub3-$sub4:
				$p['op_sub']($sub3,$sub4));
			if ((($bool6=((($cmp1=relative_y)===($cmp2=0)?0:
	...
	, 1, [null,null,['self'],['mouse_x'],['mouse_y'],['first_move', false]]);
		...
		$method = $pyjs__bind_method2('setControlPos', function(value) {
			...
			widget_height = self['getOffsetHeight']();
			height_range = (typeof ($sub9=widget_height)==typeof ($sub10=10) && (typeof $sub9=='number'||typeof $sub9=='string')?
				$sub9-$sub10:
				$p['op_sub']($sub9,$sub10));
			...
			relative_y = (typeof ($div5=(typeof ($mul3=height_range)==typeof ($mul4=(typeof ($sub13=value)==typeof ($sub14=$p['getattr'](self, 'min_value')) && (typeof $sub13=='number'||typeof $sub13=='string')?
				...
				$div5/$div6:
				$p['op_div']($div5,$div6));
			if ((($bool8=((($cmp5=relative_y)===($cmp6=0)?0:
