...
$pyjs.loaded_modules['StringIO'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('seek', function(pos, mode) {
			...
			var $bool10,$eq2,$eq3,$eq1,$eq4,$add2,$add3,$add1,$add6,$add4,$add5,$bool8,$bool9;
			$m['_complain_ifclosed']($p['getattr'](self, 'closed'));
					...
					(typeof $bool8=='object'?
						(typeof $bool8.__nonzero__=='function'?
							...
							(typeof $bool8.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				self.buf = (typeof ($add1=$p['getattr'](self, 'buf'))==typeof ($add2=''['join']($p['getattr'](self, 'buflist'))) && (typeof $add1=='number'||typeof $add1=='string')?
					$add1+$add2:
					$p['op_add']($add1,$add2));
				self.buflist = $p['list']([]);
			}
			if ((($bool9=(($eq1=mode)===($eq2=1)&&$eq1===null?true:
			...
			else if ((($bool10=(($eq3=mode)===($eq4=2)&&$eq3===null?true:
			...
			self.pos = $p['max'](0, pos);
			return null;
		}
	, 1, [null,null,['self'],['pos'],['mode', 0]]);
					...
					(typeof $bool11=='object'?
						(typeof $bool11.__nonzero__=='function'?
							...
							(typeof $bool11.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				self.buf = (typeof ($add7=$p['getattr'](self, 'buf'))==typeof ($add8=''['join']($p['getattr'](self, 'buflist'))) && (typeof $add7=='number'||typeof $add7=='string')?
					$add7+$add8:
					$p['op_add']($add7,$add8));
				self.buflist = $p['list']([]);
			}
			if ((($bool12=((($cmp1=n)===($cmp2=0)?0:
	...
	, 1, [null,null,['self'],['n', (typeof ($usub1=1)=='number'?
			-$usub1:
			$p['op_usub']($usub1))]]);
					...
					(typeof $bool13=='object'?
						(typeof $bool13.__nonzero__=='function'?
							...
							(typeof $bool13.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				self.buf = (typeof ($add11=$p['getattr'](self, 'buf'))==typeof ($add12=''['join']($p['getattr'](self, 'buflist'))) && (typeof $add11=='number'||typeof $add11=='string')?
					$add11+$add12:
					$p['op_add']($add11,$add12));
				self.buflist = $p['list']([]);
			}
			i = self['buf']['find']('\n', $p['getattr'](self, 'pos'));
			if ((($bool14=((($cmp3=i)===($cmp4=0)?0:
				...
				newpos = (typeof ($add13=i)==typeof ($add14=1) && (typeof $add13=='number'||typeof $add13=='string')?
					$add13+$add14:
					$p['op_add']($add13,$add14));
			}
			if ((($bool15=(length !== null)) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
					false :
			...
			while ((($bool17=line) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
					...
					(typeof $bool17=='object'?
						(typeof $bool17.__nonzero__=='function'?
						 ...
						 true ) )) {
				lines['append'](line);
				total = (typeof ($add19=total)==typeof ($add20=(($len2=line) === null?0:
				...
				if ((($bool18=(((($cmp7=0)===($cmp8=($compare1 = sizehint))?0:
	...
	, 1, [null,null,['self'],['sizehint', 0]]);
		...
		$method = $pyjs__bind_method2('truncate', function(size) {
			...
			$m['_complain_ifclosed']($p['getattr'](self, 'closed'));
			if ((($bool19=(size === null)) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
					false :
			...
			else if ((($bool20=((($cmp11=size)===($cmp12=0)?0:
			...
			self.buf = $p['__getslice'](self['getvalue'](), 0, size);
			self.len = size;
			return null;
		}
	, 1, [null,null,['self'],['size', null]]);
		...
		$method = $pyjs__bind_method2('write', function(s) {
			...
			var slen,$add24,$cmp20,$add26,$add21,$add22,$add25,$len4,$cmp18,$bool25,$bool24,$bool27,$bool26,$bool23,$bool22,$sub2,$sub1,$bool29,$bool28,$bool30,spos,$eq6,$eq5,$cmp15,$cmp17,$cmp16,$cmp19,$mul2,$mul1,newpos,$assign1,$len3,$add23;
			$m['_complain_ifclosed']($p['getattr'](self, 'closed'));
			...
			if ((($bool26=(($eq5=spos)===($eq6=slen)&&$eq5===null?true:
				($eq5===null?false:($eq6===null?false:
					((typeof $eq5=='object'||typeof $eq5=='function')&&typeof $eq5.__cmp__=='function'?$eq5.__cmp__($eq6) === 0:
						((typeof $eq6=='object'||typeof $eq6=='function')&&typeof $eq6.__cmp__=='function'?$eq6.__cmp__($eq5) === 0:
							$eq5==$eq6)))))) === null || $bool26 === false || $bool26 === 0 || $bool26 === '' ?
					false :
				...
				$assign1 = (typeof ($add21=spos)==typeof ($add22=(($len3=s) === null?0:
			...
			newpos = (typeof ($add23=spos)==typeof ($add24=(($len4=s) === null?0:
						...
						(typeof $bool29=='object'?
							(typeof $bool29.__nonzero__=='function'?
								...
								(typeof $bool29.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					self.buf = (typeof ($add25=$p['getattr'](self, 'buf'))==typeof ($add26=''['join']($p['getattr'](self, 'buflist'))) && (typeof $add25=='number'||typeof $add25=='string')?
						$add25+$add26:
						$p['op_add']($add25,$add26));
				}
				self.buflist = $p['list']([$p['__getslice']($p['getattr'](self, 'buf'), 0, spos), s, $p['__getslice']($p['getattr'](self, 'buf'), newpos, null)]);
				self.buf = '';
					...
					(typeof $bool31=='object'?
						(typeof $bool31.__nonzero__=='function'?
							...
							(typeof $bool31.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				self.buf = (typeof ($add27=$p['getattr'](self, 'buf'))==typeof ($add28=''['join']($p['getattr'](self, 'buflist'))) && (typeof $add27=='number'||typeof $add27=='string')?
					$add27+$add28:
