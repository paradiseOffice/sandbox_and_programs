...
$pyjs.loaded_modules['base64'] = function (__mod_name__) {
				...
				(typeof $bool4=='object'?
					(typeof $bool4.__nonzero__=='function'?
						...
						(typeof $bool4.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			return (typeof ($add13=$p['__getslice'](encoded, 0, (typeof ($usub2=6)=='number'?
				-$usub2:
				...
				(typeof $bool5=='object'?
					(typeof $bool5.__nonzero__=='function'?
						...
						(typeof $bool5.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			return (typeof ($add15=$p['__getslice'](encoded, 0, (typeof ($usub3=4)=='number'?
				-$usub3:
				...
				(typeof $bool6=='object'?
					(typeof $bool6.__nonzero__=='function'?
						...
						(typeof $bool6.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			return (typeof ($add17=$p['__getslice'](encoded, 0, (typeof ($usub4=3)=='number'?
				-$usub4:
				...
				(typeof $bool7=='object'?
					(typeof $bool7.__nonzero__=='function'?
						...
						(typeof $bool7.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			return (typeof ($add19=$p['__getslice'](encoded, 0, (typeof ($usub5=1)=='number'?
				-$usub5:
	...
	$m['test'] = function() {
		var $eq27,$eq19,$30,$29,$iter9_iter,$iter9_nextval,$iter9_idx,$bool25,$bool24,$pyjs_try_err,$bool21,$bool20,$bool23,$bool22,msg,getopt,$iter9_type,$and1,$and2,args,$eq21,$eq20,$eq23,$eq22,$eq25,$eq24,func,$eq26,$eq28,a,sys,$32,o,$31,$iter9_array,opts;
		...
		if ((($bool25=((($bool24=$and1=args) === null || $bool24 === false || $bool24 === 0 || $bool24 === '' ?
			...
			func($p['open']((typeof ($31=args).__array != 'undefined'?
				((typeof $31.__array[$32=0]) != 'undefined'?$31.__array[$32]:
					$31.__getitem__($32)):
					$31.__getitem__(0)), 'rb'), $p['getattr'](sys, 'stdout'));
		}
		else {
