...
$pyjs.loaded_modules['binascii'] = function (__mod_name__) {
	...
	$collcomp1 = $p['list']();
			...
			while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
				...
				C = $tupleassign1[2];
				D = $tupleassign1[3];
				$collcomp1['append'](''['join']($p['list']([$p['chr']((((typeof ($sub3=A)==typeof ($sub4=32) && (typeof $sub3=='number'||typeof $sub3=='string')?
					$sub3-$sub4:
	...
	$collcomp2 = $p['list']();
		...
		while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
			...
			B = $tupleassign2[1];
			C = $tupleassign2[2];
			$collcomp2['append'](''['join']($p['list']([$p['chr']((typeof ($add7=32)==typeof ($add8=((A)>>(2))&(63)) && (typeof $add7=='number'||typeof $add7=='string')?
				$add7+$add8:
						...
						(typeof $bool38=='object'?
							(typeof $bool38.__nonzero__=='function'?
								...
								(typeof $bool38.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					ch = $p['chr']($p['float_int']($p['__getslice'](s, inp, (typeof ($add53=inp)==typeof ($add54=2) && (typeof $add53=='number'||typeof $add53=='string')?
						$add53+$add54:
	...
	$m['b2a_qp'] = function(data, quotetabs, istext, header) {
		...
		crlf = ((($bool41=$and9=((($cmp21=lf)===($cmp22=0)?0:
			...
			$sub25-$sub26:
			$p['op_sub']($sub25,$sub26)))))===($eq34='\r')&&$eq33===null?true:
		...
		while ((($bool42=((($cmp23=inp)===($cmp24=(($len10=data) === null?0:
			...
			if ((($bool66=((($bool53=$or16=((($cmp25=c)===($cmp26='~')?0:
				...
				$add63+$add64:
				$p['op_add']($add63,$add64)))))===($eq48='\r')&&$eq47===null?true:
				...
				if ((($bool73=((($bool69=$and28=istext) === null || $bool69 === false || $bool69 === 0 || $bool69 === '' ?
					...
					if ((($bool76=((($bool74=$and33=((($cmp33=(($len14=odata) === null?0:
						...
						-$usub2:
						$p['op_usub']($usub2)))))===($eq76='\t')&&$eq75===null?true:
				...
				(typeof $bool101=='object'?
					(typeof $bool101.__nonzero__=='function'?
						...
						(typeof $bool101.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			s = (typeof ($add99=$p['__getslice'](s, 1, null))==typeof ($add100='?') && (typeof $add99=='number'||typeof $add99=='string')?
				$add99+$add100:
				$p['op_add']($add99,$add100));
		}
		else {
			s = (typeof ($add101=$p['__getslice'](s, 1, null))==typeof ($add102='!') && (typeof $add101=='number'||typeof $add101=='string')?
				$add101+$add102:
	...
	$m['b2a_hex'] = function(s) {
		var $iter16_idx,$add112,$add113,$add110,$add111,$$char,$cmp49,result,$iter16_iter,$iter16_type,$iter16_nextval,$add114,$sub31,$sub33,$sub32,$sub34,$add107,$add109,$add108,$cmp51,$cmp50,$cmp52,$iter16_array,$bool112,c,$bool111;
		result = $p['list']([]);
		$iter16_iter = s;
