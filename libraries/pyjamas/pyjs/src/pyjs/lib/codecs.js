...
$pyjs.loaded_modules['codecs'] = function (__mod_name__) {
	...
	if ((($bool1=(($eq1=$p['getattr']($m['sys'], 'byteorder'))===($eq2='little')&&$eq1===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setstate', function(state) {
			...
			var $bool3,$or3,$or4;
			self.buffer = ((($bool3=$or3=state) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
				false :
				(typeof $bool3=='object'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setstate', function(state) {
			...
			var $2,$1;
			self.buffer = (typeof ($1=state).__array != 'undefined'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('seek', function(offset, whence) {
			...
			var $eq3,$eq6,$eq4,$eq5,$bool4,$and1,$bool5,$and2;
			self['stream']['seek'](offset, whence);
			if ((($bool5=((($bool4=$and1=(($eq3=whence)===($eq4=0)&&$eq3===null?true:
					...
					(typeof $bool4.__nonzero__=='function'?
						...
						(typeof $bool4.__len__=='function'?
							($bool4.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?(($eq5=offset)===($eq6=0)&&$eq5===null?true:
		...
		$method = $pyjs__bind_method2('read', function(size, chars, firstline) {
			...
			while ((($bool7=true) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
				...
				if ((($bool8=((($cmp1=chars)===($cmp2=0)?0:
					...
					else if ((($bool11=((((($cmp5=(($len1=$p['getattr'](self, 'charbuffer')) === null?0:
					...
					if ((($bool12=((((($cmp7=(($len2=$p['getattr'](self, 'charbuffer')) === null?0:
				...
				try {
					...
					if (($pyjs_try_err_name == (typeof UnicodeDecodeError == "undefined"?$m.UnicodeDecodeError:UnicodeDecodeError).__name__)||$p['_isinstance']($pyjs_try_err,(typeof UnicodeDecodeError == "undefined"?$m.UnicodeDecodeError:UnicodeDecodeError))) {
						...
						if ((($bool14=firstline) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
							...
							if ((($bool15=((($cmp11=(($len3=lines) === null?0:
								(typeof $len3.__array != 'undefined' ? $len3.__array.length:
									(typeof $len3.__len__ == 'function'?$len3.__len__():
										(typeof $len3.length != 'undefined'?$len3.length:
											$p['len']($len3))))))===($cmp12=1)?0:
				...
				self.charbuffer = (typeof ($add7=$p['getattr'](self, 'charbuffer'))==typeof ($add8=newchars) && (typeof $add7=='number'||typeof $add7=='string')?
					$add7+$add8:
					$p['op_add']($add7,$add8));
			...
			if ((($bool18=((($cmp13=chars)===($cmp14=0)?0:
	...
	, 1, [null,null,['self'],['size', (typeof ($usub1=1)=='number'?
		...
		$method = $pyjs__bind_method2('readline', function(size, keepends) {
			...
			var $bool19,$cmp20,data,$3,$augexpr1,$and3,$and4,$augsub1,line0withoutend,$eq8,$or6,$bool25,$bool24,$bool27,$bool26,$bool21,$bool20,$bool23,$bool22,$bool29,$bool28,$bool40,$or8,readsize,$add14,$add16,$bool32,$bool33,$bool30,$bool31,$bool36,$bool37,$bool34,$bool35,$bool38,$bool39,$add17,$eq10,$cmp19,line,$8,$9,$6,$7,$4,$5,$mul2,$mul1,$14,$15,$16,$17,$10,$11,$12,$13,$18,$19,$len6,$len4,$len5,$add9,line0withend,$21,$20,$22,$24,$or5,$or7,$eq9,$eq7,$cmp15,$add15,$cmp17,$cmp16,$add10,$add11,$add12,$add13,$add18,$cmp18,lines,$23;
						...
						(typeof $bool20=='object'?
							(typeof $bool20.__nonzero__=='function'?
								...
								(typeof $bool20.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					self.charbuffer = (typeof ($5=$p['getattr'](self, 'linebuffer')).__array != 'undefined'?
			...
			while ((($bool24=true) === null || $bool24 === false || $bool24 === 0 || $bool24 === '' ?
							...
							(typeof $bool26=='object'?
								(typeof $bool26.__nonzero__=='function'?
									...
									(typeof $bool26.__len__=='function'?
										...
										true ) ) :
								 true ) )) {
						data = (typeof ($add9=data)==typeof ($add10=$pyjs_kwargs_call(self, 'read', null, null, [{size:1, chars:1}])) && (typeof $add9=='number'||typeof $add9=='string')?
							$add9+$add10:
							$p['op_add']($add9,$add10));
					}
				}
				...
				if ((($bool27=lines) === null || $bool27 === false || $bool27 === 0 || $bool27 === '' ?
					...
					if ((($bool28=((($cmp15=(($len5=lines) === null?0:
						...
						line = (typeof ($9=lines).__array != 'undefined'?
							((typeof $9.__array[$10=0]) != 'undefined'?$9.__array[$10]:
								...
								$9.__getitem__(0));
						lines.__delitem__(0);
						if ((($bool29=((($cmp17=(($len6=lines) === null?0:
							...
							self.charbuffer = (typeof ($add15=(typeof ($13=lines).__array != 'undefined'?
								((typeof $13.__array[$14=0]) != 'undefined'?$13.__array[$14]:
									$13.__getitem__($14)):
									$13.__getitem__(0)))==typeof ($add16=$p['getattr'](self, 'charbuffer')) && (typeof $add15=='number'||typeof $add15=='string')?
								$add15+$add16:
					...
					line0withoutend = (typeof ($21=(typeof ($19=lines).__array != 'undefined'?
						((typeof $19.__array[$20=0]) != 'undefined'?$19.__array[$20]:
							$19.__getitem__($20)):
							$19.__getitem__(0))['splitlines'](false)).__array != 'undefined'?
						((typeof $21.__array[$22=0]) != 'undefined'?$21.__array[$22]:
							$21.__getitem__($22)):
							$21.__getitem__(0));
					if ((($bool32=!(($eq9=line0withend)===($eq10=line0withoutend)&&$eq9===null?true:
						($eq9===null?false:($eq10===null?false:
							((typeof $eq9=='object'||typeof $eq9=='function')&&typeof $eq9.__cmp__=='function'?$eq9.__cmp__($eq10) === 0:
								((typeof $eq10=='object'||typeof $eq10=='function')&&typeof $eq10.__cmp__=='function'?$eq10.__cmp__($eq9) === 0:
									$eq9==$eq10)))))) === null || $bool32 === false || $bool32 === 0 || $bool32 === '' ?
							false :
							(typeof $bool32=='object'?
								(typeof $bool32.__nonzero__=='function'?
									...
									(typeof $bool32.__len__=='function'?
										...
										true ) ) :
								 true ) )) {
						self.charbuffer = (typeof ($add17=''['join']($p['__getslice'](lines, 1, null)))==typeof ($add18=$p['getattr'](self, 'charbuffer')) && (typeof $add17=='number'||typeof $add17=='string')?
							$add17+$add18:
						...
						(typeof $bool35.__nonzero__=='function'?
							...
							(typeof $bool35.__len__=='function'?
								($bool35.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or7:(size !== null))) === null || $bool36 === false || $bool36 === 0 || $bool36 === '' ?
						false :
				...
				if ((($bool40=((($cmp19=readsize)===($cmp20=8000)?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('seek', function(offset, whence) {
			...
			if (typeof whence == 'undefined') whence=arguments.callee.__args__[4][1];
			var $bool43,$bool42,$and5,$and6,$eq11,$eq12,$eq13,$eq14;
			self['stream']['seek'](offset, whence);
			self['reader']['reset']();
			if ((($bool43=((($bool42=$and5=(($eq11=whence)===($eq12=0)&&$eq11===null?true:
				($eq11===null?false:($eq12===null?false:
					((typeof $eq11=='object'||typeof $eq11=='function')&&typeof $eq11.__cmp__=='function'?$eq11.__cmp__($eq12) === 0:
						((typeof $eq12=='object'||typeof $eq12=='function')&&typeof $eq12.__cmp__=='function'?$eq12.__cmp__($eq11) === 0:
							$eq11==$eq12)))))) === null || $bool42 === false || $bool42 === 0 || $bool42 === '' ?
				false :
					...
					(typeof $bool42.__nonzero__=='function'?
						...
						(typeof $bool42.__len__=='function'?
							($bool42.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?(($eq13=offset)===($eq14=0)&&$eq13===null?true:
				($eq13===null?false:($eq14===null?false:
					((typeof $eq13=='object'||typeof $eq13=='function')&&typeof $eq13.__cmp__=='function'?$eq13.__cmp__($eq14) === 0:
						((typeof $eq14=='object'||typeof $eq14=='function')&&typeof $eq14.__cmp__=='function'?$eq14.__cmp__($eq13) === 0:
							$eq13==$eq14))))):$and5)) === null || $bool43 === false || $bool43 === 0 || $bool43 === '' ?
					false :
	...
	, 1, [null,null,['self'],['size', (typeof ($usub5=1)=='number'?
		...
		$method = $pyjs__bind_method2('readline', function(size) {
			...
			if ((($bool44=(size === null)) === null || $bool44 === false || $bool44 === 0 || $bool44 === '' ?
					false :
	...
	$m['open'] = function(filename, mode, encoding, errors, buffering) {
		...
		if ((($bool45=(encoding !== null)) === null || $bool45 === false || $bool45 === 0 || $bool45 === '' ?
				false :
			...
			if ((($bool46=mode.__contains__('U')) === null || $bool46 === false || $bool46 === 0 || $bool46 === '' ?
				...
				if ((($bool47=!$p['set']('rwa').__contains__($p['__getslice'](mode, 0, 1))) === null || $bool47 === false || $bool47 === 0 || $bool47 === '' ?
						false :
		...
		if ((($bool49=(encoding === null)) === null || $bool49 === false || $bool49 === 0 || $bool49 === '' ?
				false :
	...
	$m['EncodedFile'] = function(file, data_encoding, file_encoding, errors) {
		...
		if ((($bool50=(file_encoding === null)) === null || $bool50 === false || $bool50 === 0 || $bool50 === '' ?
				false :
	...
	$m['getincrementalencoder'] = function(encoding) {
		...
		if ((($bool51=(encoder === null)) === null || $bool51 === false || $bool51 === 0 || $bool51 === '' ?
				false :
	...
	$m['getincrementaldecoder'] = function(encoding) {
		...
		if ((($bool52=(decoder === null)) === null || $bool52 === false || $bool52 === 0 || $bool52 === '' ?
				false :
