...
$pyjs.loaded_modules['getopt'] = function (__mod_name__) {
					...
					(typeof $bool10=='object'?
						(typeof $bool10.__nonzero__=='function'?
							...
							(typeof $bool10.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				prog_args = (typeof ($add1=prog_args)==typeof ($add2=$p['__getslice'](args, 1, null)) && (typeof $add1=='number'||typeof $add1=='string')?
					$add1+$add2:
					$p['op_add']($add1,$add2));
				break;
			}
	...
	$m['do_longs'] = function(opts, opt, longopts, args) {
		...
		if ((($bool14=(($eq13=i)===($eq14=(typeof ($usub1=1)=='number'?
			...
			var $tupleassign5 = $p['__ass_unpack']($p['tuple']([$p['__getslice'](opt, 0, i), $p['__getslice'](opt, (typeof ($add5=i)==typeof ($add6=1) && (typeof $add5=='number'||typeof $add5=='string')?
				$add5+$add6:
