...
$pyjs.loaded_modules['random'] = function (__mod_name__) {
	...
	var $eq35,$pow2,$pow1,$mul3,$bool77,$add1,$mul4,$div2,$div1,$mul2,$mul1,$add2,$eq36;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setstate', function(state) {
			...
			var $iter1_iter,$mod1,$mod2,internalstate,$pow4,$pow3,version,$iter1_array,$iter1_nextval,$eq2,$eq3,$eq1,$eq4,$bool2,$bool3,$2,$1,e,$iter1_type,$pyjs_try_err,$iter1_idx,x;
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('randrange', function(start, stop, step, fint, $$default, maxwidth) {
			...
			var $mul9,$bool10,$bool11,$bool12,$bool13,$bool14,$bool16,$bool17,istart,$and1,$and2,$bool15,$bool6,$bool7,$bool4,$bool5,$bool8,$bool9,$add15,$mul16,$mul15,$mul14,$mul13,$mul12,$mul11,$mul10,$floordiv4,$floordiv3,$floordiv2,$floordiv1,$cmp11,$cmp10,$cmp13,$add13,$eq10,$eq11,$eq12,$eq13,$eq14,width,$cmp15,istep,$mul8,$mul7,$$default,n,$add3,$add6,$add7,$add4,$add5,$add8,$add9,istop,$sub3,$sub2,$sub1,$sub4,$eq8,$eq9,$eq6,$eq7,$eq5,$add14,$cmp14,$add16,$cmp16,$add10,$add11,$add12,$cmp12,$cmp5,$cmp4,$cmp7,$cmp6,$cmp1,$cmp3,$cmp2,$cmp9,$cmp8;
			istart = fint(start);
			...
			if ((($bool14=((($cmp9=istep)===($cmp10=0)?0:
				...
				n = (typeof ($floordiv1=(typeof ($sub3=(typeof ($add7=width)==typeof ($add8=istep) && (typeof $add7=='number'||typeof $add7=='string')?
					$add7+$add8:
					$p['op_add']($add7,$add8)))==typeof ($sub4=1) && (typeof $sub3=='number'||typeof $sub3=='string')?
					$sub3-$sub4:
				...
				n = (typeof ($floordiv3=(typeof ($add11=(typeof ($add9=width)==typeof ($add10=istep) && (typeof $add9=='number'||typeof $add9=='string')?
					$add9+$add10:
					$p['op_add']($add9,$add10)))==typeof ($add12=1) && (typeof $add11=='number'||typeof $add11=='string')?
					$add11+$add12:
	...
	, 1, [null,null,['self'],['start'],['stop', null],['step', 1],['fint', $p['float_int']],['$$default', null],['maxwidth', (1)<<($m['BPF'])]]);
		...
		$method = $pyjs__bind_method2('randint', function(a, b) {
			...
			var $add18,$add17;
			return self['randrange'](a, (typeof ($add17=b)==typeof ($add18=1) && (typeof $add17=='number'||typeof $add17=='string')?
				$add17+$add18:
							...
							(typeof $bool18=='object'?
								(typeof $bool18.__nonzero__=='function'?
									...
									(typeof $bool18.__len__=='function'?
										...
										true ) ) :
								 true ) )) {
						k = fint((typeof ($add19=1.00001)==typeof ($add20=_log((typeof ($sub5=n)==typeof ($sub6=1) && (typeof $sub5=='number'||typeof $sub5=='string')?
							$sub5-$sub6:
	...
	, 1, [null,null,['self'],['n'],['_log', $m['_log']],['fint', $p['float_int']],['_maxwidth', (1)<<($m['BPF'])]]);
		...
		$method = $pyjs__bind_method2('choice', function(seq) {
			...
			return (typeof ($3=seq).__array != 'undefined'?
				((typeof $3.__array[$4=$p['float_int']((typeof ($mul19=self['random']())==typeof ($mul20=(($len1=seq) === null?0:
				...
				$p['op_mul']($mul19,$mul20)))]) != 'undefined'?$3.__array[$4]:
					$3.__getitem__($4)):
					$3.__getitem__($p['float_int']((typeof ($mul19=self['random']())==typeof ($mul20=(($len1=seq) === null?0:
				(typeof $len1.__array != 'undefined' ? $len1.__array.length:
					(typeof $len1.__len__ == 'function'?$len1.__len__():
						(typeof $len1.length != 'undefined'?$len1.length:
							$p['len']($len1)))))) && typeof $mul19=='number'?
	...
	, 1, [null,null,['self'],['seq']]);
		...
		$method = $pyjs__bind_method2('shuffle', function(x, random, fint) {
			...
			while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
				i = $iter2_nextval;
				j = fint((typeof ($mul21=random())==typeof ($mul22=(typeof ($add21=i)==typeof ($add22=1) && (typeof $add21=='number'||typeof $add21=='string')?
					$add21+$add22:
					...
					(typeof $bool23=='object'?
						(typeof $bool23.__nonzero__=='function'?
							...
							(typeof $bool23.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				setsize = (typeof ($add23=setsize)==typeof ($add24=(typeof ($pow5=4)==typeof ($pow6=$m['_ceil']($m['_log']((typeof ($mul25=k)==typeof ($mul26=3) && typeof $mul25=='number'?
					$mul25*$mul26:
			...
			if ((($bool25=((($bool24=$or1=((($cmp25=n)===($cmp26=setsize)?0:
				...
				while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
					...
					pool.__setitem__(j, (typeof ($11=pool).__array != 'undefined'?
						...
						$sub9-$sub10:
						$p['op_sub']($sub9,$sub10)))==typeof ($sub12=1) && (typeof $sub11=='number'||typeof $sub11=='string')?
						$sub11-$sub12:
	...
	, 1, [null,null,['self'],['mu'],['kappa']]);
		...
		$method = $pyjs__bind_method2('gammavariate', function(alpha, beta) {
			...
			var $bool50,$bool51,ainv,$bool52,$mul80,$mul81,$mul82,$mul83,$mul84,$mul85,$mul86,$mul87,$sub39,b,p,x,$cmp48,$cmp49,$cmp42,$cmp43,$cmp41,$cmp46,$cmp47,$cmp44,$cmp45,$pow9,$bool47,$bool46,$bool45,$bool44,$bool43,$bool42,$bool41,$bool40,$bool49,$bool48,$cmp59,$cmp58,$cmp51,$cmp50,$cmp53,$cmp52,$cmp55,$cmp54,$cmp57,$cmp56,$add50,$div20,$div23,$div22,$div25,$div24,$div26,$bool38,$bool39,$cmp64,$mul69,$cmp60,$cmp61,$cmp62,$cmp63,$add43,$eq15,$eq16,$div18,$div19,$add49,$add48,$add47,$add46,$add45,$add44,u1,bbb,u2,$div17,$div21,__random,$sub54,$mul71,$mul70,$mul73,$mul72,$mul75,$mul74,$mul77,$mul76,$mul79,$mul78,r,v,z,$sub48,$sub49,$sub40,$sub41,$sub42,$sub43,$sub44,$sub45,$sub46,$sub47,$pow12,$mul88,$pow11,$pow10,$or5,$or7,$or6,$sub53,$sub52,$sub51,$sub50,$or8,u,ccc;
	...
	, 1, [null,null,['self'],['mu'],['sigma']]);
		...
		$method = $pyjs__bind_method2('betavariate', function(alpha, beta) {
			...
			var $bool54,$add53,$add54,$div27,$div28,$eq18,y,$eq17;
	...
	$m['WichmannHill'] = (function(){
		...
		$method = $pyjs__bind_method2('seed', function(a) {
			...
			a = $tupleassign7[0];
			z = $tupleassign7[1];
			self._seed = $p['tuple']([(typeof ($add55=$p['float_int'](x))==typeof ($add56=1) && (typeof $add55=='number'||typeof $add55=='string')?
				$add55+$add56:
				$p['op_add']($add55,$add56)), (typeof ($add57=$p['float_int'](y))==typeof ($add58=1) && (typeof $add57=='number'||typeof $add57=='string')?
				$add57+$add58:
				$p['op_add']($add57,$add58)), (typeof ($add59=$p['float_int'](z))==typeof ($add60=1) && (typeof $add59=='number'||typeof $add59=='string')?
				$add59+$add60:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('setstate', function(state) {
			...
			var $15,$16,$eq20,$bool58,$eq19,version;
	...
	, 1, [null,null,['self'],['n']]);
		...
		$method = $pyjs__bind_method2('__whseed', function(x, y, z) {
			...
			var $cmp73,$cmp67,$cmp68,$cmp69,$bool70,$eq32,$mul116,$eq30,$cmp70,$bool65,$or9,$cmp76,$bool67,$bool66,$or12,$bool68,$or10,$bool61,$cmp72,$cmp71,$bool62,$cmp77,$bool64,$cmp75,$cmp74,$bool69,$and4,$and3,$bool63,$and5,$eq21,$eq23,$eq22,$eq25,$eq24,$eq27,$eq26,$eq29,$eq28,$mul115,$or14,$eq31,$or11,t,$or13,time,$cmp78;
	...
	, 1, [null,null,['self'],['x', 0],['y', 0],['z', 0]]);
		...
		$method = $pyjs__bind_method2('whseed', function(a) {
			...
			x = ((($bool72=$or15=(typeof ($mod21=(typeof ($add65=x)==typeof ($add66=a) && (typeof $add65=='number'||typeof $add65=='string')?
				$add65+$add66:
				$p['op_add']($add65,$add66)))==typeof ($mod22=256) && typeof $mod21=='number'?
			...
			y = ((($bool73=$or17=(typeof ($mod23=(typeof ($add67=y)==typeof ($add68=a) && (typeof $add67=='number'||typeof $add67=='string')?
				$add67+$add68:
				$p['op_add']($add67,$add68)))==typeof ($mod24=256) && typeof $mod23=='number'?
			...
			z = ((($bool74=$or19=(typeof ($mod25=(typeof ($add69=z)==typeof ($add70=a) && (typeof $add69=='number'||typeof $add69=='string')?
				$add69+$add70:
				$p['op_add']($add69,$add70)))==typeof ($mod26=256) && typeof $mod25=='number'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getrandbits', function(k) {
			...
			var $add72,$add71,$bool76,$bool75,bytes,$cmp80,$eq33,$floordiv5,$mul120,$eq34,x,$floordiv6,$sub62,$cmp79,$mul119,$sub61;
			...
			bytes = (typeof ($floordiv5=(typeof ($add71=k)==typeof ($add72=7) && (typeof $add71=='number'||typeof $add71=='string')?
				$add71+$add72:
				$p['op_add']($add71,$add72)))==typeof ($floordiv6=8) && typeof $floordiv5=='number' && $floordiv6 !== 0?
				Math.floor($floordiv5/$floordiv6):
				$p['op_floordiv']($floordiv5,$floordiv6));
			x = $p['float_int']($m['_hexlify']($m['_urandom'](bytes)), 16);
			return (x)>>((typeof ($sub61=(typeof ($mul119=bytes)==typeof ($mul120=8) && typeof $mul119=='number'?
				$mul119*$mul120:
