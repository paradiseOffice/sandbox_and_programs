...
$pyjs.loaded_modules['string'] = function (__mod_name__) {
	...
	$m['capwords'] = function(s, sep) {
		...
		if ((($bool1=(sep === null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
				false :
				(typeof $bool1=='object'?
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	$m['maketrans'] = function(fromstr, tostr) {
		var $iter2_iter,$iter2_type,$eq2,$eq1,L,$bool2,$bool3,$iter2_idx,$bool4,$4,$2,$3,$1,$iter2_nextval,i,$len2,$len3,$len1,$iter2_array;
		if ((($bool2=!(($eq1=(($len1=fromstr) === null?0:
			(typeof $len1.__array != 'undefined' ? $len1.__array.length:
				(typeof $len1.__len__ == 'function'?$len1.__len__():
					(typeof $len1.length != 'undefined'?$len1.length:
						$p['len']($len1))))))===($eq2=(($len2=tostr) === null?0:
			(typeof $len2.__array != 'undefined' ? $len2.__array.length:
				(typeof $len2.__len__ == 'function'?$len2.__len__():
					(typeof $len2.length != 'undefined'?$len2.length:
						$p['len']($len2))))))&&$eq1===null?true:
		...
		$iter2_iter = $p['range']((($len3=fromstr) === null?0:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('_invalid', function(mo) {
			...
			i = mo['start']();
			j = $p['min']((typeof ($add17=i)==typeof ($add18=10) && (typeof $add17=='number'||typeof $add17=='string')?
				$add17+$add18:
				$p['op_add']($add17,$add18)), (($len4=$p['getattr'](self, 'template')) === null?0:
	...
	, 1, [null,null,['self'],['mo']]);
		...
		$method = $pyjs__bind_method2('substitute', function() {
			...
			if ((($bool5=((($cmp1=(($len5=args) === null?0:
			...
			convert = function(mo) {
				...
				named = ((($bool9=$or1=mo['group'](2)) === null || $bool9 === false || $bool9 === 0 || $bool9 === '' ?
					false :
					(typeof $bool9=='object'?
						(typeof $bool9.__nonzero__=='function'?
							...
							(typeof $bool9.__len__=='function'?
								...
								true ) ) :
						 true ) )?$or1:mo['group'](3));
				if ((($bool10=(named !== null)) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
						false :
				...
				if ((($bool11=(mo['group'](1) !== null)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
						false :
				...
				if ((($bool12=(mo['group'](4) !== null)) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
						false :
	...
	, 1, ['args',['kws'],['self']]);
		...
		$method = $pyjs__bind_method2('safe_substitute', function() {
			...
			if ((($bool13=((($cmp3=(($len6=args) === null?0:
			...
			convert = function(mo) {
				...
				named = mo['group'](2);
				if ((($bool17=(named !== null)) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
						false :
				...
				braced = mo['group'](3);
				if ((($bool18=(braced !== null)) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
						false :
				...
				if ((($bool19=(mo['group'](1) !== null)) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
						false :
				...
				if ((($bool20=(mo['group'](4) !== null)) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
						false :
